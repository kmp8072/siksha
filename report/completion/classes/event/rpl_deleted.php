 ...
 * @package report_completion
 */
class rpl_deleted extends \core\event\base {
    /**
    ...
    public static function get_name() {
        return get_string('eventrpldeleted', 'report_completion');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' deleted $type RPL for user '$this->relateduserid' in course '$this->courseid'.";
    }
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call rpl_deleted::create() directly, use rpl_deleted::create_from_rpl() instead.');
        }
