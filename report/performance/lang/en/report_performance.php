...
$string['check_themedesignermode_details'] = 'This is often the cause of slow shezar sites. <p>On average it might take at least twice the amount of CPU to run a shezar site with theme designer mode enabled.</p>';
