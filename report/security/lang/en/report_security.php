...
$string['check_usernameenumeration_details'] = '<p>When a user\'s credentials are incorrect shezar is careful to be vague about the reason why so as to not let the user know whether the username or the password is incorrect. This means would be attackers must guess both the username and the password.</p>
