...
$string['setting:managerselect_format'] = 'Recommended when manager assignment data is not available. When enabled and an activity requires approval by Manager, the session sign-up page will force users to search for and select a user to approve their request to attend a session each time they sign-up. The selected user will receive a notification about the request and instructions on how to approve or decline it.';
...
$string['setting:fromaddressdefault'] = 'shezar@example.com';
