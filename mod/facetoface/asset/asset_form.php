...
require_once($CFG->dirroot . '/shezar/customfield/field/location/define.class.php'); // TODO: TL-9425 this hack is unacceptable.
...
class mod_facetoface_asset_form extends moodleform {
    ...
    public function definition() {
        ...
        $modconfig = has_capability('shezar/core:modconfig', context_system::instance());
