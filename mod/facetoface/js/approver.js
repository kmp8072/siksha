...
facetofaceApproverDialog = function(name, title, find_url, save_url) {
    ...
    shezarDialogs[name].saveurl = save_url;
    shezarDialogs[name].findurl = find_url;

    /**
     * Open dialog and load external page
     * @return  void
     */
    shezarDialogs[name].open = function() {
...
facetoface_handler.prototype = new shezarDialog_handler_treeview_multiselect();
