...
M.shezar_f2f_dateintervalkeeper = M.shezar_f2f_dateintervalkeeper || {
    ...
    init: function(Y, elemstart, elemfinish) {
        ...
        M.shezar_f2f_dateintervalkeeper.previousstartvalues = M.shezar_f2f_dateintervalkeeper.getdate(elemstart);

        $('.fdate_time_selector select[name^="' + elemstart + '"]').change(function() {
            console.log("change", this);
            var newstartdate = M.shezar_f2f_dateintervalkeeper.getdate(elemstart);
            var oldstartdate = M.shezar_f2f_dateintervalkeeper.previousstartvalues;
            var currentfinishdate = M.shezar_f2f_dateintervalkeeper.getdate(elemfinish);
            var newfinishdate = currentfinishdate + (newstartdate - oldstartdate);
            M.shezar_f2f_dateintervalkeeper.setdate(elemfinish, newfinishdate);
            M.shezar_f2f_dateintervalkeeper.previousstartvalues = M.shezar_f2f_dateintervalkeeper.getdate(elemstart);
        });
    }
};