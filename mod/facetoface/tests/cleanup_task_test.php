...
class mod_facetoface_cleanup_task_testcase extends advanced_testcase {
    ...
    public function test_cleanup_task() {
        ...
        $user1ja = \shezar_job\job_assignment::create_default($user1->id); // Manager.
        \shezar_job\job_assignment::create_default($user2->id, array('managerjaid' => $user1ja->id));
        \shezar_job\job_assignment::create_default($user3->id, array('managerjaid' => $user1ja->id));
        \shezar_job\job_assignment::create_default($user4->id, array('managerjaid' => $user1ja->id));
