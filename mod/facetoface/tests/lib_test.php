...
class mod_facetoface_lib_testcase extends advanced_testcase {
    ...
    /** @var shezar_customfield_generator */
    ...
    public function setUp() {
        ...
        $this->customfield_generator = $this->getDataGenerator()->get_plugin_generator('shezar_customfield');
    }
    ...
    protected function init_sample_data() {
        ...
        $guestja = \shezar_job\job_assignment::create_default(1);
        $adminja = \shezar_job\job_assignment::create_default(2);
        $data = array(
        ...
        \shezar_job\job_assignment::create($data);
        $data = array(
    ...
    function test_facetoface_delete_session() {
        ...
        $cfids = array();
        $cfgenerator = $this->getDataGenerator()->get_plugin_generator('shezar_customfield');
    ...
    public function test_facetoface_user_signup_select_manager_message_manager() {
        ...
        $user3ja = \shezar_job\job_assignment::create_default($user3->id);
        $data = array(
            'userid' => $user2->id,
            'fullname' => 'user2ja',
            'shortname' => 'user2ja',
        ...
        $user2ja = \shezar_job\job_assignment::create($data);
        $data = array(
            'userid' => $user1->id,
            'fullname' => 'user1ja',
            'shortname' => 'user1ja',
        ...
        $user1ja = \shezar_job\job_assignment::create($data);
    ...
    function test_facetoface_send_notice_duplicates() {
        ...
        $managerja = \shezar_job\job_assignment::create_default($user2->id);
        $data = array(
            'userid' => $user1->id,
            'fullname' => 'user1ja',
            'shortname' => 'user1ja',
    ...
    public function test_facetoface_messages($emailonlyfromnoreplyaddress, $noreplyaddress, $senderfrom) {
        ...
        \shezar_job\job_assignment::create_default($user1->id, array('managerjaid' => $manager1ja->id));
        \shezar_job\job_assignment::create_default($user2->id, array('managerjaid' => $manager2ja->id));
    ...
    /**
     * Test the function shezar_core_update_module_completion_data works with:
     ...
     */
    public function test_shezar_core_update_module_completion_data_facetoface_fullyattended() {
        global $DB;
        $this->init_sample_data();
     ...
     * Reaggregation of activity completion is done via shezar_core_reaggregate_course_modules_completion().
     */
    public function test_shezar_core_update_module_completion_data_facetoface_fullyattended_course_completion() {
        global $DB;
        $this->init_sample_data();
     ...
     * Reaggregation of activity completion is done via shezar_core_reaggregate_course_modules_completion().
     */
    public function test_shezar_core_update_module_completion_data_facetoface_fullyattended_viewed() {
        global $DB;
        $this->init_sample_data();
        ...
        // Immediately after shezar_core_update_module_completion_data is called, records for this activity should
