...
M.shezar_f2f_attendees_messaging = M.shezar_f2f_attendees_messaging || {
    ...
    init: function(Y, args){
        ...
        (function() {
            var handler = new shezarDialog_handler_editrecipients();
            ...
            default_url = M.cfg.wwwroot + '/mod/facetoface/editrecipients.php?s=' + M.shezar_f2f_attendees_messaging.config.sessionid;
        ...
        $('input#id_recipient_custom').click(function() {
            ...
            shezarDialogs['editrecipients'].default_url = default_url + '&recipients=' + selected;
            shezarDialogs['editrecipients'].open();
        });
 ...
 */
shezarDialog_handler_editrecipients = function() {};
shezarDialog_handler_editrecipients.prototype = new shezarDialog_handler();

/**
 * Update recipients form with selected recipients
 */
shezarDialog_handler_editrecipients.prototype.update_recipients = function() {
