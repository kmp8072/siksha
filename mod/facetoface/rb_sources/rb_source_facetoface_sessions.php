...
class rb_source_facetoface_sessions extends rb_facetoface_base_source {
    ...
    protected function define_columnoptions() {
        ...
        $usernamefieldscreator = shezar_get_all_user_name_fields_join('creator');
    ...
    public function rb_filter_position_types_list() {
        ...
        include_once($CFG->dirroot.'/shezar/hierarchy/prefix/position/lib.php');
    ...
    public function rb_display_job_assignment_edit($jobassignment, $row, $isexport = false) {
        ...
        $jobassignment = \shezar_job\job_assignment::get_with_id($row->jobassignmentid, false);
    ...
    public function rb_display_position_type($position, $row) {
        ...
        return get_string('type' . $POSITION_TYPES[$position], 'shezar_hierarchy');
    }
