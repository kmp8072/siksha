...
$settings = new admin_settingpage($section, get_string('globalsettings', 'mod_facetoface'), 'shezar/core:modconfig', $module->is_enabled() === false);
...
// Activity defaults
$settings = new admin_settingpage('modfacetofacactivitydefaults', get_string('activitydefaults', 'mod_facetoface'), 'shezar/core:modconfig', $module->is_enabled() === false);
$ADMIN->add('modfacetofacefolder', $settings);
if ($ADMIN->fulltree) {
...
$settings = new admin_settingpage('modfacetofacesessiondefaults', get_string('sessiondefaults', 'mod_facetoface'), 'shezar/core:modconfig', $module->is_enabled() === false);
$ADMIN->add('modfacetofacefolder', $settings);
if ($ADMIN->fulltree) {
...
$ADMIN->add('modfacetofacefolder', new admin_externalpage('modfacetofacetemplates', new lang_string('notificationtemplates','facetoface'), "$CFG->wwwroot/mod/facetoface/notification/template/index.php", 'shezar/core:modconfig'));
$ADMIN->add('modfacetofacefolder', new admin_externalpage('modfacetofacerooms', new lang_string('rooms','facetoface'), "$CFG->wwwroot/mod/facetoface/room/manage.php", 'shezar/core:modconfig'));
$ADMIN->add('modfacetofacefolder', new admin_externalpage('modfacetofaceassets', new lang_string('assets','facetoface'), "$CFG->wwwroot/mod/facetoface/asset/manage.php", 'shezar/core:modconfig'));
