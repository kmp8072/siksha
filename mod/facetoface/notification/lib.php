...
class facetoface_notification extends data_object {
    ...
    */
    ...
    public function set_newevent($user, $sessionid, $sessiondate = null, $fromuser = null) {
        ...
        $this->_event->component   = 'shezar_message';
        ...
        $this->_event->sendemail = shezar_MSG_EMAIL_YES;
        $this->_event->msgtype   = shezar_MSG_TYPE_FACE2FACE;
        $this->_event->urgency   = shezar_MSG_URGENCY_NORMAL;
        $ical_content = '';
        $ical_uids = null;
        $ical_method = '';
    ...
    public function send_to_thirdparty($user, $sessionid) {
        ...
        if (!empty($this->_facetoface->thirdparty) && (!empty($this->_sessions[$sessionid]->sessiondates)
            ...
            foreach ($recipients as $recipient) {
                $event->userto = \shezar_core\shezar_user::get_external_user($recipient);
                message_send($event);
            }
        }
    }
