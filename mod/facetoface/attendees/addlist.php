...
if ($data = $mform->get_data()) {
    ...
    // Check for data.
    if (empty($addusers)) {
        shezar_set_notification(get_string('error:nodatasupplied', 'facetoface'), null, array('class' => 'notifyproblem'));
    } else if (!empty($notfound)) {
        $notfoundlist = implode(', ', $notfound);
        shezar_set_notification(get_string($errstr, 'facetoface', $notfoundlist), null, array('class' => 'notifyproblem'));
        ...
        shezar_set_notification($validationnotification, null, array('class' => 'notifyproblem'));
    } else {
