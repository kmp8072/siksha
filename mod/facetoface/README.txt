...
Copyright (C) 2010 onwards shezar LMS (http://www.shezarlms.com)
...
https://github.com/shezar/facetoface-2.0/tree/moodle-2.1.x
...
Feel free to send bug reports (and/or patches!) to the current maintainer:
  ...
  Alastair Munro <alastair.munro@shezarlms.com>
