    ...
    if ($savevalues AND !$preservevalues) {
        ...
        if ($is_switchrole) {
            ...
            if ($new_completed_id) {
                ...
                $tracking->ispresent = $formdata->present;
    ...
    if (isset($savereturn) && $savereturn == 'saved') {
        ...
        if (is_array($feedbackitems)) {
            ...
            <?php 
                ...
                $query="select tagid from {tag_instance} where itemtype='feedback' and itemid=$itemid and contextid=$contextid";
             ...
             <span style="color:blue">Mark Your Attendence
        
             <input type="radio" name="present" value='1' checked> Present
