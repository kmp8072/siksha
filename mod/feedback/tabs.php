...
if (has_capability('mod/feedback:viewreports', $context)) {
    ...
    $url_params = array('id'=>$usedid, 'do_show'=>'showallresponses');
    $reporturl = new moodle_url('/mod/feedback/show_entries_details.php', $url_params);
    $row[] = new tabobject('showallresponses',
                            $reporturl->out(),
                            get_string('show_entries_all', 'feedback'));
