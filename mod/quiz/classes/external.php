...
class mod_quiz_external extends external_api {
   ...
   public static function get_quizzes_by_courses($courseids = array()) {
        ...
        if (!empty($params['courseids'])) {
            ...
            foreach ($quizzes as $quiz) {
				...
				$quizdetails['gradepass']            = $quiz->gradepass;
                ...
                if (has_capability('mod/quiz:view', $context)) {
                    ...
                    $viewablefields = array('timeopen', 'timeclose','timelimit','attempts','grade', 'grademethod', 'section', 'visible', 'groupmode',
                                            'groupingid');
                    ...
                    if (!$accessmanager->prevent_access()) {
                        ...
                        $additionalfields = array('attemptonlast', 'grademethod', 'decimalpoints',
                                                    'questiondecimalpoints', 'reviewattempt', 'reviewcorrectness', 'reviewmarks',
                                                    'reviewspecificfeedback', 'reviewgeneralfeedback', 'reviewrightanswer',
                                                    'reviewoverallfeedback', 'questionsperpage', 'navmethod', 'sumgrades',
   ...
   public static function get_quizzes_by_courses_returns() {
                ...
                'quizzes' => new external_multiple_structure(
                    new external_single_structure(
                        array(
							...
							'gradepass' => new external_value(PARAM_INT, 'Passing Grade.'),
    ...
    public static function get_user_attempts($quizid, $userid = 0, $status = 'finished', $includepreviews = false) {
		...
		$attempts = array('Status' => 'Success','StatusCode'=>200);
    ...
    public static function get_user_best_grade($quizid, $userid = 0) {
		...
		$statusdetails = array('Status' => 'Success','StatusCode'=>200);
        $result = array();
