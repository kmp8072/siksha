...
$string['graderecentlymodified'] = 'The grade has been modified in shezar more recently than in the grading worksheet for {$a}';
...
$string['ignoremodified'] = 'Allow updating records that have been modified more recently in shezar than in the spreadsheet.';
$string['ignoremodified_help'] = 'When the grading worksheet is downloaded from shezar it contains the last modified date for each of the grades. If any of the grades are updated in shezar after this worksheet is downloaded, by default shezar will refuse to overwrite this updated information when importing the grades. By selecting this option shezar will disable this safety check and it may be possible for multiple markers to overwrite each others grades.';
$string['importgrades'] = 'Confirm changes in grading worksheet';
$string['invalidgradeimport'] = 'shezar could not read the uploaded worksheet. Make sure it is saved in comma separated value format (.csv) and try again.';
