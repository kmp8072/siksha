...
if (!has_any_capability(array('moodle/site:config', 'shezar/core:modconfig'), $context)){
    throw new required_capability_exception($context, 'shezar/core:modconfig', 'nopermissions', '');
}
