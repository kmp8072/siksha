...
$string['aiccuserid_desc'] = 'The AICC standard for usernames is very restrictive compared with shezar, and allows for alphanumeric characters, dash and underscore only. Periods, spaces and the @ symbol are not permitted. If enabled, user ID numbers are passed to the AICC package instead of usernames.';
...
$string['scorm12standarddesc'] = 'Disabling this setting allows shezar to store more data than the SCORM 1.2 specification allows.
