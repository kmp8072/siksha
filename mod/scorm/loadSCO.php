...
// shezar: already headers fixed above.
...
?>
   ...
   function doredirect() {
        if (myGetAPIHandle() != null) {
            <?php
            // shezar: open in popup (simple) option.
            if ($scorm->popup == 2) {
    ...
    <?php // shezar: BOF open in popup (simple) option. ?>
    ...
    <?php // shezar: EOF open in popup (simple) option. ?>
    //]]>
    </script>
    <noscript>
