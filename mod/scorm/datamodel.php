...
// shezar: no random error output here, instead problems are written into error log,
...
// shezar: Make sure users cannot abort this page request in the middle,
...
require_login($course, false, $cm, false, true); // shezar: no redirects here.
scorm_send_headers_shezar();
