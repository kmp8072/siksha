...
$(document).ready(function(){
   $('div.resourcecontent > span.mediaplugin.mediaplugin_html5video > video').prop('controlsList','nodownload');
   $('div.resourcecontent > span.mediaplugin.mediaplugin_html5video > video').css('width','50%');
