...
if (get_home_page() == HOMEPAGE_shezar_DASHBOARD) {
    // shezar: the only other option is HOMEPAGE_SITE
    ...
    if (!empty($CFG->allowdefaultpageselection)) {
        ...
        $PAGE->settingsnav->add(get_string('makesitemyhomepage', 'shezar_dashboard'), $newhomeurl, navigation_node::TYPE_SETTING);
    }
...
$PAGE->set_shezar_menu_selected('home');
