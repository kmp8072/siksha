...
$string['clialreadyconfigured'] = 'El archivo de configuración config.php ya existe. Por favor, utilice admin/cli/install_database.php para instalar shezar en este sitio.';
$string['clialreadyinstalled'] = 'El archivo de configuración config.php ya existe. Por favor, utilice admin/cli/install_database.php para actualizar el shezar en este sitio.';
$string['cliinstallheader'] = 'Programa de instalación shezar de línea de comando {$a}';
...
$string['dirroot'] = 'Directorio de shezar';
$string['environmenthead'] = 'Comprobando su entorno';
$string['environmentsub2'] = 'Cada versión de shezar tiene algún requisito mínimo de la versión de PHP y un número obligatorio de extensiones de PHP.
...
<p>Esto puede ocasionar que shezar tenga problemas de memoria más adelante, especialmente si usted tiene activados muchos módulos y/o muchos usuarios.</p>
...
Esto hace que shezar fije por sí mismo el límite de memoria.</li>
...
<li>En algunos servidores PHP puede crear en el directorio shezar un archivo .htaccess que contenga esta línea:
...
panel de control o algo similar. Lamentablemente, esto entra en conflicto con la ubicación estándar para las páginas de administración de shezar. Usted puede solucionar este problema, renombrando el directorio admin en su instalación shezar, poniendo un nuevo nombre aquí. Por ejemplo: <em> shezaradmin </em>. Esto solucionará los enlaces de administración en instalación shezar.';
$string['pathssubdataroot'] = '<p>Un directorio en el que shezar puede guardar los archivos subidos por usuarios.</p>
...
$string['pathssubdirroot'] = '<p>Ruta completa del directorio que contiene el código de  shezar.</p>';
$string['pathssubwwwroot'] = '<p>Dirección web completa para acceder a shezar, es decir, la dirección que los usuarios escribirán en la barra de búsqueda del navegador para acceder a shezar.</p>
<p>No es posible acceder a shezar utilizando múltiples direcciones. Si su portal tiene varias direcciones debe configurar la más sencilla y configurar un redireccionamiento permanente desde las otras.</p>
...
$string['phpversionhelp'] = '<p>shezar requiere al menos una versión de PHP 4.3.0 o 5.1.0 ((5.0.x tiene una serie de problemas conocidos).</p>
...
$string['welcomep30'] = 'Esta versión de <strong>{$a->installername}</strong> incluye las
    aplicaciones necesarias para que <strong>shezar</strong> funcione en su ordenador,
    principalmente:';
$string['welcomep40'] = 'El paquete también incluye <strong>shezar {$a->moodlerelease} ({$a->moodleversion})</strong>.';
...
$string['welcomep60'] = 'Las siguientes páginas le guiarán a través de algunos sencillos pasos para configurar y ajustar <strong>shezar</strong> en su ordenador. Puede utilizar los valores por defecto sugeridos o, de forma opcional, modificarlos para que se ajusten a sus necesidades.';
$string['welcomep70'] = 'Pulse en el botón "Siguiente" para continuar con la configuración de <strong>shezar</strong>.';
