...
$string['cliinstallheader'] = 'shezar {$a} komut satırı kurulum programı';
...
Bu, shezar\'nın kendi kendine bellek limitini ayarlasına izin verecek.</li>
...
<li>Bazı PHP sunucularında shezar klasörü içinde şu ayarı içeren bir
...
$string['pathssubadmindir'] = 'Pek az web sunucusu /admin adresini kontrol paneline yada benzeri birşeye erişmek için kullanır. Ne yazık ki bu shezar admin sayfalarının standart konumuyla bir karışıklık yaratır. Bu durumu düzeltmek için kurulumunuzdaki admin dizinini yeniden isimlendirip buraya yeni ismi yazınız. Örneğin: <em>moodleadmin</em>. Bu shezar\'daki admin bağlantısını düzeltecektir.';
$string['pathssubdataroot'] = '<p>shezar\'ın yüklenen dosyaları kayıt etmesi için bir yere ihtiyacınız var. </p>
...
$string['pathssubdirroot'] = '<p>shezar kurulumu için tam klasör yolu.</p >';
$string['pathssubwwwroot'] = '<p>shezar\'a erişilecek tam web adresi. shezar\'ın birden çok adres kullanması mümkün değildir. </p>
...
$string['phpversionhelp'] = '<p>shezar, PHP sürümünün en az 4.3.0 veya 5.1.0 olmasını gerektirir (5.0.x sürümünde çok fazla hata var).</p>
...
$string['welcomep30'] = '<strong>{$a->installername}</strong>\'nin bu sürümü <strong>shezar</strong>\'da bir ortam oluşturmak için uygulamaları içerir:';
$string['welcomep40'] = 'Bu paket <strong>shezar {$a->moodlerelease} ({$a->moodleversion})</strong> sürümünü de içerir.';
...
$string['welcomep60'] = 'Aşağıdaki sayfalar <strong>shezar</strong>ın kurulumu ve yapılandırılması için size basitçe yol gösterecektir. Varsayılan ayarları kabul edebilir veya ihtiyaçlarınıza göre bunları değiştirebilirsiniz.';
$string['welcomep70'] = '<strong>shezar</strong> kurulumu için aşağıdaki "İleri" tuşuna basın.';
