...
$string['cliinstallheader'] = 'shezar {$a} inštalačný program z príkazového riadku';
...
<p>Toto môže neskôr spôsobiť problémy v shezar, najmä ak máte veľa modulov a/alebo veľa používateľov.</p>
...
<ol>
<li>Ak je to možné, znovu vytvorte PHP s <i>--enable-memory-limit</i>. Toto umožní shezar samonastavenie limitu pamäte.</li>
...
Na niektorých PHP serveroch, si môžete vytvoriť súbor .htaccess v Adresári shezar, ktorý bude obsahovať tento riadok: <p><blockquote><div>php_value memory_limit 40M</div></blockquote></p>
...
$string['pathssubdataroot'] = 'Potrebujete adresár, kam shezar bude ukladať nahrané súbory. Adresár by mal povoliť čítanie a zapisovanie údajov používateľom web serveru, ale nesmie byť prístupný priamo cez web rozhranie. Pokiaľ ešte neexistuje, inštalácia sa pokúsi o jeho vytvorenie. ';
$string['pathssubdirroot'] = 'Plná cesta adresára shezar inštalácie';
...
$string['phpversionhelp'] = '<p>shezar si vyžaduje verziu PHP aspoň  4.3.0 alebo 5.1.0 (5.0.x obsahuje veľa známych chýb).</p>
...
$string['welcomep30'] = '<strong>{$a->installername}</strong> obsahuje aplikáciu k vytvoreniu prostredia, v ktorom bude prevádzkovaný váš <strong>shezar</strong>. Menovite sa jedná o:';
$string['welcomep40'] = 'Balíček tiež obsahuje <strong>shezar vo verzii {$a->moodlerelease} ({$a->moodleversion})</strong>.';
...
$string['welcomep60'] = 'Nasledujúce stránky vás povedú v nekoľkých jednoduchých krokoch nastavením <strong>shezar</strong> na vašom počítači. Môžete prijať východzie nastavenie, alebo si ich upraviť podľa svojich potrieb.';
$string['welcomep70'] = 'Stlačením nižšie uvedeného tlačidla "Ďalší" pokračujte v nastavení vašej inštalácie shezar.';
