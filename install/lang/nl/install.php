...
$string['clialreadyconfigured'] = 'Het configuratiebestand config.php bestaat al. Maak aub gebruik van admin/cli/install_database.php als je shezar voor deze site wenst te installeren.';
$string['clialreadyinstalled'] = 'Het configuratiebestand config.php bestaat al. Maak aub gebruik van admin/cli/install_database.php als je shezar voor deze site wenst te upgraden.';
$string['cliinstallheader'] = 'shezar {$a} command line installatieprogramma';
...
$string['dirroot'] = 'shezar-map';
$string['environmenthead'] = 'Omgeving controleren ...';
$string['environmentsub2'] = 'Elke shezar vraagt een minimale PHP-versie en een aantal vereiste PHP-extenties.
...
<p>Hierdoor kan shezar geheugenproblemen krijgen, vooral als je veel modules installeert en/of veel gebruikers hebt.</p>
...
Hierdoor kan shezar zelf zijn geheugenlimiet instellen.
...
<li>Op sommige PHP-servers kun je een .htaccess-bestand maken in de shezar-map met volgende lijn: <p><blockquote>php_value memory_limit 40M</blockquote></p>
...
$string['pathssubadmindir'] = 'Sommige webhosts gebruiken /admin als een speciale url om toegang tot bijvoorbeeld een controlepaneel te krijgen. Dit kan conflicten veroorzaken met de standaardlocatie van de shezar admin scripts. Je kunt dit oplossen door de admin map van shezar te hernoemen en de nieuwe naam hier te zetten. Bijvoorbeeld <em>moodleadmin</em>. Dat zal de admin links in shezar herstellen.';
$string['pathssubdataroot'] = '<p>Een map waar shezar geüploade bestanden kan bewaren.</p>
...
$string['pathssubdirroot'] = '<p>Het volledig pad naar de shezar-code.</p>';
$string['pathssubwwwroot'] = '<p>Het volledige webadres waarlangs de toegang naar shezar zal gebeuren - het adres dat gebruikers zullen ingeven om shezar te bereiken.</p>
<p>Het is niet mogelijk toegang tot shezar te krijgen via meerdere adressen. Als je site meerdere publieke adressen heeft, dan zul je permanente verwijzingen moeten opzetten voor al die andere adressen.</p>
...
$string['phpversionhelp'] = '<p>shezar heeft minstens PHP-versie 4.3.0 of 5.1.0 nodig (5.0.x heeft veel bekende problemen).</p> <p>De huidige versie op je server is {$a}</p>
...
$string['welcomep30'] = 'Deze uitgave van <strong>{$a->installername}</strong> bevat de software die nodig is om een omgeving te creëren waarin <strong>shezar</strong> zal werken, namelijk:';
$string['welcomep40'] = 'Dit pakket bevat ook <strong>shezar {$a->moodlerelease} ({$a->moodleversion})</strong>.';
...
$string['welcomep60'] = 'De volgende pagina\'s leiden je door een aantal makkelijk te volgen stappen om <strong>shezar</strong> te installeren op je computer. Je kunt de standaardinstellingen overnemen of, optionneel, ze aanpassen aan je noden.';
$string['welcomep70'] = 'Klik op de "volgende"-knop om verder te gaan met de installatie van <strong>shezar</strong>';
