...
Utilizzare admin/cli/install_database.php per installare shezar.';
$string['clialreadyinstalled'] = 'Il file config.php è già presente.
Utilizzare admin/cli/install_database.php per aggiornare shezar.';
$string['cliinstallheader'] = 'Programma di installazione shezar {$a} via linea di comando';
...
<p>Tale limite potrà causare problemi nel funzionamento di shezar, specialmente se usi molti moduli di attività con molti utenti.</p>
...
Questo consentirà a shezar di impostare in autonomia il limite di memoria.</li>
...
<li>Su alcuni server con il PHP è possibile creare un file .htaccess nella cartella di shezar contenente questa linea:
...
$string['pathssubadmindir'] = 'Alcuni web host utilizzano la cartella /admin come URL di accesso a pannelli di controllo od altre funzioni particolari. Tuttavia questo nome coincide con il nome della cartella che shezar utilizza per i propri file di amministrazione. Per evitare conflitti, è possibile specificare un nome alternativo per la cartella Admin di shezar. Ad esempio:<p><b>moodleadmin</b></p>
Tutti i link che puntano ai file di amministrazione di shezar terranno conto di questa variazione.';
$string['pathssubdataroot'] = '<p>La cartella dove shezar memorizzerà i file caricati dagli utenti.</p>
...
$string['pathssubdirroot'] = '<p>Percorso assoluto della cartella dove si trova il codice di shezar.</p>';
$string['pathssubwwwroot'] = '<p>L\'iIndirizzo web per raggiungere a shezar, in altre parole l\'indirizzo che gli utenti inseriranno nella barra degli indirizzi del proprio browser per accedere a questa installazione.</p>
<p>Non è possibile accedere alla stessa installazione shezar usando più di un indirizzi web. Se il tuo sito usa più indirizzi web, devi configurare dei re-indirizzamenti permanenti per tutti gli altri indirizzi web.</p>
...
$string['phpversionhelp'] = '<p>shezar necessita come minimo della versione 4.3.0 o 5.1.0 del PHP. (La versione 5.0.x soffre di problemi noti)</p>
...
$string['welcomep30'] = 'La release di <strong>{$a->installername}</strong> include l\'applicazione per creare l\'ambiente necessario a far girare <strong>shezar</strong>:';
$string['welcomep40'] = 'Il pacchetto include anche <strong>shezar {$a->moodlerelease} ({$a->moodleversion})</strong>.';
...
$string['welcomep60'] = 'Le prossime pagine ti guideranno attraverso semplici passi per installare e configurare <strong>shezar</strong> nel tuo computer. Puoi utilizzare le impostazioni di default oppure modificarle per adeguarle alle tue esigenze.';
$string['welcomep70'] = 'Fai click sul pulsante "Avanti" per continuare l\'installazione di <strong>shezar</strong>.';
