...
$string['clialreadyconfigured'] = 'Arquivo config.php já existe. Por favor, use admin/cli/install_database.php para instalar o shezar neste site.';
$string['clialreadyinstalled'] = 'Arquivo config.php já existe. Por favor use admin/cli/install_database.php para atualizar o shezar neste site.';
$string['cliinstallheader'] = 'Programa de instalação por linha de comando do shezar {$a}';
...
$string['dirroot'] = 'Diretório shezar';
$string['environmenthead'] = 'Verificando o ambiente ...';
$string['environmentsub2'] = 'Cada release do shezar requer uma versão mínima do PHP e diversas extensões do PHP.
...
Com esta operação shezar será capaz de configurar o limite de memória sózinho.</li>
...
<li>Em alguns servidores é possível fazer esta mudança criando um arquivo .htaccess no diretório shezar. O arquivo deve conter a seguinte expressão:
...
$string['pathssubadmindir'] = 'Alguns poucos webhosts usam /admin como um URL especial para acesso ao painel de controle ou outras coisas. Infelizmente isto conflita com a localizaçao padrão das páginas do administrador shezar. Você pode corrigir isso renomeando a pasta admin na sua instalação, e colocando esse novo nome aqui. Por exemplo: <em>shezaradmin</em>. Isto irá corrigir os links das páginas do administrador shezar.';
$string['pathssubdataroot'] = '<p>Um diretório em que shezar pode armazenar todo o conteúdo de arquivos enviados pelos usuários. </p>
...
$string['pathssubwwwroot'] = '<p>O endereço completo em que shezar pode ser acessado ou seja, o endereço que os usuários vão digitar na barra de endereços do seu navegador para acessar shezar. </p>
<p>Não é possível acessar shezar usando múltiplos endereços. Se o seu site é acessível através de múltiplos endereços, em seguida, escolher o mais fácil e configurar um redirecionamento permanente para cada um dos outros endereços. </p>
...
$string['phpversionhelp'] = '<p>shezar requer a versão 4.3.0 de PHP ou posterior.</p>
...
$string['welcomep30'] = 'Esta versão do <strong>{$a->installername}</strong> inclui as aplicações para a criação de um ambiente em que <strong>shezar</strong> possa operar:';
$string['welcomep40'] = 'O pacote inclui também o <strong>shezar {$a->moodlerelease} ({$a->moodleversion})</strong>.';
...
$string['welcomep60'] = 'As seguinte páginas guiam passo a passo a configuração de <strong>shezar</strong> no seu computador. Você pode usar a configuração padrão ou alterá-las de acordo com as suas necessidades.';
$string['welcomep70'] = 'Clicar o botão "Próxima" abaixo para continuar a configuração de <strong>shezar</strong>.';
