...
$string['cliinstallheader'] = 'תוכנית התקנת shezar {$a} בשורת הפקודה';
...
$string['dirroot'] = 'ספריית ה-shezar';
$string['environmenthead'] = 'בודק את הסביבה שלך...';
$string['environmentsub2'] = 'לכל התקנת shezar יש דרישות מינימליות לגרסת ה-PHP ומספר הרחבות הכרחי של ה-PHP.
...
דבר זה יאפשר ל-shezar להגדיר את גבול הזיכרון לבד. </i>
...
<i> בכמה שרתי PHP תוכל ליצור קובץ  .htaccess בספריית  ה-shezar שלך בצירוף שורה זו:
...
$string['pathssubdirroot'] = 'הנתיב המלא לספריית ההתקנה של shezar';
...
$string['welcomep30'] = 'גירסת <strong>{$a->installername}</strong> כוללת את היישומים ליצור סביבה אשר בה <strong> shezar </strong>
יפעל דהיינו:';
$string['welcomep40'] = 'החבילה כוללת בנוסף
<strong>shezar {$a->moodlerelease} ({$a->moodleversion})</strong>.';
...
$string['welcomep60'] = 'העמודים הבאים יובילו אותך בצורה פשוטה דרך כמה צעדים לקביעת הגדרות <strong>shezar</strong> בשרת.
ניתן לאשר הגדרות בררת־המחדל או לשנותם לפי צרכיך.';
$string['welcomep70'] = 'הקש על לחצן ה"המשך" למטה כדי להמשיך עם הגדרת ה-<strong>shezar</strong>';
