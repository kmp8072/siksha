...
shezar si tak bude sama moci nastavit potřebný limit.</li>
...
$string['phpversionhelp'] = '<p>shezar vyžaduje PHP alespoň verze 4.3.0 nebo 5.1.0 (PHP 5.0.x obsahuje množství chyb).</p>
...
$string['welcomep30'] = '<strong>{$a->installername}</strong> obsahuje aplikace k vytvoření prostředí, ve kterém bude provozována váše <strong>shezar</strong>. Jmenovitě se jedná o:';
$string['welcomep40'] = 'Balíček rovněž obsahuje <strong>shezar ve verzi {$a->moodlerelease} ({$a->moodleversion})</strong>.';
