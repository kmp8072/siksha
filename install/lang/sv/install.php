...
$string['cliinstallheader'] = 'Installationsprogram av typ kommandorad {$a} för shezar ';
...
$string['dirroot'] = 'Katalogen för shezar';
...
<p>Detta kan förorsaka att shezar får minnesproblem senare, särskilt om Du har aktiverat många moduler och/eller har många användare.</p>
...
<li>Om Du har möjlighet till det så kan Du kompilera om PHP med<i>--enable-memory-limit </i>Detta gör det möjligt för shezar att ställa in minnesbegränsningen själv. </li>
...
$string['phpversionhelp'] = '<p>shezar kräver minst PHP 4.3.0 eller 5.1.0 (det finns ett antal kända problem med 5.0.x)</p>
...
$string['welcomep40'] = 'I paketet ingår även <strong>shezar {$a->moodlerelease} ({$a->moodleversion})</strong>.';
...
$string['welcomep60'] = 'De följande sidorna leder Dig genom några enkla steg för att konfigurera och installera <strong>shezar</strong> på Din dator, Du kan acceptera standardinställningarna eller, alternativt, modifiera dem som det passar Dina egna behov.';
$string['welcomep70'] = 'Klicka på knappen "Nästa" här nedan för att fortsätta installationen av <strong>shezar</strong>';
