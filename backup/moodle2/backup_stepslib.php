...
class backup_course_structure_step extends backup_structure_step {
    ...
    protected function define_structure() {
        ...
        $customfield->annotate_files('shezar_customfield', 'course_filemgr', 'field_data_id', context_system::instance()->id);
        // Annotate files for text area custom field types.
        $customfield->annotate_files('shezar_customfield', 'course', 'field_data_id', context_system::instance()->id);
