...
if (shezar_feature_disabled('myteam')) {
...
$strheading = get_string('teammembers', 'shezar_core');
...
$PAGE->navbar->add(get_string('team', 'shezar_core'));
...
echo html_writer::tag('p', get_string('teammembers_text', 'shezar_core'));
