...
?>
<!-- <style>
fieldset#id_moodle_picture,fieldset#id_moodle_additional_names,fieldset#id_moodle_interests,fieldset#id_moodle_optional{    display: none !important;}
</style> -->
<style type="text/css">
    ...
    #fitem_id_firstname,#fitem_id_lastname,#fitem_id_email,#fitem_id_maildisplay,#fitem_id_city,#fitem_id_country,#fitem_id_timezone,#fitem_id_description_editor{
         display: none;
    }
    #mform1 > div.fdescription.required {
        display: none;
    }
</style>