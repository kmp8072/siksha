...
require_capability('enrol/nomination:config', $context);

$PAGE->set_url('/enrol/nomination/edit.php', array('courseid' => $course->id, 'id' => $instanceid));
$PAGE->set_pagelayout('admin');

$return = new moodle_url('/enrol/instances.php', array('id' => $course->id));
if (!enrol_is_enabled('nomination')) {
    redirect($return);
}
...
$mform = new enrol_nomination_edit_form(null, array($instance, $plugin, $context));
...
$PAGE->set_title(get_string('pluginname', 'enrol_nomination'));
