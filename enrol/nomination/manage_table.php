...
class enrol_nomination_manage_table extends table_sql {

    public $is_collapsible = false;

    public function __construct($enrolid = null) {
        parent::__construct('enrol_nomination_manage_table');
        ...
        $this->set_sql(
            ...
            LEFT JOIN {enrol_nomination_applicationinfo} ai ON ai.userenrolmentid = ue.id
    ...
    public function get_row_class($row) {
        if ($row->enrolstatus == 2) {
            return 'enrol_nomination_waitinglist_highlight';
        }
        return '';
    }
    ...
    public function col_nominationdate($row) {
