...
$string['enrolname'] = 'Request For Nomination';
$string['pluginname'] = 'Request For Nomination';
...
$string['notifycoursebased_desc'] = "Default for new instances: Notify everyone who have the 'Manage Nomination enrolment' capability for the corresponding course (eg. teachers and managers)";
...
$string['nomination:config'] = 'Configure nomination enrol instances';
$string['nomination:manageapplications'] = 'Manage nomination enrolment';
$string['nomination:unenrol'] = 'Cancel users from the course';
$string['nomination:unenrolself'] = 'Cancel self from the course';
...
$string['nominationmanage'] = 'Manage enrolment applications';
