...
/**
 * Test shezar bulk enrolment modifications.
 */
class enrol_cohort_bulk_sync_testcase extends advanced_testcase {
    ...
    public function test_enrolments() {
        ...
        $this->assertInstanceOf('shezar_core\event\bulk_enrolments_started', $events[0]);
        $this->assertInstanceOf('core\event\user_enrolment_created', $events[1]);
        $this->assertInstanceOf('shezar_core\event\bulk_enrolments_ended', $events[2]);
        ...
        $this->assertInstanceOf('shezar_core\event\bulk_enrolments_ended', $events[6]);
    ...
    public function test_unenrolments() {
        ...
        $this->assertInstanceOf('shezar_core\event\bulk_enrolments_ended', $events[5]);
    ...
    public function test_roles() {
        ...
        $this->assertInstanceOf('shezar_core\event\bulk_role_assignments_ended', $events[18]);
        $this->assertEquals(7, $DB->count_records('enrol'));
        $this->assertEquals(8, $DB->count_records('user_enrolments'));
        ...
        $this->assertInstanceOf('core\event\user_enrolment_updated', $events[1]);
        $this->assertInstanceOf('shezar_core\event\bulk_enrolments_ended', $events[2]);
        $this->assertInstanceOf('shezar_core\event\bulk_role_assignments_started', $events[3]);
        $this->assertInstanceOf('core\event\role_unassigned', $events[4]);
        $this->assertInstanceOf('shezar_core\event\bulk_role_assignments_ended', $events[5]);
        $this->assertEquals(7, $DB->count_records('enrol'));
        $this->assertEquals(8, $DB->count_records('user_enrolments'));
    ...
    public function test_groups() {
        ...
        $this->assertInstanceOf('shezar_core\event\bulk_enrolments_ended', $events[3]);
        $this->assertEquals(4, $DB->count_records('enrol'));
        $this->assertEquals(5, $DB->count_records('user_enrolments'));
        $this->assertEquals(1, $DB->count_records('role_assignments'));
