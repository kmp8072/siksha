 ...
 * @param int $cohortid ID of the cohort being synced (shezar performance only)
...
function enrol_cohort_sync(progress_trace $trace, $courseid = NULL, $cohortid = NULL) {
    ...
    shezar_cohort_check_and_update_dynamic_cohort_members($courseid, $trace, $cohortid);
    ...
    foreach ($rseids as $enrol) {
        ...
        \shezar_core\event\bulk_enrolments_started::create_from_instance($instance)->trigger();
    ...
    shezar_cohort_delete_stale_memberships();
