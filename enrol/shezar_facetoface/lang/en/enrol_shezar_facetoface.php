...
/**
 * Strings for component 'enrol_shezar_facetoface', language 'en'.
 */
...
$string['customwelcomemessage_help'] = 'A custom welcome message may be added as plain text or shezar-auto format, including HTML tags and multi-lang tags.
...
$string['shezar_facetoface:config'] = 'Configure Seminar Direct enrolment instances';
$string['shezar_facetoface:manage'] = 'Manage Seminar Direct enrolled users';
$string['shezar_facetoface:unenrol'] = 'Unenrol Seminar Direct enrolment users from course';
$string['shezar_facetoface:unenrolself'] = 'Unenrol self from the course and seminar events';
