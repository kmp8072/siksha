...
global $CFG;
require_once($CFG->dirroot . '/enrol/shezar_facetoface/lib.php');

/**
 * Class enrol_shezar_facetoface_testcase
 * @group enrol_shezar_facetoface
 */
class enrol_shezar_facetoface_testcase extends advanced_testcase {
    ...
    protected function enable_plugin() {
        ...
        $enabled['shezar_facetoface'] = true;
    ...
    protected function disable_plugin() {
        $enabled = enrol_get_plugins(true);
        unset($enabled['shezar_facetoface']);
        $enabled = array_keys($enabled);
        set_config('enrol_plugins_enabled', implode(',', $enabled));
    }
    ...
    public function test_basics() {
        ...
        $this->assertFalse(enrol_is_enabled('shezar_facetoface'));
        $plugin = enrol_get_plugin('shezar_facetoface');
        $this->assertInstanceOf('enrol_shezar_facetoface_plugin', $plugin);

        self::enable_plugin();
        $this->assertTrue(enrol_is_enabled('shezar_facetoface'));
    }

    public function test_sync_nothing() {
        global $SITE;

        $selfplugin = enrol_get_plugin('shezar_facetoface');
    ...
    public function test_longtimnosee() {
        ...
        $this->assertEquals(3, $DB->count_records('enrol', array('enrol' => 'shezar_facetoface')));
        $instance1 = $DB->get_record('enrol', array('courseid' => $course1->id, 'enrol' => 'shezar_facetoface'), '*', MUST_EXIST);
        $instance2 = $DB->get_record('enrol', array('courseid' => $course2->id, 'enrol' => 'shezar_facetoface'), '*', MUST_EXIST);
        $instance3 = $DB->get_record('enrol', array('courseid' => $course3->id, 'enrol' => 'shezar_facetoface'), '*', MUST_EXIST);
    ...
    public function test_send_expiry_notifications() {
        ...
        $this->assertEquals(4, $DB->count_records('enrol', array('enrol' => 'shezar_facetoface')));
        ...
        $instance4 = $DB->get_record('enrol', array('courseid' => $course4->id, 'enrol' => 'shezar_facetoface'), '*', MUST_EXIST);
    ...
    public function test_show_enrolme_link() {
        ...
        // Cohort member test.
        $instance5 = $DB->get_record('enrol', array('courseid' => $course5->id, 'enrol' => 'shezar_facetoface'), '*', MUST_EXIST);
        ...
        $instance7 = $DB->get_record('enrol', array('courseid' => $course6->id, 'enrol' => 'shezar_facetoface'), '*', MUST_EXIST);
        ...
        $instance8 = $DB->get_record('enrol', array('courseid' => $course7->id, 'enrol' => 'shezar_facetoface'), '*', MUST_EXIST);
        ...
        $instance9 = $DB->get_record('enrol', array('courseid' => $course8->id, 'enrol' => 'shezar_facetoface'), '*', MUST_EXIST);
        ...
        $instance10 = $DB->get_record('enrol', array('courseid' => $course9->id, 'enrol' => 'shezar_facetoface'), '*', MUST_EXIST);
        ...
        $instance11 = $DB->get_record('enrol', array('courseid' => $course10->id, 'enrol' => 'shezar_facetoface'), '*', MUST_EXIST);
        ...
        $instance12 = $DB->get_record('enrol', array('courseid' => $course11->id, 'enrol' => 'shezar_facetoface'), '*', MUST_EXIST);
    ...
    public function test_can_enrol() {
        ...
        $expectederrorstring = get_string('cannotenrol', 'enrol_shezar_facetoface');
    ...
    public function test_enrol_shezar_facetoface_find_best_session() {
        global $CFG;
        ...
        $shezar_facetoface = enrol_get_plugin('shezar_facetoface');

        $this->setUser(null); // Sloppy test code!
        $this->assertNull(enrol_shezar_facetoface_find_best_session($shezar_facetoface, $facetoface->id));
        ...
        $this->setUser(null); // Sloppy test code!
        $best = enrol_shezar_facetoface_find_best_session($shezar_facetoface, $facetoface->id);
    ...
    public function test_enrol_shezar_facetoface_get_sessions_to_autoenrol() {
        global $CFG;
        $CFG->debug = false; // Suppress debugging as faked raises a message fails the test.
        ...
        $shezar_facetoface = enrol_get_plugin('shezar_facetoface');
        $sessions = enrol_shezar_facetoface_get_sessions_to_autoenrol($shezar_facetoface, $course1, $facetofaces, $user2);
