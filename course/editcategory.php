...
if ($mform->is_cancelled()) {
    if ($type != 'course') {
        $manageurl = new moodle_url('/shezar/program/manage.php');
    ...
    if ($type == 'course') {
        ...
        redirect(new moodle_url('/shezar/program/manage.php',
...
if (empty($id) && empty($parent) && $type == 'course') {
    ...
    navigation_node::override_active_url(new moodle_url('/shezar/program/manage.php', array('viewtype' => $type)));
}
