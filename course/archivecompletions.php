...
if (!empty($coursesets)) {
    ...
    if (!empty($prognames)) {
        ...
        echo get_string('programs', 'shezar_program');
    ...
    if (!empty($certnames)) {
        ...
        echo get_string('certifications', 'shezar_certification');
        echo html_writer::start_tag('ul');
...
if (!$archive) {
    ...
    \shezar_core\event\course_completion_archived::create_from_course($course)->trigger();
