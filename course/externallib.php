...
class core_course_external extends external_api {
    ...
    public static function create_courses($courses) {
        ...
        foreach ($params['courses'] as $course) {
            ...
            $course = self::shezar_course_validate_parameters($course);
    ...
    /**
     * Validates submitted shezar parameters, if anything is incorrect
     ...
     */
    private static function shezar_course_validate_parameters($course) {
        global $CFG;
        ...
        if (isset($course['coursetype'])) {
            ...
            if (!in_array($course['coursetype'], $shezar_COURSE_TYPES)) {
