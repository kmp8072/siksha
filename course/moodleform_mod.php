...
abstract class moodleform_mod extends moodleform {
                ...
                if ($unlockcompletion) {
                    ...
                    $mform->insertElementBefore(
                        $mform->createElement('static', 'completedunlocked',
                            ...
                            get_string('activitycompletionunlockedtext', 'shezar_core')),
                        'unlockcompletion');
                    $mform->removeElement('unlockcompletion');
                    $mform->removeElement('unlockcompletionnoreset');
                    $mform->getElement('completionunlocked')->setValue(1);
                    ...
                    $mform->insertElementBefore(
                        $mform->createElement('static', 'completedunlocked',
                            get_string('completedunlocked', 'completion'),
                            get_string('activitycompletionunlockednoresettext', 'shezar_core')),
                        'unlockcompletion');
                    $mform->removeElement('unlockcompletion');
                    $mform->removeElement('unlockcompletionnoreset');
                    $mform->getElement('completionunlocked')->setValue(1);
                    ...
                    $mform->insertElementBefore(
                        $mform->createElement('static', 'completedwarning',
                            ...
                            get_string('completedwarningtext', 'shezar_core')),
                        'unlockcompletion');
                    $freeze = true;
                }
            }
    ...
    function standard_coursemodule_elements(){
        ...
        if ($completion->is_enabled()) {
            ...
            $mform->addElement('submit', 'unlockcompletion', get_string('unlockcompletion', 'shezar_core'));
            $mform->registerNoSubmitButton('unlockcompletion');
            $mform->addElement('hidden', 'completionunlocked', 0);
            $mform->setType('completionunlocked', PARAM_INT);

            $mform->addElement('submit', 'unlockcompletionnoreset', get_string('unlockcompletionnoreset', 'shezar_core'));
