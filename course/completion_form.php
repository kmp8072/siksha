...
//--------------------------------------------------------------------------------
        ...
        if (!empty($activities)) {
            ...
            // shezar: tell users how we deal with failed activity completions in course completions.
            if (!empty($CFG->completionexcludefailures)) {
                $note2 = get_string('completionexcludefailureson','shezar_core');
            } else {
                $note2 = get_string('completionexcludefailuresoff','shezar_core');
            }
