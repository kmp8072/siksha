...
function update_moduleinfo($cm, $moduleinfo, $course, $mform = null) {
    ...
    if ($completion->is_enabled()) {
        ...
        if (!empty($moduleinfo->completionunlocked)) {
            ...
            if (!empty($moduleinfo->completionunlockednoreset)) {
                // shezar - Trigger module_completion_unlocked event here.
                \shezar_core\event\module_completion_unlocked::create_from_module($moduleinfo)->trigger();
            }
        }
    ...
    // shezar - the function below allows for unlock completion with delete.
    shezar_core_update_module_completion_data($cm, $moduleinfo, $course, $completion);
