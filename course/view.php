...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('.material-button.material-button-toggle.closed > i').removeClass('fa-angle-down');
		$('.material-button.material-button-toggle.closed > i').addClass('fa-angle-up');
		$('.section.img-text').addClass('open');
		$('.section.img-text').css("display", "block");

		// $('.section.img-text').addClass('section.img-text.open');
	});
	
</script>
<style type="text/css">
  /*  div.content.box-body.row > div.clearfix{
        display: none !important;
    }*/
    .wdm_img{
         display: none !important;
    }
    .material-button.material-button-toggle, .toggle-section-btn{
        display: none !important;
    }
</style>