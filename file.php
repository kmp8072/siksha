...
// shezar: no point in returning to this script.
...
if ($course->id != SITEID) {
    ...
    if (!empty($CFG->sitepolicy)
        && ($CFG->sitepolicy == $CFG->wwwroot.'/file.php/'.$courseid.'/'.$relativepath
             || $CFG->sitepolicy == $CFG->wwwroot.'/file.php?file=/'.$courseid.'/'.$relativepath)) {
