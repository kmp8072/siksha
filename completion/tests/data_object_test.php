 ...
 * @copyright  2016 shezar Learning Solutions
    ...
    public function setUp() {
        ...
        $users = [
            ['username' => 'samh', 'firstname' => 'Sam', 'lastname' => 'Hemelryk', 'password' => 'samh',
                'email' => 'sam.hemelryk@shezarlearning.com'],
            ['username' => 'petrs', 'firstname' => 'Petr', 'lastname' => 'Škoda', 'password' => 'petrs',
                'email' => 'petr.skoda@shezarlearning.com'],
            ['username' => 'simonc', 'firstname' => 'Simon', 'lastname' => 'Coggins', 'password' => 'simonc',
                'email' => 'simon.coggins@shezarlearning.com'],
            ['username' => 'davek', 'firstname' => 'David', 'lastname' => 'Krill', 'password' => 'davidk',
                'email' => 'david.kirll@shezarlearning.com', 'description' => 'Test description', 'descriptionformat' => FORMAT_MOODLE],
        ];
