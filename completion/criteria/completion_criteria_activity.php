...
class completion_criteria_activity extends completion_criteria {
    ...
    // shezar performance improvement - Static cache of courses  to speed up loadtimes in review & get_details.
    ...
    public function review($completion, $mark = true) {
        ...
        // shezar performance improvement - Get cached completion info.
        ...
        // shezar: let admin decide how to deal with activity completion failures in course completion
        global $CFG;
        ...
        if (in_array($data->completionstate, $completedstates)) {
            if ($mark) {
                ...
                // shezar Hack - Reload the completion criteria object, it may be outdated after the get_data() call.
