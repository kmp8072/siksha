...
class rb_source_dp_program extends rb_base_source {
    ...
    protected function define_columnoptions() {
        ...
        $columnoptions[] = new rb_column_option(
            'program',
            'mandatory',
            get_string('programmandatory', 'shezar_program'),
        ...
        $columnoptions[] = new rb_column_option(
            'program',
            'recurring',
            get_string('programrecurring', 'shezar_program'),
            "base.id",
            array(
                'joins' => 'program_completion',
    ...
    function rb_display_recurring_status($programid, $row) {
        ...
        if (isset($coursesets[0])) {
            ...
            if ($courseset->is_recurring()) {
                ...
                $link = get_string('yes');
                $link .= $OUTPUT->action_link(new moodle_url('/shezar/plan/record/programs_recurring.php', array('programid' => $programid, 'userid' => $userid)), get_string('viewrecurringprogramhistory', 'shezar_program'));
                return $link;
            }
        }
        return get_string('no');
    ...
    public function rb_display_program_previous_completion($name, $row) {
        global $OUTPUT;
        return $OUTPUT->action_link(new moodle_url('/shezar/plan/record/programs.php',
    ...
    protected function define_filteroptions() {
        ...
        $this->add_cohort_program_fields_to_filters($filteroptions, 'shezar_program');
