...
require_once($CFG->dirroot . '/shezar/reportbuilder/classes/rb_join_nonpruneable.php');
...
class rb_source_dp_objective extends rb_base_source {
    ...
    public function rb_display_objectivelink($objective, $row) {
        ...
        return $OUTPUT->action_link(new moodle_url('/shezar/plan/components/objective/view.php', array('id' => $row->plan_id, 'itemid' => $row->objective_id)), $objective);
    }
