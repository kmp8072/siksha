...
class dp_userdriven_workflow extends dp_base_workflow {
    ...
    function __construct() {
        global $CFG;
        require_once($CFG->dirroot.'/shezar/plan/objectivescales/lib.php');
        ...
        $this->perm_plan_completereactivate_learner = DP_PERMISSION_ALLOW;
        ...
        $this->perm_program_updateprogram_learner = DP_PERMISSION_ALLOW;
        $this->perm_program_updateprogram_manager = DP_PERMISSION_ALLOW;
        $this->perm_program_setpriority_learner = DP_PERMISSION_ALLOW;
        $this->perm_program_setpriority_manager = DP_PERMISSION_ALLOW;
        $this->perm_program_setduedate_learner = DP_PERMISSION_ALLOW;
