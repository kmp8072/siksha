...
define(['jquery', 'core/config'], function($, mdlconfig) {
    ...
    var component = {
        ...
        init: function(args) {
            ...
            // Create the dialog.
            component.shezarDialog_handler_preRequisite = function() {
                // Base url.
                var baseurl = '';
            };

            component.shezarDialog_handler_preRequisite.prototype = new shezarDialog_handler_treeview_multiselect();
             ...
             * @return void
             */
            component.shezarDialog_handler_preRequisite.prototype._update = function(response) {
                // Hide dialog.
                this._dialog.hide();
                // Update table
                component.shezar_shezar_plan_update(response);
            };
        },
        ...
        add_handlers : function() {
            ...
            jQuery('table.dp-plan-component-items input, table.dp-plan-component-items select').change(function() {
                ...
                $.post(
                    mdlconfig.wwwroot + '/shezar/plan/component.php?id=' + component.config.plan_id +
                        '&c=' + component.config.component_name + '&page=' + component.config.page,
                    data,
                    component.shezar_shezar_plan_update
                );
            });
        },
         ...
         * @return  void
         */
        shezar_shezar_plan_update: function(response) {
            ...
            require(['core/str'], function (mdlstr) {
                mdlstr.get_string('datepickerlongyeardisplayformat', 'shezar_core').done(function (format) {
                    // This function does not use Y so no point in sending it.
                    M.shezar_core.build_datepicker(null, "[id^=duedate_" + component.config.component_name + "]", format);
                });
            });
        }
    };
