...
$PAGE->set_url(new moodle_url('/shezar/plan/record/programs_recurring.php',
...
if ($USER->id != $userid) {
    ...
    $strheading = get_string('recurringprogramhistoryfor', 'shezar_program', $a);
    ...
    $strheading = get_string('recurringprogramhistory', 'shezar_program', format_string($program->fullname));
    $menuitem = null;
    $url = null;
}
// Get subheading name for display.
$strsubheading = get_string('recurringprograms', 'shezar_program');
