...
class plan_reactivate_form extends moodleform {
    function definition() {
        ...
        $mform->addElement('static', 'reactivatecheck', null, get_string('checkplanreactivate', 'shezar_plan', $plan->name));
        ...
        $this->add_action_buttons(true, get_string('reactivate', 'shezar_plan'));
    }
    ...
    function validation($data, $files) {
        ...
        if (!empty($data['validate_date'])) {
            ...
            if ($datenow > $enddate && $enddate !== false) {
                ...
                $errstr = get_string('error:reactivatedatebeforenow', 'shezar_plan');
