 ...
 */
M.shezar_plan_objective_find_course = M.shezar_plan_objective_find_course || {
 ...
 // public handler reference for the dialog
    ...
    init: function(Y, args){
        ...
        shezarDialog_handler_preRequisite = function() {
            // Base url
            var baseurl = '';
        }

        shezarDialog_handler_preRequisite.prototype = new shezarDialog_handler_treeview_multiselect();
         ...
         * @return void
         */
        shezarDialog_handler_preRequisite.prototype._update = function(response) {
        ...
        shezarDialogs['evidence'] = new shezarDialog(
            ...
            {
                buttons: buttonsObj,
                title: '<h2>' + M.util.get_string('addlinkedcourses', 'shezar_plan') + '</h2>'
            },
