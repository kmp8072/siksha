 ...
 */
M.shezar_plan_competency_find = M.shezar_plan_competency_find || {
    ...
    shezarDialog_handler_lpCompetency: null,
    ...
    init: function(Y, args){
        ...
        M.shezar_plan_competency_find.Y = Y;
        ...
        if (args) {
            ...
            for (var a in jargs) {
                if (Y.Object.owns(jargs, a)) {
                    M.shezar_plan_competency_find.config[a] = jargs[a];
                }
            }
        }
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.shezar_plan_competency_find.init()-> jQuery dependency required for this module to function.');
        }

        require(['shezar_plan/component'], function (component) {
            component.init(M.shezar_plan_competency_find.config);

            // Create handler for the dialog
            M.shezar_plan_competency_find.shezarDialog_handler_lpCompetency = function() {
                // Base url
                var baseurl = '';
            }

            M.shezar_plan_competency_find.shezarDialog_handler_lpCompetency.prototype = new component.shezarDialog_handler_preRequisite();
             ...
             * @return  void
             */
            M.shezar_plan_competency_find.shezarDialog_handler_lpCompetency.prototype._open = function() {
             ...
             * @return  void
             */
            M.shezar_plan_competency_find.shezarDialog_handler_lpCompetency.prototype._continue = function(url) {
             ...
             * @return  void
             */
            M.shezar_plan_competency_find.shezarDialog_handler_lpCompetency.prototype._continueRender = function(response) {
             ...
             * @return void
             */
            shezarDialog_handler.prototype._continueSave = function(url) {

                // Serialize form data
                var data_str = $('form', M.shezar_plan_competency_find._container).serialize();
            ...
            var continueurl = url + 'confirm.php?id='+M.shezar_plan_competency_find.config.plan_id+'&update=';
            var saveurl = url + 'update.php?id='+M.shezar_plan_competency_find.config.plan_id+'&update=';
            var continueskipurl = saveurl + 'id='+M.shezar_plan_competency_find.config.plan_id+'&update=';
            var continuesaveurl = url + 'update.php?';

            var handler = new M.shezar_plan_competency_find.shezarDialog_handler_lpCompetency();
            handler.baseurl = url;
            handler.continueskipurl = continueskipurl;

            handler.standard_buttons = {};
            handler.standard_buttons[M.util.get_string('save', 'shezar_core')] = function() { handler._save(saveurl) }
            ...
            handler.continuesave_buttons[M.util.get_string('save', 'shezar_core')] = function() { handler._continueSave(continuesaveurl) }
            ...
            shezarDialogs['evidence'] = new shezarDialog(
                ...
                {
                    buttons: {},
                    title: '<h2>' + M.util.get_string('addcompetencys', 'shezar_plan') + '</h2>'
                },
                url + 'find.php?id=' + M.shezar_plan_competency_find.config.plan_id,
                handler
            );
        });
    }
