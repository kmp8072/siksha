...
if ($component->get_setting('setproficiency') != DP_PERMISSION_ALLOW) {
    print_error('error:competencystatuspermission', 'shezar_plan');
}
...
$mform = new shezar_competency_evidence_form(null, compact('id','evidenceid','competencyid','positionid',
...
if ($fromform = $mform->get_data()) { // Form submitted
    if (empty($fromform->submitbutton)) {
        print_error('error:unknownbuttonclicked', 'shezar_core', $returnurl);
    }
    ...
    if ($result) {
        ...
        redirect($returnurl, get_string('recordnotcreated', 'shezar_core'));
    }
...
$fullname = get_string('setcompetencystatus', 'shezar_plan');
