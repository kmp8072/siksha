...
class shezar_course_rpl_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('header', 'rpl_general', get_string('coursecompletion', 'shezar_plan'));

        $mform->addElement('text', 'rpl', get_string('rpl', 'shezar_plan'), array('maxsize' => '255', 'size' => '50'));
