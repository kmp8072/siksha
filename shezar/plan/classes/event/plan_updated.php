...
class plan_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventplanupdated', 'shezar_plan');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' updated the plan {$this->objectid}:{$this->other['name']}";
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array(SITEID, 'plan', "updated plan", $logurl, "{$this->objectid}:plan");
    }
