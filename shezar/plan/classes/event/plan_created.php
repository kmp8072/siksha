...
/**
 * Event triggered when a plan is created
 *
...
class plan_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventplancreated', 'shezar_plan');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' created the plan {$this->objectid}:{$this->other['name']}";
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array(SITEID, 'plan', 'plan created', $logurl, "{$this->objectid}:{$this->other['name']}");
    }
