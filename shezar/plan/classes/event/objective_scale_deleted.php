...
/**
 * Event triggered when objective scale deleted.
 *
 ...
 * }
 */
class objective_scale_deleted extends \core\event\base {
    /**
     ...
     * @return objective_scale_deleted
     */
    public static function create_from_scale($scale) {
        ...
        /** @var objective_scale_deleted $event */
    ...
    public static function get_name() {
        return get_string('eventobjectivescaledeleted', 'shezar_plan');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' deleted objective scale with id '{$this->objectid}'";
    }
