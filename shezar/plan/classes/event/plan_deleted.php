...
/**
 * Event triggered when a plan is deleted
 *
...
class plan_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventplandeleted', 'shezar_plan');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' deleted the plan {$this->objectid}:{$this->other['name']}";
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array(SITEID, 'plan', 'plan deleted', $logurl, "{$this->objectid}:{$this->other['name']}");
    }
    ...
    public function get_url() {
        return new \moodle_url('/shezar/plan/index.php', array('userid' => $this->relateduserid));
    }
