...
/**
 * Event triggered when a plan, or a component in a plan, is approved
 *
 ...
 *
 */
class approval_approved extends \core\event\base {
    /**
    ...
    public static function get_name() {
        return get_string('eventapprovalapproved', 'shezar_plan');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '{$this->userid}' approved {$desc} {$this->objectid}:{$this->other['name']} for user {$this->relateduserid}";
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array(SITEID, 'plan', "approved {$component}", $logurl, $this->other['componentname']);
    }
