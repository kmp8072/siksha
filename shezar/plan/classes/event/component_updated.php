...
class component_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcomponentupdated', 'shezar_plan');
    }
    ...
    public function get_url() {
        ...
        switch ($component) {
            ...
            case 'objective':
            case 'program':
                $logurl = new \moodle_url("/shezar/plan/components/$component/view.php", array('id' => $this->objectid, 'itemid' => $this->other['componentid']));
                break;
            case 'competencyproficiency':
                ...
                $logurl = new \moodle_url('/shezar/plan/components/competency/update-competency-setting.php', $params);
                break;
            default:
