...
/**
 * Event triggered when a component is added to a plan
 *
 ...
 *
 */
class component_created extends \core\event\base {
    /**
    ...
    public static function get_name() {
        return get_string('eventcomponentcreated', 'shezar_plan');
    }
    ...
    public function get_description() {
        $desc = "The user with id '{$this->userid}' added {$this->other['component']}";
        $desc .= " {$this->other['componentid']}:{$this->other['componentname']}";
        $components = array('objectivescales', 'objectivescalevalues', 'priorityscales', 'priorityscalevalues', 'evidencetype');
    ...
    protected function get_legacy_logdata() {
        ...
        return array(SITEID, 'plan', "added {$this->other['component']}", $logurl, "{$this->other['componentid']}:{$this->other['componentname']}");
    }
