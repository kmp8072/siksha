...
/**
 * Event triggered when a plan is reactivated
 *
 ...
 *
 */
class plan_reactivated extends \core\event\base {
    /**
    ...
    public static function get_name() {
        return get_string('eventplanreactivated', 'shezar_plan');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' reactivated the plan {$this->objectid}:{$this->other['name']}";
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array(SITEID, 'plan', 'plan reactivated', $logurl, "{$this->objectid}:{$this->other['name']}");
    }
    ...
    public function get_url() {
        return new \moodle_url('/shezar/plan/view.php', array('id' => $this->objectid));
    }
