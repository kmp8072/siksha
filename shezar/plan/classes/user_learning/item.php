...
namespace shezar_plan\user_learning;
...
class item extends item_base implements item_has_progress {
     ...
     * @var \shezar_plan\user_learning\course[]
     */
    protected $courses;
    ...
    protected function map_learning_item_record_data(\stdClass $data) {
        ...
        $this->url_view = new \moodle_url('/shezar/plan/view.php', array('id' => $this->id));
    }
     ...
     *
     * @return \shezar_plan\user_learning\course[] An array of course learning items
     */
