 ...
 * @package shezar_plan
 */
class shezar_plan_generator extends component_generator_base {
    ...
    public function add_learning_plan_competency($planid, $competencyid) {
        ...
        if (!has_capability('shezar/plan:manageanyplan', context_system::instance())) {
            debugging('add_learning_plan_competency generator needs shezar/plan:manageanyplan capability!');
            return false;
        }
