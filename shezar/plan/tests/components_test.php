 ...
 * vendor/bin/phpunit --verbose shezar_plan_components_testcase shezar/plan/tests/components_test.php
 */
class shezar_plan_components_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $this->plan_generator = $this->data_generator->get_plugin_generator('shezar_plan');
        $this->program_generator = $this->data_generator->get_plugin_generator('shezar_program');
    }
    ...
    public function test_course_get_assigned_items() {
        ...
        $plangenerator = $datagenerator->get_plugin_generator('shezar_plan');
        $planrecord = $plangenerator->create_learning_plan(array('userid' => $user->id));
        $plan = new development_plan($planrecord->id);
    ...
    public function test_program_get_assigned_items() {
        ...
        $programgenerator = $datagenerator->get_plugin_generator('shezar_program');
    ...
    public function test_get_assigned_competencies_linked() {
        ...
        $hierarchygenerator = $datagenerator->get_plugin_generator('shezar_hierarchy');
        $competencyframework = $hierarchygenerator->create_framework('competency');
    ...
    public function test_send_component_update_alert() {
        ...
        $learner1ja1 = \shezar_job\job_assignment::create_default($learner1->id, array('managerjaid' => $manager1ja->id));
        $learner1ja2 = \shezar_job\job_assignment::create_default($learner1->id, array('managerjaid' => $manager2ja->id));
        $learner1ja3 = \shezar_job\job_assignment::create_default($learner1->id, array('managerjaid' => $manager3ja->id));
