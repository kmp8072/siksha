...
use shezar_form\form\element\text,
    shezar_form\form\group\section,
    shezar_form\model,
    shezar_form\test\test_definition,
    shezar_form\test\test_form;

/**
 * Test for \shezar_form\model class.
 */
class shezar_form_model_testcase extends advanced_testcase {
    ...
    public function test_get_id_suffix() {
        $definition = new test_definition($this,
            function (model $model, advanced_testcase $testcase) {
                $testcase->assertSame('shezar_form_test_test_form', $model->get_id_suffix());
            });
        test_form::phpunit_set_definition($definition);
        test_form::phpunit_set_post_data(null);
        new test_form();
    ...
    public function test_get_id() {
        $definition = new test_definition($this,
            function (model $model, advanced_testcase $testcase) {
                $testcase->assertSame('tf_fid_shezar_form_test_test_form', $model->get_id());
            });
        test_form::phpunit_set_definition($definition);
        test_form::phpunit_set_post_data(null);
        new test_form();
    ...
    public function test_add_action_buttons() {
        $definition = new test_definition($this,
            function (model $model, advanced_testcase $testcase) {
                ...
                $buttongroup = $model->find('actionbuttonsgroup', 'get_name', 'shezar_form\form\group\buttons');
                $submitbutton = $model->find('submitbutton', 'get_name', 'shezar_form\form\element\action_button');
                $cancelbutton = $model->find('cancelbutton', 'get_name', 'shezar_form\form\element\action_button');
    ...
    public function test_find() {
        $definition = new test_definition($this,
            function (model $model, advanced_testcase $testcase) {
                ...
                $result = $model->find('sometext2', 'get_name', 'shezar_form\item');
                $this->assertSame($text2, $result);

                $result = $model->find('sometext2', 'get_name', 'shezar_form\element');
                $this->assertSame($text2, $result);

                $result = $model->find('sometext2', 'get_name', 'shezar_form\group');
                $this->assertNull($result);

                $result = $model->find('sometext2', 'get_name', 'shezar_form\element', false);
                $this->assertNull($result);

                $result = $model->find('somesection2', 'get_name', 'shezar_form\group', true);
                $this->assertSame($section2, $result);

                $result = $model->find('somesection2', 'get_name', 'shezar_form\group', false);
                $this->assertSame($section2, $result);

                $result = $model->find(true, 'is_name_used', 'shezar_form\item', true, array('sometext2'));
                $this->assertSame($text2, $result);

                $result = $model->find('0', 'is_name_used', 'shezar_form\item', true, array('sometext2'), false);
                $this->assertSame($section1, $result);

                $result = $model->find('0', 'is_name_used', 'shezar_form\item', true, array('sometext2'), true);
                $this->assertNull($result);
            });
        test_form::phpunit_set_definition($definition);
        test_form::phpunit_set_post_data(null);
