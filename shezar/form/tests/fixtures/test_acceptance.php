...
$classes = \core_component::get_namespace_classes('form\testform', '\shezar_form\form\testform\form');
...
$PAGE->set_url(new moodle_url('/shezar/form/tests/fixtures/test_acceptance.php'));
...
if ($formclass) {
    ...
    /** @var \shezar_form\form\testform\form $form */
...
$PAGE->set_title('shezar form acceptance tests');
$PAGE->set_heading('shezar form acceptance tests');
...
if (isset($form)) {
    if ($form->is_cancelled()) {
        ...
        $js = <<<EOD
require(["shezar_form/form"], function(Form) {
