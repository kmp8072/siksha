...
class test_definition {
     ...
     *
     * @param $elname
     * @return \shezar_form\element
     */
    public function get_element($elname) {
        return $this->model->find($elname, 'get_name', 'shezar_form\element', true);
    }
}
