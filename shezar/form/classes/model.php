...
use shezar_form\form\group\buttons,
...
class model implements item {
    ...
    public function add(item $item, $position = null) {
        ...
        if ($this->find(true, 'is_name_used', 'shezar_form\item', true, array($item->get_name(), false))) {
     ...
     * @return clientaction|\shezar_form\form\clientaction\hidden_if
     */
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        if ($this->is_form_submitted() and !$this->is_valid()) {
            ...
            $this->add_error(get_string('submissionerror', 'shezar_form'));
        }

        if ($this->find(true, 'get_attribute', 'shezar_form\item', true, array('required'), false)) {
    ...
    public function add_action_buttons($cancel = true, $submitlabel = null) {
        ...
        $buttongroup = $this->find('actionbuttonsgroup', 'get_name', 'shezar_form\form\group\buttons');
        if (!$buttongroup) {
