...
/**
 * Base class for shezar forms element groups.
 *
...
abstract class group implements item {
    ...
    public function __construct($name) {
        if (!model::is_valid_name($name)) {
            // Array style names are forbidden in shezar forms!
    ...
    public function add(item $item, $position = null) {
        ...
        if ($this->get_model()->find(true, 'is_name_used', 'shezar_form\item', true, array($item->get_name()), false)) {
