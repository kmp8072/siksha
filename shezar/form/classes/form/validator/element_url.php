...
use shezar_form\item,
    ...
    shezar_form\form\element\url;

/**
 * shezar form url validator.
 *
...
class element_url extends element_validator {
     ...
     *
     * @throws \coding_exception If the item is not an instance of \shezar_form\form\element\editor
     * @param item $item
     */
    ...
    public function validate() {
        ...
        $this->element->add_error(get_string('urlvalidationerror', 'shezar_form'));
    }
}
