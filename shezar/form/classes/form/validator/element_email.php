...
use shezar_form\item,
    ...
    shezar_form\form\element\email;

/**
 * shezar form email validator.
 *
 * @package   shezar_form
...
class element_email extends element_validator {
     ...
     *
     * @throws \coding_exception If the item is not an instance of \shezar_form\form\element\email
     * @param item $item
     */
    ...
    public function validate() {
        ...
        $this->element->add_error(get_string('emailvalidationerror', 'shezar_form'));
    }
}
