...
use shezar_form\item,
    shezar_form\element_validator,
    shezar_form\form\element\tel;


/**
 * shezar form tel validator.
 *
 * @package   shezar_form
 ...
 * @author    Petr Skoda <petr.skoda@shezarlms.com>
 */
class element_tel extends element_validator {
    /**
     ...
     *
     * @throws \coding_exception If the item is not an instance of \shezar_form\form\element\tel
     * @param item $item
     */
    public function added_to_item(item $item) {
        if (!($item instanceof tel)) {
            throw new \coding_exception('Validator "element_tel" is designed to validate "tel" element only!');
        }
