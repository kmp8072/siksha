...
namespace shezar_form\form\group;

use shezar_form\group,
    shezar_form\item;
...
class section extends group {
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        $result = array(
            'form_item_template' => 'shezar_form/group_section',
            ...
            'items' => array(),
            'amdmodule' => 'shezar_form/form_group_section',
        );
    ...
    protected function finalise_collapsible() {
        ...
        foreach ($this->get_model()->get_items() as $section) {
            ...
            if ($section->get_expanded() === null) {
                if ($section->find(true, 'get_attributes', 'shezar_form\item', true, array('required'))) {
                    $section->set_expanded(true);
                    $expandedfound = true;
                    continue;
                }
