...
use shezar_form\form\validator\attribute_required,
    shezar_form\form\validator\attribute_maxlength,
    shezar_form\trait_item_paramtype;
...
class textarea extends text {
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        $result['form_item_template'] = 'shezar_form/element_textarea';
        $result['amdmodule'] = 'shezar_form/form_element_textarea';
        return $result;
    }
}
