...
use shezar_form\form\validator\element_email;
...
class email extends text {
    ...
    public function __construct($name, $label) {
        ...
        $this->add_validator(new element_email());
    }
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        $result['form_item_template'] = 'shezar_form/element_email';
        $result['amdmodule'] = 'shezar_form/form_element_email';
        return $result;
    }
}
