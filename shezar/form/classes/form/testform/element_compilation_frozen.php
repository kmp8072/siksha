...
class element_compilation_frozen extends form {
    ...
    public static function get_current_data_for_test() {
        ...
        return [
            ...
            'filemanager' => new \shezar_form\file_area($usercontext, 'user', 'test_filemanager', 7),
            'filepicker' => new \shezar_form\file_area($usercontext, 'user', 'test_filepicker', 7),
            'hidden' => 'Invisible',
