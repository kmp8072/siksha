...
class element_url extends form {
    ...
    public static function get_current_data_for_test() {
        return [
            'url_with_current_data' => 'http://www.shezarlms.com',
            'url_frozen_with_current_data' => 'https://www.shezarlms.com',
        ];
    }
    ...
    public function definition() {
        ...
        $hiddenif_secondary_c = $section->add(new url('hiddenif_secondary_c', 'Visible when test is not equal to \'https://shezarlms.com\''));
        $hiddenif_secondary_d = $section->add(new url('hiddenif_secondary_d', 'Visible when test equals \'https://shezarlms.com\''));
        ...
        $this->model->add_clientaction(new hidden_if($hiddenif_secondary_c))->is_equal($hiddenif_primary, 'https://shezarlms.com');
        $this->model->add_clientaction(new hidden_if($hiddenif_secondary_d))->not_equals($hiddenif_primary, 'https://shezarlms.com');
