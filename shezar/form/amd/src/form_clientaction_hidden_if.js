...
/**
 * shezar Hidden If client action.
 *
 * @module  shezar_form/form_clientaction_hidden_if
 * @class   HiddenIf
 * @author Sam Hemelryk <sam.hemelryk@shezarlms.com>
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
define(['shezar_form/form', 'shezar_form/clientaction_base'], function(Form, ClientAction) {
    ...
    return {
         ...
         * @returns {HiddenIf}
         */
        init: function(actionconfig, shezarform, done) {
            var action = new HiddenIf(actionconfig, shezarform);
            action.init();
            done(action);
        }
    };
