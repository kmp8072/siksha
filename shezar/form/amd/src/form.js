...
/**
 * shezar ajax form class.
 *
 * @module  shezar_form/form
 * @author  Sam Hemelryk <sam.hemelryk@shezarlms.com>
...
define(['jquery', 'core/config', 'core/templates', 'core/notification'], function($, CFG, Templates, Notification) {
    ...
    ElementCollection.prototype = {
        ...
        initElement: function(node) {
            ...
            if (!moduleData.module) {
                moduleData.module = 'shezar_form/element_generic';
            }
    ...
    function Group(parent, id, node) {
        ...
        Element.call(this, parent, 'shezar_form\\form\\group', id, node);
    ...
    function Form(config) {
        ...
        this.form.data('shezarForm', this);

        if (this.form.attr('action') === CFG.wwwroot + '/shezar/form/ajax.php') {
    ...
    $.extend(Form.prototype, {
        ...
        ajaxSubmit: function(button, reloadOnly) {
            ...
            $.ajax({
                type: 'POST',
                url: CFG.wwwroot + '/shezar/form/ajax.php',
                data: formdata,
                context: this,
        ...
        setFormWorking: function(action) {
            ...
            M.util.js_pending('shezarForm_' + this.id + '_' + action);
            if (this.form) {
        ...
        setFormReady: function(action) {
            ...
            M.util.js_complete('shezarForm_' + this.id + '_' + action);
        },
    ...
    var MODULE = {
         ...
         */
        itemIdentifiers: {
            FORM: 'data-shezar-form',
            ELEMENT: 'element',
            GROUP: 'group',
            INPUT: 'data-shezar-form-element-input'
        },
