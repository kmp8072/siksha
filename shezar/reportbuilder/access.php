...
$returnurl = new moodle_url('/shezar/reportbuilder/access.php', array('id' => $id));
...
if ($fromform = $mform->get_data()) {
    ...
    $report = new reportbuilder($id);
    \shezar_reportbuilder\event\report_updated::create_from_report($report, 'access')->trigger();
