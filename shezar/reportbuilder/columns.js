 ...
 */
M.shezar_reportbuildercolumns = M.shezar_reportbuildercolumns || {
    ...
    init: function(Y, config){
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.shezar_reportbuildercolumns.init()-> jQuery dependency required for this module to function.');
        }
        ...
        require(['core/templates'], function (templates) {
            var iconscache = [];
            iconscache.push(templates.renderIcon('loading', M.util.get_string('saving', 'shezar_reportbuilder')));
            iconscache.push(templates.renderIcon('hide', M.util.get_string('hide', 'shezar_reportbuilder')));
            iconscache.push(templates.renderIcon('show', M.util.get_string('show', 'shezar_reportbuilder')));
            iconscache.push(templates.renderIcon('delete', M.util.get_string('delete', 'shezar_reportbuilder')));
            iconscache.push(templates.renderIcon('arrow-up', M.util.get_string('moveup', 'shezar_reportbuilder')));
            iconscache.push(templates.renderIcon('arrow-down', M.util.get_string('movedown', 'shezar_reportbuilder')));
        ...
        if (colName == '0') {
            ...
            if (advancedSelectorVal != '') {
                if ($.inArray(advancedSelectorVal, module.config.rb_allowed_advanced[colName]) == -1) {
                    ...
                    newHeading = M.util.get_string(strName, 'shezar_reportbuilder', newHeading);
                }
            }
    ...
    rb_init_addbutton: function(colselector){
        ...
        addbutton.bind('click', function(e) {
            ...
            e.preventDefault();
            $.ajax({
                url: M.cfg.wwwroot + '/shezar/reportbuilder/ajax/column.php',
                type: "POST",
                data: data,
                beforeSend: function() {
    ...
    rb_init_deletebuttons: function() {
        ...
        $('.reportbuilderform table .deletecolbtn').bind('click', function(e) {
            ...
            confirmed = confirm(M.util.get_string('confirmcoldelete', 'shezar_reportbuilder'));
    ...
    rb_get_btn_hide: function(reportid, colid) {
        return $('<a href="' + M.cfg.wwwroot + '/shezar/reportbuilder/columns.php?id=' + reportid + '&cid='+colid+'&h=1" class="hidecolbtn action-icon">' + this.hideicon +'</a>');
    },

    rb_get_btn_show: function(reportid, colid) {
        return $('<a href="' + M.cfg.wwwroot + '/shezar/reportbuilder/columns.php?id=' + reportid + '&cid='+colid+'&h=0" class="showcolbtn action-icon">' + this.showicon + '</a>');
    },

    rb_get_btn_delete: function(reportid, colid) {
        return $('<a href="' + M.cfg.wwwroot + '/shezar/reportbuilder/columns.php?id=' + reportid + '&cid='+colid+'&d=1" class="deletecolbtn action-icon">' + this.deleteicon + '</a>');
    },

    rb_get_btn_up: function(reportid, colid) {
        return $('<a href="' + M.cfg.wwwroot + '/shezar/reportbuilder/columns.php?id=' + reportid + '&cid='+colid+'&m=up" class="movecolupbtn action-icon">' + this.upicon + '</a>');
    },

    rb_get_btn_down: function(reportid, colid) {
        return $('<a href="' + M.cfg.wwwroot + '/shezar/reportbuilder/columns.php?id=' + reportid + '&cid='+colid+'&m=down" class="movecoldownbtn action-icon">' + this.downicon + '</a>');
    },

    rb_get_btn_add: function(reportid) {
        return $('<a href="' + M.cfg.wwwroot + '/shezar/reportbuilder/columns.php?id=' + reportid + '" class="addcolbtn"><input type="button" value="' + M.util.get_string('add', 'shezar_reportbuilder') + '" /></a>');
    }
};
