...
class rb_plan_competencies_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        ...
        $this->url = '/shezar/plan/record/competencies.php';
        $this->source = 'dp_competency';
        $this->defaultsortcolumn = 'competency_fullname';
        $this->shortname = 'plan_competencies';
        $this->fullname = get_string('recordoflearningcompetencies', 'shezar_plan');
        $this->columns = array(
            array(
                'type' => 'plan',
                'value' => 'planlink',
                'heading' => get_string('plan', 'shezar_plan'),
            ),
            array(
                'type' => 'plan',
                'value' => 'status',
                'heading' => get_string('planstatus', 'shezar_plan'),
            ),
            array(
                'type' => 'competency',
                'value' => 'fullname',
                'heading' => get_string('competency', 'shezar_hierarchy'),
            ),
            array(
                'type' => 'competency',
                'value' => 'priority',
