...
class rb_bookings_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        ...
        $this->fullname = get_string('mybookings', 'shezar_core');
        $this->columns = array(
            array(
                'type' => 'course',
                'value' => 'courselink',
    ...
    public function is_capable($reportfor, $report) {
        ...
        return ($reportfor == $subjectid || \shezar_job\job_assignment::is_managing($reportfor, $subjectid) || is_siteadmin($reportfor));
    }
}
