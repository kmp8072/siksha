...
class rb_plan_programs_recurring_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        ...
        $this->url = '/shezar/plan/record/programs_recurring.php';
        $this->source = 'dp_program_recurring';
        $this->shortname = 'plan_programs_recurring';
        $this->fullname = get_string('recordoflearningprogramsrecurring', 'shezar_plan');
        $this->columns = array(
            array(
                'type' => 'program_completion_history',
                'value' => 'courselink',
                'heading' => get_string('coursenamelink', 'shezar_program'),
            ),
            array(
                'type' => 'program_completion_history',
                'value' => 'status',
                'heading' => get_string('completionstatus', 'shezar_program'),
            ),
            array(
                'type' => 'program_completion_history',
                'value' => 'timecompleted',
