...
class rb_plan_courses_completion_history_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        ...
        $url = new moodle_url('/shezar/plan/record/courses.php', array('history' => 1));
        ...
        $this->fullname = get_string('recordoflearningcoursescompletionhistory', 'shezar_plan');
        $this->columns = array(
            array(
                'type' => 'course',
                'value' => 'coursetypeicon',
                'heading' => get_string('coursetypeicon', 'shezar_reportbuilder'),
            ),
            array(
                'type' => 'course',
                'value' => 'courselink',
