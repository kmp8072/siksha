...
class rb_alerts_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        ...
        $this->url = '/shezar/message/alerts.php';
        $this->source = 'shezarmessages';
        $this->shortname = 'alerts';
        $this->fullname = get_string('alerts', 'shezar_message');
        $this->columns = array(
            array(
                'type' => 'message_values',
                'value' => 'msgtype',
                'heading' => get_string('type', 'rb_source_shezarmessages'),
            ),
            array(
                'type' => 'user',
                'value' => 'namelink',
                'heading' => get_string('name', 'rb_source_shezarmessages'),
            ),
            array(
                'type' => 'message_values',
                'value' => 'statement',
                'heading' => get_string('details', 'rb_source_shezarmessages'),
            ),
            array(
                'type' => 'message_values',
                'value' => 'sent',
                'heading' => get_string('sent', 'rb_source_shezarmessages'),
            ),
        );
    ...
    public function is_capable($reportfor, $report) {
        ...
        return ($reportfor == $subjectid ||
            \shezar_job\job_assignment::is_managing($reportfor, $subjectid) ||
                has_capability('shezar/message:viewallmessages', context_system::instance(), $reportfor));
    }
}
