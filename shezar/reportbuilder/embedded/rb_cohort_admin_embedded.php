...
class rb_cohort_admin_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        ...
        $this->fullname = get_string('cohortadminreportname', 'shezar_cohort');
        $this->columns = array(
            array(
                'type' => 'cohort',
                'value' => 'namelink',
                'heading' => get_string('name', 'shezar_cohort')
            ),
            array(
                'type' => 'cohort',
                'value' => 'idnumber',
                'heading' => get_string('idnumber', 'shezar_cohort')
            ),
            array(
                'type' => 'cohort',
                'value' => 'numofmembers',
                'heading' => get_string('numofmembers', 'shezar_cohort')
            ),
            array(
                'type' => 'cohort',
                'value' => 'type',
                'heading' => get_string('type', 'shezar_cohort')
            ),
            array(
                'type' => 'cohort',
                'value' => 'startdate',
                'heading' => get_string('startdate', 'shezar_cohort')
            ),
            array(
                'type' => 'cohort',
                'value' => 'enddate',
                'heading' => get_string('enddate', 'shezar_cohort')
            ),
            array(
                'type' => 'cohort',
                'value' => 'status',
                'heading' => get_string('status', 'shezar_cohort')
            ),
            array(
                'type' => 'course_category',
                'value' => 'namelink',
                'heading' => get_string('category', 'shezar_reportbuilder')
            ),
            array(
                'type' => 'cohort',
                'value' => 'actions',
                'heading' => get_string('actions', 'shezar_cohort')
            )
        );
