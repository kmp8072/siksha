...
class rb_goal_custom_fields_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        global $USER;
        $this->url = '/shezar/hierarchy/prefix/goal/mygoals.php';
        $this->source = 'goal_custom';
        $this->shortname = 'goal_custom_fields';
        $this->fullname = get_string('goalembeddedreportcustomfields', 'shezar_hierarchy');
    ...
    public function is_capable($reportfor, $report) {
        ...
        return has_capability('shezar/hierarchy:viewgoal', $context, $reportfor);
    }
