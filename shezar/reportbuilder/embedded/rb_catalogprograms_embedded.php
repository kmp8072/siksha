...
class rb_catalogprograms_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        $this->url = $this->url = '/shezar/coursecatalog/programs.php';
        $this->source = 'program';
        $this->shortname = 'catalogprograms';
        $this->fullname = get_string('catalogprograms', 'shezar_coursecatalog');
        ...
        $this->columns = array(
            ...
            array(
                'type' => 'prog',
                'value' => 'summary',
                'heading' => get_string('programsummary', 'shezar_program'),
            )
        );
    ...
    public function get_extrabuttons() {
        ...
        $categoryid = shezar_get_categoryid_with_capability('shezar/program:createprogram');

        if ($categoryid !== false) {
            $createurl = new moodle_url("/shezar/program/add.php", array('category' => $categoryid));
            $createbutton = new single_button($createurl, get_string('addprogram', 'shezar_coursecatalog'), 'get');
