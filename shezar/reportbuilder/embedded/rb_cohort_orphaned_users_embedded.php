...
class rb_cohort_orphaned_users_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        $this->url = '/shezar/cohort/orphanreport.php';
        $this->source = 'cohort_orphaned_users';
        $this->shortname = 'cohort_orphaned_users';
        $this->fullname = get_string('orphanedusersreport', 'shezar_cohort');
        $this->columns = array(
            array(
                'type' => 'user',
                'value' => 'namelinkicon',
                'heading' => get_string('userfullname', 'shezar_reportbuilder')
            ),
            array(
                'type' => 'user',
                'value' => 'idnumber',
                'heading' => get_string('useridnumber', 'shezar_reportbuilder')
            ),
            array(
                'type' => 'user',
                'value' => 'email',
                'heading' => get_string('useremail', 'shezar_reportbuilder')
            ),
            array(
                'type' => 'user',
                'value' => 'position',
                'heading' => get_string('userspos', 'shezar_reportbuilder')
            ),
            array(
                'type' => 'user',
                'value' => 'organisation',
                'heading' => get_string('usersorgname', 'shezar_reportbuilder')
            ),
        );
