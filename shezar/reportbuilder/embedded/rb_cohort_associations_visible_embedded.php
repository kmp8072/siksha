...
class rb_cohort_associations_visible_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        $this->url = '/shezar/cohort/visiblelearning.php';
        $this->source = 'cohort_associations_visible';
        $this->shortname = 'cohort_associations_visible';
        $this->fullname = get_string('cohortvisiblereportname', 'shezar_cohort');
        $this->columns = array(
            array(
                'type' => 'associations',
                'value' => 'nameiconlink',
            ...
            array(
                'type' => 'associations',
                'value' => 'status',
                'heading' => get_string('visibility', 'shezar_cohort')
            ),
            array(
                'type' => 'associations',
                'value' => 'actionsvisible',
                'heading' => get_string('associationactionsvisible', 'shezar_cohort')
            ),
        );
