...
class rb_plan_certifications_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        ...
        $this->url = '/shezar/plan/record/certifications.php';
        ...
        $this->fullname = get_string('recordoflearningcertifications', 'shezar_plan');
        $this->columns = array(
            array(
                'type' => 'base',
                'value' => 'fullnamelink',
                'heading' => get_string('certificationname', 'shezar_program'),
            ),
            array(
                'type' => 'certif_completion',
                'value' => 'timedue',
                'heading' => get_string('certificationduedate', 'shezar_program'),
            ),
            array(
                'type' => 'certif_completion',
                'value' => 'certifpath',
