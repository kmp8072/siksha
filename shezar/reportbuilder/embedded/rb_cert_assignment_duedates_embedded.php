...
class rb_cert_assignment_duedates_embedded extends rb_base_embedded {
    ...
    public function __construct($data) {
        $this->url = '/shezar/program/manage.php?viewtype=certification';
        ...
        $this->fullname = get_string('certassignmentduedates', 'shezar_certification');
        ...
        $this->columns = array(
            ...
            array(
                ...
                'heading' => get_string('duedatecanbechanged', 'shezar_program'),
            ),
        );
    ...
    public function is_capable($reportfor, $report) {
        ...
        return (has_capability('shezar/program:configureassignments', $context));
    }
}
