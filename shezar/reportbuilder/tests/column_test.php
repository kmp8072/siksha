 ...
 *
 * vendor/bin/phpunit shezar_reportbuilder_column_testcase
 *
 */
...
class shezar_reportbuilder_column_testcase extends reportcache_advanced_testcase {
    ...
    protected $block_shezar_stats_data = array(
    ...
    protected $files_data = array(
        'contextid' => 1, 'itemid' => 1, 'filepath' => '/shezar/', 'filename' => 'icon.gif', 'filesize' => 8,
    ...
    protected $shezar_compl_import_course_data = array(
    ...
    protected $shezar_compl_import_cert_data = array(
    ...
    protected $upgrade_log = array(
        'id' => 11111111, 'type' => 0, 'plugin' => 'shezar_core', 'version' => 2014012345, 'targetversion' => 'targetversion',
    ...
    protected $shezar_connect_clients_data = array('id' => 1, 'status' => 1, 'clientidnumber' => 'xxx', 'clientsecret' => 'yyyy',
        'clientname' => 'some client', 'clienturl' => 'http://example.com/shezar', 'clienttype' => 'shezarlms', 'clientcomment' => '',
    ...
    protected $tool_customlang_data = array('id' => 1, 'lang' => 'en', 'componentid' => 1, 'stringid' => 'shezar', 'original' => 'shezar',
        'master' => 'shezar', 'local' => 'shezar', 'timecustomized' => 1416859984, 'timemodified' => 1416859984);

    protected $tool_customlang_components_data = array('id' => 1, 'name' => 'shezar', 'version' => '1985031400');
    ...
    protected function setUp() {
        ...
        \shezar_job\job_assignment::create_default(2, array('organisationid' => 1, 'positionid' => 1));
        ...
        $this->loadDataSet($this->createArrayDataset(array(
            ...
            'block_shezar_stats' => array($this->block_shezar_stats_data),
            ...
            'shezar_sync_log' => array($this->sync_log_data),
            'cohort_visibility' => array($this->visible_cohort_data),
            'appraisal_user_assignment' => array($this->appraisal_user_assignment),
            'shezar_compl_import_course' => array($this->shezar_compl_import_course_data),
            'shezar_compl_import_cert' => array($this->shezar_compl_import_cert_data),
            ...
            'shezar_connect_clients' => array($this->shezar_connect_clients_data),
