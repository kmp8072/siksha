...
abstract class reportcache_advanced_testcase extends advanced_testcase {
    ...
    /** @var shezar_reportbuilder_cache_generator $generator */
     ...
     * @return shezar_reportbuilder_cache_generator
     */
    public static function getDataGenerator() {
        if (is_null(static::$generator)) {
            static::$generator = new shezar_reportbuilder_cache_generator();
        }
