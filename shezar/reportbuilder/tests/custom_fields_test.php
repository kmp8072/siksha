...
class shezar_reportbuilder_custom_fields_testcase extends advanced_testcase {
    ...
    public function test_profile_field_defaults() {
        ...
        /** @var shezar_core_generator $generator */
        $generator = $this->getDataGenerator()->get_plugin_generator('shezar_core');
