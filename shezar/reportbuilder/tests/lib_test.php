 ...
 *
 * Unit tests for shezar/reportbuilder/lib.php
 */
...
class shezar_reportbuilder_lib_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        \shezar_job\job_assignment::create_default($user->id, array('organisationid' => 1, 'positionid' => 1));
    ...
    function test_reportbuilder_report_url() {
        ...
        $this->assertEquals('/shezar/reportbuilder/report.php?id=' . $rb->_id, substr($rb->report_url(), strlen($CFG->wwwroot)));
        $rb2 = new reportbuilder(null, $this->shortname);
        // an embedded report should return the embedded url (this page)
        $this->assertEquals($CFG->wwwroot . '/shezar/plan/record/competencies.php', $rb2->report_url());
    ...
    public function test_get_search_columns_select() {
        ...
        $userstr = get_string('type_user', 'shezar_reportbuilder');
