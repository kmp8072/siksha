...
class shezar_reportbuilder_rb_global_restriction_set_testcase extends advanced_testcase {
 ...
 WHERE ef_419295f028_insid = ? AND ef_419295f028_type = ?";
    ...
    protected function setUp() {
        ...
        /** @var shezar_reportbuilder_generator $reportgen */
        $reportgen = $this->getDataGenerator()->get_plugin_generator('shezar_reportbuilder');
