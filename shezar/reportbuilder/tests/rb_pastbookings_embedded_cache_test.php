...
global $CFG;
require_once($CFG->dirroot . '/shezar/reportbuilder/tests/rb_bookings_embedded_cache_test.php');

class shezar_reportbuilder_rb_pastbookings_embedded_cache_testcase extends shezar_reportbuilder_rb_bookings_embedded_cache_testcase {
    // testcase data
