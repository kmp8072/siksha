...
class shezar_reportbuilder_display_testcase extends advanced_testcase {
    ...
    public function test_aggregation() {
        ...
        $fs = get_file_storage();
        $file = array('contextid' => $syscontext->id, 'component' => 'shezar_customfield', 'filearea' => 'course_filemgr',
                        'itemid' => $f->data, 'filepath' => '/', 'filename' => 'readme.txt');
        $fileurl = 'http://www.example.com/moodle/pluginfile.php/'.$syscontext->id.'/shezar_customfield/course_filemgr/'.
                        $f->data.'/readme.txt';
        ...
        $this->assertSame('<img src="http://www.example.com/moodle/theme/image.php/_s/' . $theme . '/shezar_core/1/courseicons/business-modelling" id="icon_preview" class="course_icon" alt="volba1" title="volba1" />', $processed[3]);
