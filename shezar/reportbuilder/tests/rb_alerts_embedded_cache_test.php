...
class shezar_reportbuilder_rb_alerts_embedded_cache_testcase extends reportcache_advanced_testcase {
    // testcase data
    protected $report_builder_data = array('id' => 2, 'fullname' => 'Alerts', 'shortname' => 'alerts',
                                           'source' => 'shezarmessages', 'hidden'=>1, 'embedded' => 1);
    ...
    protected function setUp() {
        ...
        assign_capability('shezar/message:viewallmessages', CAP_PROHIBIT, $rolemanager->id, $syscontext);
        ...
        assign_capability('shezar/message:viewallmessages', CAP_ALLOW, $rolecoursecreator->id, $syscontext);
