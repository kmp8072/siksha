 ...
 */
M.shezar_reportbuilderfilters = M.shezar_reportbuilderfilters || {
    ...
    rb_init_filter_addbutton: function(filterselector, region) {
        ...
        addbutton.bind('click', function(e) {
            ...
            $.ajax({
                url: M.cfg.wwwroot + '/shezar/reportbuilder/ajax/filter.php',
                type: "POST",
    ...
    rb_init_search_column_addbutton: function(searchcolumnselector) {
        ...
        addbutton.bind('click', function(e) {
            e.preventDefault();
            $.ajax({
                url: M.cfg.wwwroot + '/shezar/reportbuilder/ajax/searchcolumn.php',
                type: "POST",
                data: ({action: 'add', sesskey: module.config.user_sesskey, id: module.config.rb_reportid,
    ...
    rb_init_filter_deletebuttons: function() {
        ...
        $('.reportbuilderform table .deletefilterbtn').bind('click', function(e) {
            ...
            if (module.config.rb_initial_display == 1 && module.config.rb_filters <= 1) {
                alert(M.util.get_string('initialdisplay_error', 'shezar_reportbuilder'));
                return;
            }

            confirmed = confirm(M.util.get_string('confirmfilterdelete', 'shezar_reportbuilder'));
    ...
    rb_init_search_column_deletebuttons: function() {
        ...
        $('.reportbuilderform table .deletesearchcolumnbtn').bind('click', function(e) {
            ...
            confirmed = confirm(M.util.get_string('confirmsearchcolumndelete', 'shezar_reportbuilder'));
    ...
    rb_get_filter_btn_delete: function(reportid, fid) {
        return $('<a href=' + M.cfg.wwwroot + '/shezar/reportbuilder/filters.php?id=' + reportid + '&fid=' + fid +
                '&d=1" class="deletefilterbtn action-icon">' + this.deleteicon + '</a>');
    },

    rb_get_search_column_btn_delete: function(reportid, searchcolumnid) {
        return $('<a href=' + M.cfg.wwwroot + '/shezar/reportbuilder/filters.php?id=' + reportid + '&searchcolumnid=' +
    ...
    rb_get_btn_add: function(reportid) {
        return $('<a href=' + M.cfg.wwwroot + '/shezar/reportbuilder/filters.php?id=' + reportid +
                '" class="additembtn"><input type="button" value="' + M.util.get_string('add', 'shezar_reportbuilder') +
                '" /></a>');
    }
