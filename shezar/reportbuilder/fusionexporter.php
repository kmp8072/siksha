...
$PAGE->set_url('/shezar/reportbuilder/fusionexporter.php', array('id' => $id));
...
$returnurl = new moodle_url('/shezar/reportbuilder/fusionexporter.php', array('id' => $id, 'sid' => $sid));
...
if (empty($errors)) {
    ...
    shezar_set_notification(get_string('error:fusionexport', 'gradeexport_fusion', format_string($errordetails)), $url);
}
