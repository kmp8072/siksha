...
if ($reportrecord->embedded) {
    print_error('cannotviewembedded', 'shezar_reportbuilder');
}
...
$pagetitle = format_string(get_string('report', 'shezar_reportbuilder').': '.$fullname);
...
echo $output->footer();
?>
<!--Css to display report table 100% -->
<style type="text/css">
    .no-overflow.table-wrap-remui{
        width: 100% !important;
    }
</style>