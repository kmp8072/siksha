 ...
 *
 * Note: this event is not triggered for embedded reports since shezar 2.7.6
 *
...
class report_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportcreated', 'shezar_reportbuilder');
    }
    ...
    public function get_url() {
        return new \moodle_url('/shezar/reportbuilder/report.php', array('id' => $this->objectid));
    }
