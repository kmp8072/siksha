...
class rb_global_restriction {
    ...
    public function insert($data) {
        ...
        //\shezar_restriction\event\restriction_created::create_from_instance($this)->trigger();
    ...
    public function update($data) {
        ...
        // Might need an event to go in here.
        //\shezar_restriction\event\restriction_updated::create_from_instance($this)->trigger();
    }
    ...
    public static function get_all($offset = 0, $limit = 0, &$count) {
        global $DB, $CFG;
        require_once($CFG->dirroot . '/shezar/reportbuilder/lib/assign/lib.php');
        ...
        foreach ($restrictions as $restriction) {
            ...
            $records = new shezar_assign_reportbuilder_record('reportbuilder', $restriction);
            $users = new shezar_assign_reportbuilder_user('reportbuilder', $restriction);
