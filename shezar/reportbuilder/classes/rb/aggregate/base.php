...
abstract class base {
    ...
    public static function get_types() {
        ...
        foreach (scandir(__DIR__) as $filename) {
            ...
            $classname = '\shezar_reportbuilder\rb\aggregate\\' . $name;
    ...
    public static function get_options() {
        ...
        foreach (self::get_types() as $name => $classname) {
            $options[$classname::get_typename()][$name] = get_string("aggregatetype{$name}_name", 'shezar_reportbuilder');
        }
    ...
    public static function require_column_heading_strings() {
        ...
        foreach (self::get_types() as $name => $classname) {
            $PAGE->requires->string_for_js("aggregatetype{$name}_heading", 'shezar_reportbuilder');
        }
    }
    ...
    public static function get_typename() {
        return get_string('advancedgroupaggregate', 'shezar_reportbuilder');
    }
