...
M.shezar_reportbuilder_expand = M.shezar_reportbuilder_expand || {
    /** Selectors. */
    SELECTORS: {
    ...
    init: function(Y, args) {
        $('body').on('click', '.rb-display-expand', M.shezar_reportbuilder_expand.displayExpand);
        $('body').on('click', this.SELECTORS.ENROLMENTBUTTONS, M.shezar_reportbuilder_expand.clickEnrol);
    ...
    displayExpand: function(event) {
        ...
        var url = M.cfg.wwwroot + '/shezar/reportbuilder/ajax/expand.php?id=' + id +
    ...
    clickEnrol: function(event) {
        ...
        var id = $('.rb-display-table-container').attr('id');
        var url = M.cfg.wwwroot + '/shezar/reportbuilder/ajax/expand.php';
