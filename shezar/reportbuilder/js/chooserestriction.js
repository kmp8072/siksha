...
M.shezar_reportbuilder_chooserestriction = M.shezar_reportbuilder_chooserestriction || {
    Y: null,
    reportid: null,
    pageurl: null,
    ...
    addDialog: function () {
        var selected = [];
        var baseurl = M.cfg.wwwroot + '/shezar/reportbuilder/';
        var title = M.util.get_string('chooserestrictiontitle', 'shezar_reportbuilder');
        ...
        var buttonObj = {};
        buttonObj[M.util.get_string('save', 'shezar_core')] = function() {
