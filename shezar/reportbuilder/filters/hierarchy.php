...
class rb_filter_hierarchy extends rb_filter_type {
    ...
    function setupForm(&$mform) {
        ...
        $objs[] =& $mform->createElement('static', 'selectorbutton',
            ...
            html_writer::empty_tag('input', array('type' => 'button',
                ...
                'value' => get_string('choose' . $type, 'shezar_reportbuilder'),
        ...
        $mform->addHelpButton($grp->_name, 'reportbuilderdialogfilter', 'shezar_reportbuilder');
        if ($advanced) {
    ...
    function get_label($data) {
        ...
        $a->value    = '"'.s($itemname).'"';
        if ($recursive) {
            $a->value .= get_string('andchildren', 'shezar_hierarchy');
        }
    ...
    public function include_js() {
        ...
        $currentlyselected = dialog_display_currently_selected(get_string('currentlyselected', 'shezar_hierarchy'), $title);
