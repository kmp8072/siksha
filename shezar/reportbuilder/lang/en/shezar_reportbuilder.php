...
$string['norestrictionsfound'] = 'No restrictions found. Ask your developer to add restrictions to /shezar/reportbuilder/sources/{$a}/restrictionoptions.php';
...
$string['pdffont_help'] = 'When exporting a report from the report builder as a PDF this is the font that will be used. If appropriate default is selected shezar will select a font that is suitable for the users language.';
...
The shortname is used by shezar to keep track of this report. No two reports can be given the same shortname, even if they are based on the same source. Avoid using special characters in this field (text, numbers and underscores are okay).';
...
**Note:** If no options are available in the **Source** field, or the source you require does not appear you will need your shezar installation to be configured to include the source data you require (This cannot be done via the shezar interface).';
...
$string['scheduledreportmessage'] = 'Hi,

Please find attached the \'{$a->reportname}\' report.

NOTE: This is an automatic email from Siksha Learning Portal. You are scheduled to receive this report {$a->schedule}.  To remove your name, please contact L&D.
