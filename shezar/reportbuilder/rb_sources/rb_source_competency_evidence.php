...
class rb_source_competency_evidence extends rb_base_source {
    ...
    public function is_ignored() {
        return !shezar_feature_visible('competencies');
    }
    ...
    protected function define_columnoptions() {
        ...
        $usednamefields = shezar_get_all_user_name_fields_join('assessor', null, true);
        $allnamefields = shezar_get_all_user_name_fields_join('assessor');
    ...
    public function rb_display_status_history_link($userid, $row, $isexport = false) {
        ...
        $url = new moodle_url('/shezar/hierarchy/prefix/competency/statushistoryreport.php',
    ...
    function rb_display_link_competency($comp, $row) {
        ...
        $url = new moodle_url('/shezar/hierarchy/item/view.php', array('prefix' => 'competency', 'id' => $compid));
