 ...
 * @package shezar_reportbuilder
 */
class shezar_assign_reportbuilder_record extends shezar_assign_core {
 ...
 * can only see list of allowed to them users (which is defined in shezar_assign_restriction_record).
 * It is object of restrictions.
 *
 * @author Valerii Kuznetsov <valerii.kuznetsov@shezarlms.com>
 * @package shezar_reportbuilder
 */
class shezar_assign_reportbuilder_user extends shezar_assign_core {
