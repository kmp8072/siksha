...
switch ($action) {
    case 'add' :
        ...
        if ($customheading) {
            if (trim($heading) === '') {
                $result->error = get_string('noemptycols', 'shezar_reportbuilder');
        ...
        if ($DB->record_exists('report_builder_columns', $params)) {
            $result->error = get_string('norepeatcols', 'shezar_reportbuilder');
            break;
        }
    ...
    case 'delete':
        ...
        if ($column) {
            ...
            } else if (get_string_manager()->string_exists('type_' . $column->type, 'shezar_reportbuilder')) {
                $column->optgroup_label = get_string('type_' . $column->type, 'shezar_reportbuilder');
            } else {
