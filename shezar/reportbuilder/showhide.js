...
M.shezar_reportbuilder_showhide = M.shezar_reportbuilder_showhide || {
    ...
    init: function(Y, args) {
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.shezar_reportbuilder_showhide.init()-> jQuery dependency required for this module to function.');
        }
        ...
        shezarDialogs[name] = new shezarDialog(
            ...
            {
                buttons: buttons,
                title: '<h2>' + M.util.get_string('showhidecolumns', 'shezar_reportbuilder') + '</h2>'
            },
