...
class job_assignment_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventjobassignmentupdated', 'shezar_job');
    }
    ...
    public function get_url() {
        return new \moodle_url('/shezar/job/jobassignment.php', array('id' => $this->objectid));
    }
}