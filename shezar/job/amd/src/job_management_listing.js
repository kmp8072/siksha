 ...
 * @package shezar_job
 * @module shezar_job/job_management_listing
 */
define(['jquery', 'core/ajax', 'core/notification', 'core/str'], function($, Ajax, Notification, Str) {
    ...
    ListManager.prototype.confirm_delete = function(itemid) {
        var node = this.container.find('a.editjoblink[data-id="'+itemid+'"]'),
            ...
            deferred = Str.get_strings([
                { key: 'deletejobassignment', component: 'shezar_job', param: null, lang: null },
                { key: 'confirmdeletejobassignment', component: 'shezar_job', param: node.text(), lang: null },
                { key: 'delete', component: 'core', param: null, lang: null },
                { key: 'cancel', component: 'core', param: null, lang: null }
            ]);
        deferred.done(function(results){
            results.push(function() {
                M.util.js_pending('shezar_job-delete');
                var deferred = self.delete_job_assignment(itemid);
                deferred.done(function(){
                    M.util.js_complete('shezar_job-delete');
                });
            });
    ...
    ListManager.prototype.delete_job_assignment = function(itemid) {
        var ajaxrequests = [{
                methodname: 'shezar_job_external_delete_job_assignment',
                args: {
                    userid: this.userid,
    ...
    ListManager.prototype.move_item_up = function(itemid) {
        ...
        M.util.js_pending('shezar_job-move_item_up');
        ...
        deferred.done(function() {
            ...
            M.util.js_complete('shezar_job-move_item_up');
        });
    };
    ListManager.prototype.move_item_down = function(itemid) {
        ...
        M.util.js_pending('shezar_job-move_item_down');
        var deferred = this.switch_items(switchItem, targetItem);
        deferred.done(function() {
            var li = $(ul.find('a.editjoblink[data-id="'+targetItem.id+'"]').parents('li')[0]);
            li.fadeOut(50, function() {
            ...
            M.util.js_complete('shezar_job-move_item_down');
        });
    };
    ...
    ListManager.prototype.switch_items = function(itema, itemb) {
        ...
        var ajaxrequests = [{
            methodname: 'shezar_job_external_resort_job_assignments',
            args: {
                userid: this.userid,
                sort: data
            }
