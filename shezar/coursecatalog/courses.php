...
if ($enhancedcatalogenabled) {
    $PAGE->set_shezar_menu_selected('courses');
}

$PAGE->set_url('/shezar/coursecatalog/courses.php');
...
$strheading = get_string('searchcourses', 'shezar_core');
...
$PAGE->navbar->add($fullname, new moodle_url("/shezar/coursecatalog/courses.php"));
