...
class certifications extends \shezar_core\shezar\menu\item {

    protected function get_default_title() {
        return get_string('certifications', 'shezar_coursecatalog');
    }
    ...
    protected function get_default_url() {
        ...
        if (!empty($CFG->enhancedcatalog)) {
            return '/shezar/coursecatalog/certifications.php';
        } else {
            return '/shezar/program/index.php?viewtype=certification';
        }
    }
    ...
    public function is_disabled() {
        return shezar_feature_disabled('certifications');
    }
}
