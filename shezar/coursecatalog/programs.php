...
if ($enhancedcatalogenabled) {
    $PAGE->set_shezar_menu_selected('programs');
}

$PAGE->set_pagelayout('standard');
$PAGE->set_url('/shezar/coursecatalog/programs.php');
if ($CFG->forcelogin) {
    require_login();
}
...
$fullname = get_string('programs', 'shezar_program');
$pagetitle = format_string(get_string('findlearning', 'shezar_core') . ': ' . $fullname);

$PAGE->navbar->add($fullname, new moodle_url('/shezar/coursecatalog/programs.php'));
