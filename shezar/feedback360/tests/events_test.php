...
global $CFG;
require_once($CFG->dirroot.'/shezar/feedback360/tests/feedback360_testcase.php');
...
class feedback360_event_test extends feedback360_testcase {
    ...
    public function test_feedback360_events() {
        ...
        $this->assertEquals('shezar_feedback360', $eventdata['component']);
        $this->assertEquals('\shezar_feedback360\event\feedback360_created', $eventdata['eventname']);
        ...
        $eventdata = $events[0]->get_data();
        $this->assertEquals('shezar_feedback360', $eventdata['component']);
        $this->assertEquals('\shezar_feedback360\event\feedback360_updated', $eventdata['eventname']);
        ...
        $eventdata = $events[0]->get_data();
        $this->assertEquals('shezar_feedback360', $eventdata['component']);
        $this->assertEquals('\shezar_feedback360\event\feedback360_deleted', $eventdata['eventname']);
    ...
    public function test_request_events() {
        ...
        $this->assertEquals('shezar_feedback360', $eventdata['component']);
        $this->assertEquals('\shezar_feedback360\event\request_created', $eventdata['eventname']);
        $this->assertEquals('created', $eventdata['action']);
        ...
        $eventdata = $events[2]->get_data();
        $this->assertEquals('shezar_feedback360', $eventdata['component']);
        $this->assertEquals('\shezar_feedback360\event\request_deleted', $eventdata['eventname']);
        $this->assertEquals('deleted', $eventdata['action']);
        $this->assertEquals('feedback360_resp_assignment', $eventdata['objecttable']);
    ...
    public function test_legacy_events() {
        ...
        $oldurl = new moodle_url('/shezar/feedback360/general.php', array('id' => $feedback360->id));
        ...
        $oldurl = new moodle_url("/shezar/feedback360/request.php", $params);
