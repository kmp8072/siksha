...
class feedback360_test extends feedback360_testcase {
    ...
    public function test_activate() {
        ...
        $assign = new shezar_assign_feedback360('feedback360', $fdbcktest);
    ...
    public function test_duplicate() {
        ...
        $assign = new shezar_assign_feedback360('feedback360', $newfdbck);
    ...
    public function test_cleanup_task() {
        ...
        $task = new \shezar_feedback360\task\cleanup_task();
        $task->execute();
