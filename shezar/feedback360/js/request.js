...
M.shezar_requestfeedback = M.shezar_requestfeedback || {
    ...
    init: function(Y, args){
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.shezar_requestfeedback.init()-> jQuery dependency required for this module to function.');
        }

        // Select users to request feedback from, javascript dialog.
        (function() {
            var url = M.cfg.wwwroot+ '/shezar/feedback360/request';
            var saveurl = url + '/update.php';
            var findurl = url + '/find.php';
            var uid = M.shezar_requestfeedback.config.userid;
            var fid = M.shezar_requestfeedback.config.formid;
            feedback360Dialog(
                'systemrequest',
                M.util.get_string('addsystemusers', 'shezar_feedback360'),
...
feedback360Dialog = function(name, title, find_url, save_url) {
    ...
    var existing = M.shezar_requestfeedback.config.existing;
...
feedback360_handler.prototype = new shezarDialog_handler_treeview_multiselect();
