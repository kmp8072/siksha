 ...
 */
M.shezar_feedback360_feedback = M.shezar_feedback360_feedback || {
  ...
  init : function(Y, args) {
    ...
    if ( typeof $ === 'undefined') {
      throw new Error('M.shezar_feedback360_feedback.init()-> jQuery dependency required for this module to function.');
    }
    moveScroller();
