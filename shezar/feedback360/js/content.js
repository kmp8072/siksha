 ...
 */
M.shezar_feedback360_content = M.shezar_feedback360_content || {
  ...
  init : function(Y, args) {
    ...
    if ( typeof $ === 'undefined') {
      throw new Error('M.shezar_feedback360_content.init()-> jQuery dependency required for this module to function.');
    }
    makeDraggable(M.cfg.wwwroot + '/shezar/feedback360/content.php', '#feedback360-quest-list', 'li');
