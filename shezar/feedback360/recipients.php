...
redirect(new moodle_url('/shezar/feedback360/general.php', array('id' => $id)));

$returnurl = new moodle_url('/shezar/feedback360/recipients.php', array('id' => $id));
...
if ($fromform = $mform->get_data()) {
    ...
    $feedback360->save();
    shezar_set_notification(get_string('recipientsupdated', 'shezar_feedback360'), $returnurl, array('class' => 'notifysuccess'));
} else {
...
echo html_writer::tag('span', get_string('recipientdesc', 'shezar_feedback360'));
$mform->display();
echo $output->footer();
