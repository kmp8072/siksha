...
class request_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventdeletedrequest', 'shezar_feedback360');
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url('/shezar/feedback360/index.php', $urlparams);
    }
    ...
    public function get_legacy_logdata() {
        ...
        $logdata[] = new \moodle_url('/shezar/feedback360/request.php', $urlparams);
