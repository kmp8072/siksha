...
/**
 * Event triggered when a feedback360 request is created.
 *
...
class request_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcreatedrequest', 'shezar_feedback360');
    }
    ...
    public function get_description() {
        return "The feedback360 request {$this->objectid} was created";
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url('/shezar/feedback360/request.php', $urlparams);
    }
