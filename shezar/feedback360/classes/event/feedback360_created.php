...
/**
 * Event triggered when a feedback360 is created.
 *
 * @author David Curry <david.curry@shezarlms.com>
 * @package shezar_feedback360
 */
class feedback360_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcreatedfeedback', 'shezar_feedback360');
    }
