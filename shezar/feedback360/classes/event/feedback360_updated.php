...
namespace shezar_feedback360\event;

defined('MOODLE_INTERNAL') || die();

/**
 * Event triggered when a feedback360 is updated.
 *
 * @author David Curry <david.curry@shezarlms.com>
 * @package shezar_feedback360
 */
class feedback360_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventupdatedfeedback', 'shezar_feedback360');
    }
    ...
    public function get_url() {
        return new \moodle_url('/shezar/feedback360/general.php', array('id' => $this->objectid));
    }
    ...
    public function get_legacy_logdata() {
        ...
        $logdata[] = SITEID;
        $logdata[] = 'feedback360';
        $logdata[] = 'update feedback360';
        $logdata[] = new \moodle_url('/shezar/feedback360/general.php', array('id' => $this->objectid));
        $logdata[] = 'General Settings: feedback360 ID=' . $this->objectid;
