...
class rb_source_completionimport_certification extends rb_base_source {
    ...
    public function __construct($groupid, rb_global_restriction_set $globalrestrictionset = null) {
        ...
        $this->base = '{shezar_compl_import_cert}';
    ...
    protected function define_columnoptions() {
        ...
        $columnoptions[] = new rb_column_option(
                ...
                $DB->sql_concat_join("' '", shezar_get_all_user_name_fields_join('importuser', null, true)),
                array(
                    'joins' => 'importuser',
                    'dbdatatype' => 'char',
                    'outputformat' => 'text',
                    'extrafields' => shezar_get_all_user_name_fields_join('importuser'),
                    'displayfunc' => 'user'
                )
        );
    ...
    public function rb_display_importerrormsg($importerrormsg, $row, $isexport) {
        ...
        foreach ($errorcodes as $errorcode) {
            if (!empty($errorcode)) {
                $errors[] = get_string($errorcode, 'shezar_completionimport');
            }
        }
