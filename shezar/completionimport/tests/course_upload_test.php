 ...
 * vendor/bin/phpunit shezar/completionimport/tests/course_upload_test.php
 *
...
class coursecompletionimport_testcase extends advanced_testcase {
    ...
    public function test_course_singular_upload_empty() {
        ...
        $filename = $CFG->dirroot . '/shezar/completionimport/tests/fixtures/course_single_upload.csv';
        $tempfilename = $CFG->dirroot . '/shezar/completionimport/tests/fixtures/course_single_upload_ready.csv';
        $importname = 'course';
        $importtime = time();
        ...
        $expected = shezar_date_parse_from_format('Y-m-d', '2020-06-06');
