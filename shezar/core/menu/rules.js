...
M.shezar_restrictcohort = M.shezar_restrictcohort || {
    ...
    init: function(Y, args) {
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.shezar_restrictcohort.init()-> jQuery dependency required for this module.');
        }
        ...
        $('select[name="audiencevisible"]').change(M.shezar_restrictcohort.checkcohortaddvisibility);
    ...
    init_dialogs: function() {
        ...
        var ehandler = new shezarDialog_handler_restrictcohorts();
...
shezarDialog_handler_restrictcohorts = function() {
    this.baseurl = '';
...
shezarDialog_handler_restrictcohorts.prototype = new shezarDialog_handler_treeview_multiselect();
 ...
 * @return void
 */
shezarDialog_handler_restrictcohorts.prototype._update = function(response) {
    ...
    if (newids.length > 0) {
        ...
        var ajax_url = M.cfg.wwwroot + '/shezar/cohort/dialog/cohort_item.php?itemid=' + newids.join(',') + params;
 ...
 */
shezarDialog_handler_restrictcohorts.prototype.cohort_item_exists = function(itemid) {
...
shezarDialog_handler_restrictcohorts.prototype.check_table_hidden_status = function() {
...
shezarDialog_handler_restrictcohorts.prototype.add_cohort_delete_event_handlers = function() {
 ...
 * Adds an item
 */
shezarDialog_handler_restrictcohorts.prototype.add_cohort_item = function(itemid) {
 ...
 */
shezarDialog_handler_restrictcohorts.prototype.create_item = function(html) {
    var element = $(html);
...
shezarDialog_handler_restrictcohorts.prototype.remove_cohort_item = function(item) {
