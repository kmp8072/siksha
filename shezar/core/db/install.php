...
function xmldb_shezar_core_install() {
    global $CFG, $DB, $SITE;

    // switch to new default theme in shezar 9.0
    ...
    // Following roles are not created any more since shezar 8.0 - assessor, regionalmanager, regionaltrainer.
    ...
    // Turn completion on in shezar when upgrading from Moodle.
    ...
    // was never implemented and is no longer in shezar
    ...
    // Adding some shezar upgrade code from lib/db/upgrade.php to
