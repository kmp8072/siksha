 ...
 *
 * shezar_core specific language strings.
 * these should be called like get_string('key', 'shezar_core');
 */
...
$string['cannotdownloadshezarlanguageupdatelist'] = 'Cannot download list of language updates from download.shezarlms.com';
$string['cannotundeleteuser'] = 'Cannot undelete user';
$string['cloudconfigoverride'] = 'This setting is not available on shezar cloud.';
...
$string['configforceloginshezar'] = 'Normally, the entire site is only available to logged in users. If you would like to make the front page and the course listings (but not the course contents) available without logging in, then you should uncheck this setting.';
...
$string['enabledisableshezarsync'] = 'Select Enable or Disable and then click continue to update HR Import for {$a}';
...
$string['error:autoupdatedisabled'] = 'Automatic checking for updates is currently disabled in shezar';
$string['error:cannotmanagereminders'] = 'You do not have permission to manage reminders';
$string['error:cannotupgradefromnewermoodle'] = 'You cannot upgrade to shezar {$a->newshezarversion} from this version of Moodle. Please use a newer version of shezar which is based on Moodle core {$a->oldversion} or above.';
$string['error:cannotupgradefromnewershezar'] = 'You cannot downgrade from {$a->oldversion} to {$a->newversion}.';
$string['error:cannotupgradefrommoodle'] = 'You cannot upgrade to this shezar version from a Moodle version prior to 2.2.7. Please upgrade to shezar 2.2.13+ or Moodle 2.2.7+ first.';
$string['error:cannotupgradefromshezar'] = 'You cannot upgrade to this shezar version from a shezar version prior to 2.2.13, please upgrade to shezar 2.2.13+ first.';
...
$string['error:notificationsparamtypewrong'] = 'Incorrect param type sent to shezar notifications';
...
$string['menuitem:roleswithaccess_help'] = 'This criteria allows you to restrict access to the menu item based upon the roles a user has been assigned. You can select as many roles as you like and use the other supporting settings to determine how shezar checks those roles.
...
$string['myfuturebookings'] = 'My Future Classroom Trainings';
$string['mylearning'] = 'My Learning';
$string['mypastbookings'] = 'My Past Classroom Trainings';
$string['myprofile'] = 'My Profile';
$string['myrecordoflearning'] = 'My Record of Learning';
$string['mysqlneedsbarracuda'] = 'Advanced shezar features require InnoDB Barracuda storage format';
$string['mysqlneedsfilepertable'] = 'Advanced shezar features require InnoDB File-Per-Table mode to be enabled';
$string['mysqlneedsinnodb'] = 'The current database engine "{$a}" may not be compatible with shezar, it is strongly recommended to use InnoDB or XtraDB engine.';
...
$string['notimplementedshezar'] = 'Sorry, this feature is only implemented on MySQL, MSSQL and PostgreSQL databases.';
...
$string['pastbookingsfor'] = 'Past Classroom Trainings for ';
...
$string['poweredby'] = 'Powered by shezar LMS';
...
$string['remoteshezarlangnotavailable'] = 'Because shezar can not connect to download.shezarlms.com, we are unable to do language pack installation automatically. Please download the appropriate zip file(s) from https://download.shezarlms.com/lang/T{$a->shezarversion}/, copy them to your {$a->langdir} directory and unzip them manually.';
...
$string['tab:futurebookings'] = 'Future Classroom Trainings';
$string['tab:pastbookings'] = 'Past Classroom Trainings';
...
$string['toggleshezarsync'] = 'Toggle HR Import';
$string['toggleshezarsyncerror'] = 'Could not enable/disable the HR Import field for user {$a}';
$string['toggleshezarsyncerror:noidnumber'] = 'The ID Number field is empty and so HR Import cannot be enabled for these users: {$a}';
$string['toolshezarsynctask'] = 'Import HR elements from external sources';
$string['shezarbuild'] = 'shezar build number';
$string['shezarcopyright'] = '<p>Copyright &copy; 2010 onwards, shezar Learning Solutions Limited.</p>
<p><a href="http://www.shezarlms.com">shezar LMS</a> is a fully supported Open Source learning platform specifically designed for the requirements of corporate, industry and vocational training.</p>
<p><a href="http://www.gnu.org/licenses/gpl-3.0.en.html">GNU General Public License</a></p>';
$string['shezarcopyrightacknowledge'] = '<p>shezar LMS utilises the following copyrighted material:</p>';
$string['shezarcore'] = 'shezar core';
$string['shezarfeatures'] = 'shezar features';
$string['shezarlogo'] = 'shezar Logo';
$string['shezarmenu'] = 'shezar Menu';
$string['shezarnavigation'] = 'Main menu';
$string['shezarregistration'] = 'shezar Registration';
$string['shezarregistrationinfo'] = '<p>This page configures registration updates which are sent to shezarlms.com.
These updates allow shezar to know what versions of shezarlms and support software you are running.
This information will allow shezar to better examine and resolve any support issues you face in the future.</p>
<p>This information will be securely transmitted and held in confidence.</p>';
$string['shezarrelease'] = 'shezar release identifier';
$string['shezarreleaselink'] = 'See the <a href="https://community.shezarlms.com/mod/forum/view.php?id=1834" target=\"_blank\">release notes</a> for more details.';
$string['shezarrequiredupgradeversion'] = 'shezar 2.2.13';
$string['shezaruniqueidnumbercheckfail'] = 'The following tables contain non-unique values in the column idnumber:<br/><br/>
{$a}
<br/>
Please fix these records before attempting the upgrade.';
$string['shezarunsupportedupgradepath'] = 'You cannot upgrade directly to {$a->attemptedversion} from {$a->currentversion}. Please upgrade to at least {$a->required} before attempting the upgrade to {$a->attemptedversion}.';
$string['shezarupgradecheckduplicateidnumbers'] = 'Check duplicate ID numbers';
$string['shezarupgradesetstandardtheme'] = 'Enable Standard shezar theme';
$string['shezarversion'] = 'shezar version number';
