 ...
 */
class shezar_page extends moodle_page {
    /**
     * Return shezar requirements manager
    ...
    protected function magic_get_requires() {
        if (is_null($this->_requires)) {
            $this->_requires = new shezar_page_requirements_manager();
        }
 ...
 */
class shezar_page_requirements_manager extends page_requirements_manager {
    /**
