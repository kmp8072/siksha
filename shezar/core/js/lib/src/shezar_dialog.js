 ...
 */
M.shezar_dialog = M.shezar_dialog || {
    ...
    init: function(Y, args){
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.shezar_dialog.init()-> jQuery dependency required for this module to function.');
        }
    }
};
...
// Dialog object
function shezarDialog(title, buttonid, config, default_url, handler) {
    ...
    this.setup = function() {
        ...
        $('<div class="shezar-dialog" style="display: none;"><div id="'+this.title+'"></div></div>').appendTo($('body'));
    ...
    this.error = function(dialog, response, url) {
        if (response) {
            ...
            require(['core/str'], function (mdlstring) {
                mdlstring.get_string('error:dialoggenericerror', 'shezar_core').done(function (genericerror) {
                    // Hide loading animation.
                    dialog.hideLoading();
...
/*****************************************************************************/
/** shezarDialog_handler **/

function shezarDialog_handler() {

    // Reference to the shezarDialog object
    var _dialog;
 ...
 * @return void
 */
shezarDialog_handler.prototype._setup = function(dialog) {
    this._dialog = dialog;
 ...
 * @return void
 */
shezarDialog_handler.prototype._load = function(dialog) {
 ...
 * @return void
 */
shezarDialog_handler.prototype._update = function(response) {
    ...
    $('.shezar-noscript', $('div.list-'+this._title)).hide();
 ...
 * @return array
 */
shezarDialog_handler.prototype._get_ids = function(elements, prefix) {
 ...
 * @return void
 */
shezarDialog_handler.prototype._save = function(url) {
 ...
 * @return void
 */
shezarDialog_handler.prototype._cancel = function() {
    this._dialog.hide();
    return;
}
 ...
 * @return void
 */
shezarDialog_handler.prototype._set_framework = function() {
 ...
 * @return void
 */
shezarDialog_handler.prototype._set_plan = function() {
...
/*****************************************************************************/
/** shezarDialog_handler_treeview **/

shezarDialog_handler_treeview = function() {};

shezarDialog_handler_treeview.prototype = new shezarDialog_handler();
 ...
 * @return void
 */
shezarDialog_handler_treeview.prototype.setup_tabs = function(e, ui) {
 ...
 * @return void
 */
shezarDialog_handler_treeview.prototype.first_load = function() {
 ...
 * @return void
 */
shezarDialog_handler_treeview.prototype._partial_load = function(parent_element) {
 ...
 * @return void
 */
shezarDialog_handler_treeview.prototype._make_hierarchy = function(parent_element) {
    var handler = this;
 ...
 * @return void
 */
shezarDialog_handler_treeview.prototype._update_hierarchy = function(response, parent_id) {
    var items = response;
 ...
 * @return void
 */
shezarDialog_handler_treeview.prototype._toggle_items = function(elid, type) {
 ...
 * @return void
 */
shezarDialog_handler_treeview.prototype._make_deletable = function(parent_element) {
 ...
 * @return void
 */
shezarDialog_handler_treeview.prototype._append_to_selected = function(element) {
...
/*****************************************************************************/
/** shezarDialog_handler_treeview_multiselect **/

shezarDialog_handler_treeview_multiselect = function() {};
shezarDialog_handler_treeview_multiselect.prototype = new shezarDialog_handler_treeview();
 ...
 * @return void
 */
shezarDialog_handler_treeview_multiselect.prototype.every_load = function() {
 ...
 * @return void
 */
shezarDialog_handler_treeview_multiselect.prototype._make_selectable = function(parent_element) {
 ...
 * @return void
 */
shezarDialog_handler_treeview_multiselect.prototype._handle_update_hierarchy = function(parent_element) {
    this._make_selectable(parent_element);
}


/*****************************************************************************/
/** shezarDialog_handler_treeview_multiselect_rb_filter **/

shezarDialog_handler_treeview_multiselect_rb_filter = function() {};
shezarDialog_handler_treeview_multiselect_rb_filter.prototype = new shezarDialog_handler_treeview_multiselect();
 ...
 * @return void
 */
shezarDialog_handler_treeview_multiselect_rb_filter.prototype.first_load = function() {
    var id = this._title;
    ...
    $('.multiselect-selected-item', linkcontainer).each(function(i, el) {
        ...
        preselected += '<div class="treeview-selected-item"><span id="item_'+item_id+'"><a href="#">'+item_name+'</a><span class="deletebutton">'
                    + M.util.get_string('delete', 'shezar_core')
                    +'</span></span></div>';
...
shezarDialog_handler_treeview_multiselect_rb_filter.prototype._update = function(response) {
    var id = this._title;
...
/*****************************************************************************/
/** shezarDialog_handler_treeview_singleselect **/

shezarDialog_handler_treeview_singleselect = function(value_element_name, text_element_id, dualpane) {
...
shezarDialog_handler_treeview_singleselect.prototype = new shezarDialog_handler_treeview();
 ...
 * @return void
 */
shezarDialog_handler_treeview_singleselect.prototype._handle_update_hierarchy = function(parent_element) {
    this._make_selectable(parent_element);
}
 ...
 * @return  void
 */
shezarDialog_handler_treeview_singleselect.prototype.setup_delete = function() {
    this.deletable = true;
    ...
    require(['core/templates'], function (templates) {
        templates.renderIcon('delete', M.util.get_string('delete', 'shezar_core')).done(function (html) {
 ...
 * @return void
 */
shezarDialog_handler_treeview_singleselect.prototype.first_load = function() {

    // Setup dialog
    shezarDialog_handler_treeview.prototype.first_load.call(this);
 ...
 * @return void
 */
shezarDialog_handler_treeview_singleselect.prototype.every_load = function() {

    this._make_selectable($('.treeview', this._container));
}

shezarDialog_handler_treeview_singleselect.prototype._set_current_selected = function() {
 ...
 * @return void
 */
shezarDialog_handler_treeview_singleselect.prototype._save = function() {
    dialog = this;
    ...
    if (selected_val === "0") {
        if (!M.str.hasOwnProperty('shezar_core') || !M.str['shezar_core'].hasOwnProperty('error:'+this._title+'notselected')) {
            require(['core/str'], function (mdlstring) {
                mdlstring.get_string('error:itemnotselected', 'shezar_core').done(function (itemnotselected) {
                    alert(itemnotselected);
                })
            ;})
        } else {
            alert(M.util.get_string('error:'+this._title+'notselected', 'shezar_core'));
        }
        return false;
    }
 ...
 * @return void
 */
shezarDialog_handler_treeview_singleselect.prototype._make_selectable = function(parent_element) {
...
/*****************************************************************************/
/** shezarDialog_handler_skeletalTreeview **/

shezarDialog_handler_skeletalTreeview = function() {};
shezarDialog_handler_skeletalTreeview.prototype = new shezarDialog_handler_treeview();
 ...
 * @return void
 */
shezarDialog_handler_skeletalTreeview.prototype.every_load = function() {
 ...
 * @return void
 */
shezarDialog_handler_skeletalTreeview.prototype._make_hierarchy = function(parent_element) {
    var handler = this;
 ...
 * @return void
 */
shezarDialog_handler_skeletalTreeview.prototype._update_hierarchy = function(response, parent_id) {
...
* @return void
*/
shezarDialog_handler_skeletalTreeview.prototype._make_selectable = function(elements, addclickable) {
    var handler = this;
...
/*****************************************************************************/
/** shezarDialog_handler_form **/

shezarDialog_handler_form = function() {};
shezarDialog_handler_form.prototype = new shezarDialog_handler();


/**
 * Add custom submit handler to forms in dialog
 */
shezarDialog_handler_form.prototype.every_load = function() {
    var handler = this;
 ...
 */
shezarDialog_handler_form.prototype.submit = function() {
 ...
 * @return  void
 */
shezarDialog_handler_form.prototype._updatePage = function(response) {
...
/*****************************************************************************/
/** shezarDialog_handler_selectable **/

shezarDialog_handler_selectable = function(selected) { this.selected = selected; };
shezarDialog_handler_selectable.prototype = new shezarDialog_handler();

shezarDialog_handler_selectable.prototype.first_load = function() {
    // Setup selectable
...
shezarDialog_handler_selectable.prototype.every_load = function() {
    shezarDialog_handler_selectable.prototype.first_load.call(this);
};

shezarDialog_handler_selectable.prototype._updatePage = function(response) {
...
shezarDialog_handler_selectable.prototype._set_selected = function() {
 ...
 * @return void
 */
shezarSingleSelectDialog = function(name, title, find_url, value_element, text_element, handler_extra, deletable) {

    var handler = new shezarDialog_handler_treeview_singleselect(value_element, text_element);
    var buttonObj = {};
    if (deletable) {
        handler.setup_delete();
    }
 ...
 * @return void
 */
shezarMultiSelectDialog = function(name, title, find_url, save_url) {

    var handler = new shezarDialog_handler_treeview_multiselect();

    var buttonObj = {};
    buttonObj[M.util.get_string('save', 'shezar_core')] = function() { handler._save(save_url) };
    buttonObj[M.util.get_string('cancel', 'moodle')] = function() { handler._cancel() };
 ...
 * @return void
 */
shezarMultiSelectDialogRbFilter = function(name, title, find_url, save_url) {

    var handler = new shezarDialog_handler_treeview_multiselect_rb_filter();
