...
Also has the following change due to introduction of requirejs in Moodle 2.9 / shezar 8.0 (which caused the plugin to switch to AMD mode):
diff --git a/shezar/core/js/lib/jquery.dataTables.js b/shezar/core/js/lib/jquery.dataTables.js
index 4440ba6..4f296fc 100644
--- a/shezar/core/js/lib/jquery.dataTables.js
+++ b/shezar/core/js/lib/jquery.dataTables.js
@@ -29,15 +29,7 @@
 (function( factory ) {
        "use strict";
