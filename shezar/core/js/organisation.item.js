 ...
 */
M.shezar_organisationitem = M.shezar_organisationitem || {
    ...
    init: function(Y, args){
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.shezar_competencyitem.init()-> jQuery dependency required for this module to function.');
        }
        ...
        (function() {
            ...
            $(document).on('click', '#show-assignedgoals-dialog', function(event) {
                ...
                // Open default url
                var select = $(this);
                var id = M.shezar_organisationitem.config.id;
                var sesskey = M.shezar_organisationitem.config.sesskey;
        ...
        //
        (function() {
            var url = M.cfg.wwwroot+ '/shezar/hierarchy/prefix/organisation/assigncompetency/';
            var id = M.shezar_organisationitem.config.id;
            var fid = M.shezar_organisationitem.config.frameworkid;
