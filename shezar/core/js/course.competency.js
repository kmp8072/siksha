 ...
 */
M.shezar_coursecompetency = M.shezar_coursecompetency || {
    ...
    init: function(Y, args){
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.shezar_competencyadd.init()-> jQuery dependency required for this module to function.');
        }
        ...
        if (typeof this.config.competencyuseresourcelevelevidence !== 'undefined' &&
            ...
            shezarDialog_handler_assignCourseEvidence = function() {
                // Base url
                var baseurl = '';
            };

            shezarDialog_handler_assignCourseEvidence.prototype = new shezarDialog_handler_treeview_singleselect(null, null, dualpane=true);

            shezarDialog_handler_assignCourseEvidence.prototype.handle_click = function(clicked) {
            ...
            shezarDialog_handler_assignCourseEvidence.prototype.display_evidence = function(response) {
            ...
            ///
            (function() {
                var url = M.cfg.wwwroot+'/shezar/hierarchy/prefix/competency/course/';

                var handler = new shezarDialog_handler_assignCourseEvidence();
                handler.baseurl = url;

                var buttonsObj = {};
                buttonsObj[M.util.get_string('cancel','moodle')] = function() { handler._cancel() };

                shezarDialogs['coursecompetency'] = new shezarDialog(
                    'coursecompetency',
                    'show-coursecompetency-dialog',
                    {
                        buttons: buttonsObj,
                        title: '<h2>'+M.util.get_string('addcourseevidencetocompetencies', 'shezar_hierarchy')+'</h2>'
                    },
            ...
            shezarDialog_handler_courseEvidence = function() {
                // Base url
                var baseurl = '';
            };

            shezarDialog_handler_courseEvidence.prototype = new shezarDialog_handler_treeview_multiselect();
             ...
             * @return void
             */
            shezarDialog_handler_courseEvidence.prototype._update = function(response) {
            ...
            (function() {
                ...
                var handler = new shezarDialog_handler_courseEvidence();
                handler.baseurl = url;
                ...
                shezarDialogs['evidence'] = new shezarDialog(
                    ...
                    {
                        buttons: buttonsObj,
                        title: '<h2>'+M.util.get_string('assigncoursecompletiontocompetencies', 'shezar_hierarchy')+'</h2>'
                    },
            ...
            $(shezarDialogs.evidence.dialog).bind('ajaxComplete', function(event) {
