 ...
 */
M.shezar_cohort = M.shezar_cohort || {
    ...
    init: function(Y, args){
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.shezar_cohort.init()-> jQuery dependency required for this module to function.');
        }
        ...
        (function() {
            ...
            $(document).on('click', '#show-assignedgoals-dialog', function(event) {
                ...
                // Open default url
                var select = $(this);
                var id = M.shezar_cohort.config.id;
                var sesskey = M.shezar_cohort.config.sesskey;
        ...
        (function() {
            ...
            shezarSingleSelectDialog(
                'position',
                M.util.get_string('chooseposition', 'shezar_hierarchy') +
        ...
        (function() {
            ...
            shezarSingleSelectDialog(
                'organisation',
                M.util.get_string('chooseorganisation', 'shezar_hierarchy') +
        ...
        (function() {
            ...
            var dialog = new shezarDialog(
                name,
                'id_submitbutton',
                {
                    buttons: buttonsObj,
                    title: '<h2>'+ M.util.get_string('confirmdynamiccohortcreation', 'shezar_cohort') +'</h2>'
                },
                '',
                handler
            );
