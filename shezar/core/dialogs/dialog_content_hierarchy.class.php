 ...
 * @access  public
 */
class shezar_dialog_content_hierarchy extends shezar_dialog_content {
     ...
     *
     * @see     shezar_dialog_hierarchy::skip_access_checks
     *
     * @access  public
    ...
    public function __construct($prefix, $frameworkid = 0, $showhidden = false, $skipaccesschecks = false) {
        ...
        if (!$this->skip_access_checks) {
            ...
            require_capability("shezar/hierarchy:view{$prefix}", context_system::instance());
        }
        ...
        if (empty($this->framework)) {
            echo '<p>' . get_string($prefix.'noframeworkssetup', 'shezar_hierarchy') . '</p>';
            die();
        }
 ...
 * @access  public
 */
class shezar_dialog_content_hierarchy_multi extends shezar_dialog_content_hierarchy {
