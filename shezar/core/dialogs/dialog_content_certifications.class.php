 ...
 * @access  public
 */
class shezar_dialog_content_certifications extends shezar_dialog_content {
    ...
    public function load_categories() {
        ...
        $category_item_counts = (count($category_ids) > 0) ? shezar_get_category_item_count($category_ids, 'certification') : array();
