 ...
 */
define('shezar_DIALOG_MAXITEMS', 1000);
...
class shezar_dialog_content {
     ...
     * @var     string
     */
    public $search_code = '/shezar/core/dialogs/search.php';
    ...
    public function generate_markup() {
        ...
        $markup .= '  <li><a href="#browse-tab">'.get_string('browse', 'shezar_core').'</a></li>';
                ...
                foreach ($this->items as $element) {
                    ...
                    if (isset($element->fullname)) {
                        if (isset($element->email) && $canviewemail) {
                            $displayname = get_string('assignindividual', 'shezar_program', $element);
                        } else {
    ...
    public function generate_search() {
        ...
        define('shezar_DIALOG_SEARCH', true);
        ob_start();
