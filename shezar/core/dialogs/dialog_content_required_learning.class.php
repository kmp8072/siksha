...
class shezar_dialog_content_required_learning extends shezar_dialog_content {
    ...
    public function get_search_info(stdClass $search_info, array $keywords) {
        ...
        if ($keywords) {
            list($searchsql, $searchparams) = shezar_search_get_keyword_where_clause($keywords, array('prog.fullname'));
