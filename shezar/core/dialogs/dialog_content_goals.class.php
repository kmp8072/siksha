...
class shezar_dialog_content_goals extends shezar_dialog_content {
    ...
    public function __construct($frameworkid = goal::SCOPE_COMPANY, $showhidden = false, $userid = 0) {
        ...
        // Set lang file.
        $this->lang_file = 'shezar_hierarchy';
    ...
    public function get_frameworks() {
        $list = array();
        if ($this->showcompany) {
            $list[goal::SCOPE_COMPANY] = get_string('companygoals', 'shezar_hierarchy');
        }
        if ($this->showpersonal) {
            $list[goal::SCOPE_PERSONAL] = get_string('personalgoals', 'shezar_hierarchy');
        }
        return $list;
    }
    ...
    protected function _prepend_markup() {
        ...
        return display_dialog_selector($select_options, goal::SCOPE_COMPANY, 'simpleframeworkpicker', array(
            ...
            'label' => get_string('goaltypes', 'shezar_hierarchy'),
        ));
    }
