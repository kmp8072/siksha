 ...
 * @package shezar_core
 */
class bulk_enrolments_started extends \core\event\base {
    /**
     * Create instance of event.
     *
     * @param \stdClass $instance enrol instance
     * @return bulk_enrolments_started
     */
    ...
    public static function get_name() {
        return get_string('eventbulkenrolmentsstarted', 'shezar_core');
    }
    ...
    public function get_description() {
        return "Bulk enrolment changes were started in course $this->courseid";
    }
}
