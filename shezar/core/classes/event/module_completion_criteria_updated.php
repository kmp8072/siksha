...
/**
 * Event triggered when module completion criteria is changed.
 *
 * @package shezar_core
 */
class module_completion_criteria_updated extends \core\event\base {

    /**
     * Create instance of event.
     *
     * @param \stdClass $mod
     * @return module_completion_criteria_updated
     */
    ...
    public static function get_name() {
        return get_string('eventmodulecompletioncriteriaupdated', 'shezar_core');
    }
    ...
    public function get_description() {
        return "Completion criteria for module with id '$this->objectid' in course '$this->courseid' was updated";
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, $this->other['module'], 'Module completion criteria updated',
