...
/**
 * Event triggered when module completion is unlocked and data deleted.
 *
 * @since   shezar 2.7
 * @author  Petr Skoda <petr.skoda@shezarlms.com>
 * @package shezar_core
 */
class module_completion_reset extends \core\event\base {

    /**
     * Create instance of event.
     *
     * @param \stdClass $mod
     * @return module_completion_reset
     */
    ...
    public static function get_name() {
        return get_string('eventmodulecompletionreset', 'shezar_core');
    }
    ...
    public function get_description() {
        return "Completion data for module with id '$this->objectid' in course '$this->courseid' was reset";
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, $this->other['module'], 'Module completion reset',
