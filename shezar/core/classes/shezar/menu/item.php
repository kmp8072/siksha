...
class item {
     ...
     * Coming string is "shezar_core\shezar\menu\myclassname".
     * Returns "myclassname".
     *
    ...
    protected function get_visibility_custom() {
        ...
        $ruleset = $DB->get_records('shezar_navigation_settings', array('itemid' => $this->id));
        ...
        foreach ($presets as $preset) {
            switch ($preset) {
                ...
                case 'can_view_required_learning':
                    $result[] = $this->check_menu_item_visibility('\shezar_program\shezar\menu\requiredlearning');
                    break;
                case 'can_view_my_team':
                    $result[] = $this->check_menu_item_visibility('\shezar_core\shezar\menu\myteam');
                    break;
                case 'can_view_my_reports':
                    $result[] = $this->check_menu_item_visibility('\shezar_core\shezar\menu\myreports');
                    break;
                case 'can_view_certifications':
                    $result[] = $this->check_menu_item_visibility('\shezar_coursecatalog\shezar\menu\certifications');
                    break;
                case 'can_view_programs':
                    $result[] = $this->check_menu_item_visibility('\shezar_coursecatalog\shezar\menu\programs');
                    break;
                case 'can_view_allappraisals':
                    $result[] = $this->check_menu_item_visibility('\shezar_appraisal\shezar\menu\allappraisals');
                    break;
                case 'can_view_latestappraisal':
                    $result[] = $this->check_menu_item_visibility('\shezar_appraisal\shezar\menu\latestappraisal');
                    break;
                case 'can_view_appraisal':
                    $result[] = $this->check_menu_item_visibility('\shezar_appraisal\shezar\menu\appraisal');
                    break;
                case 'can_view_feedback_360s':
                    $result[] = $this->check_menu_item_visibility('\shezar_feedback360\shezar\menu\feedback360');
                    break;
                case 'can_view_my_goals':
                    $result[] = $this->check_menu_item_visibility('\shezar_hierarchy\shezar\menu\mygoals');
                    break;
                case 'can_view_learning_plans':
                    $result[] = $this->check_menu_item_visibility('\shezar_plan\shezar\menu\learningplans');
                    break;
                default:
    ...
    private function check_menu_item_visibility($menuclass) {
        /** @var \shezar_core\shezar\menu\item $menuinstance */
