...
class shezar_assign_core_grouptype_cohort extends shezar_assign_core_grouptype {

    protected $grouptype = 'cohort';
    // The dialog class.
    protected $pickerclass = 'shezar_assign_ui_picker_cohort';
    ...
    public function get_grouptype_displayname() {
        return get_string($this->grouptype, 'shezar_cohort');
    }
