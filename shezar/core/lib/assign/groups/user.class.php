 ...
 */
class shezar_assign_core_grouptype_user extends shezar_assign_core_grouptype {

    protected $grouptype = 'user';
    // The dialog class.
    protected $pickerclass = 'shezar_assign_ui_picker_user';
    ...
    public function get_grouptype_displayname() {
        return get_string('assignuser', 'shezar_core');
    }
    ...
    public function get_current_assigned_groups_sql($itemid) {
        global $DB;
        $fullname = $DB->sql_concat_join("' '", shezar_get_all_user_name_fields_join('source'));
