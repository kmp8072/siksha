...
class shezar_assign_core_grouptype_hierarchy extends shezar_assign_core_grouptype {

    /** @var string The dialog class. */
    protected $pickerclass = 'shezar_assign_ui_picker_hierarchy';
    ...
    public function get_grouptype_displayname() {
        return get_string($this->prefix, 'shezar_hierarchy');
    }
