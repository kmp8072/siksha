 ...
 */
class shezar_core_flex_icon_testcase extends advanced_testcase {
    ...
    public function test_create_from_pix_url() {
        ...
        $url = 'http://www.example.com/moodle/theme/image.php/_s/standardshezarresponsive/forum/1/icon';
