...
class shezar_core_event_bulk_enrolments_ended_testcase extends advanced_testcase {
    public function test_event() {
        ...
        $event = \shezar_core\event\bulk_enrolments_ended::create_from_instance($instance);
        $event->trigger();
