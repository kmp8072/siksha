 ...
 * vendor/bin/phpunit --verbose shezar_core_completion_start_user_bulk_testcase shezar/core/tests/completion_start_user_bulk_test.php
 */
...
class shezar_core_completion_start_user_bulk_testcase extends advanced_testcase {
