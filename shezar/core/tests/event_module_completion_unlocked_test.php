...
class shezar_core_event_module_completion_unlocked_testcase extends advanced_testcase {
    ...
    public function test_event() {
        ...
        $event = \shezar_core\event\module_completion_unlocked::create_from_module($modinfo);
        $event->trigger();
        ...
        $legacydata = array($course->id, 'quiz', 'Module completion unlocked', 'course/modedit.php?id=' . $quiz->cmid, "instance:{$quiz->id}", $quiz->cmid);
