 ...
 */
class shezar_core_component_testcase extends advanced_testcase {
    public function test_get_namespace_classes() {
        ...
        $this->assertContains('shezar_reportbuilder\rb\display\base', $displayclasses);
        $count = count($displayclasses);

        $displayclasses = core_component::get_namespace_classes('rb\display', 'shezar_reportbuilder\rb\display\base');
        $this->assertInternalType('array', $displayclasses);
        foreach ($displayclasses as $displayclass) {
            $this->assertContains('\rb\display\\', $displayclass);
        }
        ...
        $displayclasses = core_component::get_namespace_classes('rb\display', 'shezar_reportbuilder\rb\display\legacy');
        $this->assertInternalType('array', $displayclasses);
        $this->assertContains('shezar_reportbuilder\rb\display\legacy', $displayclasses);
        ...
        $this->assertNotContains('shezar_reportbuilder\rb\aggregate\base', $displayclasses);
        ...
        $this->assertContains('shezar_reportbuilder\rb\aggregate\base', $displayclasses);

        $displayclasses = core_component::get_namespace_classes('rb\display', 'shezar_reportbuilder\rb\display\base', 'shezar_reportbuilder');
        $this->assertInternalType('array', $displayclasses);
        $this->assertGreaterThan(15, count($displayclasses));
        foreach ($displayclasses as $displayclass) {
            $this->assertContains('shezar_reportbuilder\rb\display\\', $displayclass);
        }
