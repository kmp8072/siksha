 ...
 */
class shezar_core_moodlelib_testcase extends advanced_testcase {
    ...
    public function test_delete_user() {
        ...
        // Delete user the old shezar way.
    ...
    /**
     * shezar specific tests for sending of emails.
     */
    public function test_email_to_user() {
        ...
        // No messing with external shezar users.

        $u = \shezar_core\shezar_user::get_external_user('ext@example.com');
        $prevu = clone($u);
