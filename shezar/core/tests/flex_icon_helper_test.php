 ...
 */
class shezar_core_flex_icon_helper_testcase extends advanced_testcase {
    ...
    public function test_all_flex_icons_files() {
        ...
        foreach ($locations as $component => $location) {
            if (strpos($component, 'tinymce') !== false) {
                // Skip deprecated stuff that is not supposed to be used or that will be removed in shezar 10.
                continue;
            }
