 ...
 */
class shezar_core_shezar_lang_testcase extends advanced_testcase {
    public function test_shezar() {
        global $CFG;
    ...
    protected function verify_file($component, $file, $exceptions) {
        ...
        foreach ($string as $k => $v) {
            ...
            if (stripos($v, 'moodle') !== false) {
                $this->fail("Lang pack string '$component', '$k' contains a word 'Moodle' that is not whitelisted in shezar: $v");
            }
        }
    }
}
