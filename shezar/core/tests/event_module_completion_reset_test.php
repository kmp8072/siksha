...
class shezar_core_event_module_completion_reset_testcase extends advanced_testcase {
    ...
    public function test_event() {
        ...
        $event = \shezar_core\event\module_completion_reset::create_from_module($modinfo);
        $event->trigger();
