...
class shezar_core_event_reminder_created_testcase extends advanced_testcase {
    public function test_event() {
        ...
        $event = \shezar_core\event\reminder_created::create_from_reminder($reminder);
        $event->trigger();
        ...
        $this->assertEventLegacyLogData(array($reminder->courseid, 'course', 'reminder added',
