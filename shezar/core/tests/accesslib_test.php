...
class shezar_core_accesslib_testcase extends advanced_testcase {
     ...
     * we forget to do it in shezar pre-upgrade script.
     */
    public function test_capability_move() {
        ...
        $DB->set_field('capabilities', 'component', 'shezar_core', array('id' => $viewbadges->id));
