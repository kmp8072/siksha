...
class shezar_core_event_bulk_role_assignments_started_testcase extends advanced_testcase {
    public function test_event() {
        ...
        $event = \shezar_core\event\bulk_role_assignments_started::create_from_context($context);
        $event->trigger();
