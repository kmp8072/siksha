 ...
 */
class behat_shezar_data_generators extends behat_base {
    /**
    ...
    protected static $componentelements = array(
        // NOTE: this could be dynamic, but it is not a problem for shezar.
        'shezar_core' => array(
    ...
    public function the_following_exist_in_plugin($elementname, $component, TableNode $data) {
        ...
        $helper = new shezar_core_behat_helper_generator();
