...
class shezar_core_menu_testcase extends advanced_testcase {
    public function test_url_replace() {
        ...
        $result = \shezar_core\shezar\menu\menu::replace_url_parameter_placeholders($url);
    ...
    public function test_validate() {
        ...
        $errors = \shezar_core\shezar\menu\menu::validation($data);
