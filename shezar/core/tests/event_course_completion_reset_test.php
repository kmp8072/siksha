...
class shezar_core_event_course_completion_reset_testcase extends advanced_testcase {
    public function test_event() {
        $this->resetAfterTest();

        $course = $this->getDataGenerator()->create_course();

        $event = \shezar_core\event\course_completion_reset::create_from_course($course);
        $event->trigger();
        ...
        $this->assertEventLegacyLogData(array($course->id, 'course', 'completion data reset', 'completion.php?id=' . $course->id), $event);
    }
}
