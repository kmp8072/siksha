...
use \shezar_core\tabexport_source;
use \shezar_core\tabexport_writer;
...
class writer extends tabexport_writer {
    ...
    protected function create_pdf() {
        ...
        if (!static::is_ready()) {
            ...
            copy("$CFG->dirroot/shezar/core/tabexport/wkpdfportrait/failed.bin", $pdffile);
...
<body>";
        ...
        if ($customheader === null) {
            ...
            $recordscount = get_string('x' . $resultstr, 'shezar_reportbuilder', $count);
