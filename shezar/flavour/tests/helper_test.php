 ...
 */
class shezar_flavour_helper_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $this->testflavouravailable = file_exists("$CFG->dirroot/shezar/flavour/flavours/test/classes/definition.php");
    }
    ...
    public function test_expected_defaults() {
        ...
        $this->assertEquals(shezar_SHOWFEATURE, get_config('moodle', 'enableappraisals'));

        // We need some flavours for testing.
        $this->assertFileExists("$CFG->dirroot/shezar/flavour/flavours/enterprise/classes/definition.php");

        if ($this->testflavouravailable) {
            // We can only test this if the test flavour is installed.
            $this->assertFileExists("$CFG->dirroot/shezar/flavour/flavours/test/classes/definition.php");
        }
    }
    ...
    public function test_get_active_flavour_definition_forced() {
        ...
        // Forced flavour.
        set_config('currentflavour', 'flavour_test', 'shezar_flavour');
        $CFG->forceflavour = '';
        $result = helper::get_active_flavour_definition();
        $this->assertNull($result);
    ...
    public function test_get_active_flavour_definition_manual() {
        ...
        set_config('currentflavour', 'flavour_enterprise', 'shezar_flavour');
        $result = helper::get_active_flavour_definition();
        $this->assertInstanceOf('flavour_enterprise\\definition', $result);

        unset_config('currentflavour', 'shezar_flavour');
        $result = helper::get_active_flavour_definition();
        $this->assertNull($result);

        // Invalid manual flavour.
        set_config('currentflavour', 'flavour_xxxxx', 'shezar_flavour');
        $result = helper::get_active_flavour_definition();
        $this->assertNull($result);
    }
    ...
    public function test_get_available_flavour_definitions() {
        ...
        foreach ($result as $component => $flavour) {
            ...
            $this->assertInstanceOf('shezar_flavour\\definition', $flavour);
        }
    }
    ...
    public function test_get_enforced_settings() {
        ...
        $this->assertSame(shezar_DISABLEFEATURE, $result['moodle']['enableappraisals']);
        $this->assertSame('', $result['theme_customshezarresponsive']['customcss']);
    }
    ...
    public function test_get_prohibited_settings() {
        ...
        $this->assertSame(true, $result['theme_customshezarresponsive']['customcss']);
    }
    ...
    public function test_execute_post_install_steps() {
        ...
        $this->assertSame('flavour_test', get_config('shezar_flavour', 'currentflavour'));
        $this->assertEquals(shezar_DISABLEFEATURE, get_config('moodle', 'enableappraisals'));
    }
    ...
    public function test_set_active_flavour() {
        ...
        $this->assertSame('flavour_enterprise', get_config('shezar_flavour', 'currentflavour'));
        $this->assertEquals(shezar_DISABLEFEATURE, get_config('moodle', 'enableappraisals'));
