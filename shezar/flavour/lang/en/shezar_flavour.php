...
$string['setting_core_enablecourserpl_desc'] = 'The Record of Prior Learning allows learners to view their history in shezar, including the courses, competencies, programs, and certifications that they have been assigned.';
...
$string['setting_core_enableappraisals_desc'] = 'Online appraisals are custom forms site administrators create to allow learners, managers, manager’s managers and appraisers to answer questions and review a learner’s work towards goals and learning plan components.';
$string['setting_core_enablefeedback360'] = '360 Feedback';
$string['setting_core_enablefeedback360_desc'] = '360° feedback provides a mechanism for individual users to receive feedback on their progress from a group of their peers.';
...
$string['setting_core_enableshezardashboard'] = 'Dashboards';
$string['setting_core_enableshezardashboard_desc'] = 'Dashboards allow administrators to design multiple interface options for a user to access upon logging into shezar, so that the features and dashboard reports displayed are appropriate for the user.';
...
$string['setting_core_enablecompetencies_desc'] = 'shezar competencies allow site administrators to define the skills and knowledge that a learner needs to fulfill and managers to assess staff performance.';
