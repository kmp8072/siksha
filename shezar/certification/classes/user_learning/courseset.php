...
use shezar_core\user_learning\designation;
use \shezar_core\user_learning\designation_asset;
...
class courseset implements designation {
    ...
    /**
     * @var \shezar_certification\user_learning\course[]
     */
    private $courses;
     ...
     *
     * @return \shezar_certification\user_learning\course[] Array of courses in this set.
     */
    ...
    public function export_for_template() {
        ...
        switch ($this->completiontype) {
            case COMPLETIONTYPE_ALL;
                $setdata->completion_text = get_string('completeallcoursestoprogress', 'shezar_program');
                break;
            case COMPLETIONTYPE_ANY;
                $setdata->completion_text = get_string('completeanycoursetoprogress', 'shezar_program');
                break;
            case COMPLETIONTYPE_SOME;
                if ($this->mincourses !== 0 && $this->totalpointstocomplete === 0) {
                    ...
                    $setdata->completion_text = get_string($langstring, 'shezar_program', $coursesrequired);
                    ...
                    $setdata->completion_text = get_string('obtainxpointstoprogress', 'shezar_program', $setcompletiontext);
                } elseif ($this->mincourses !== 0 && $this->totalpointstocomplete !== 0) {
                    ...
                    $setdata->completion_text = get_string($langstring, 'shezar_program', $setcompletiontext);
                }
                break;
            default:
        ...
        switch ($this->nextsetoperator) {
            case NEXTSETOPERATOR_OR:
                $setoperator = get_string('or', 'shezar_program');
                break;
            case NEXTSETOPERATOR_AND:
                $setoperator = get_string('and', 'shezar_program');
