...
class certification_add_form extends moodleform {
    ...
    public function definition() {
        ...
        $comptypeoptions = array(
            CERTIFTYPE_PROGRAM => get_string('program', 'shezar_certification'),
        );
        $mform->addElement('select', 'comptype', get_string('comptype', 'shezar_certification'), $comptypeoptions);

        $mform->addHelpButton('comptype', 'comptype', 'shezar_certification');
