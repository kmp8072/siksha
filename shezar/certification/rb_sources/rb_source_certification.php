...
global $CFG;
require_once($CFG->dirroot . '/shezar/program/rb_sources/rb_source_program.php');

class rb_source_certification extends rb_source_program {

    /**
     * Overwrite instance type value of shezar_visibility_where() in rb_source_program->post_config().
     */
    ...
    public function is_ignored() {
        return !shezar_feature_visible('certifications');
    }
    ...
    protected function define_columnoptions() {
        ...
        $this->add_program_fields_to_columns($columnoptions, 'base', 'shezar_certification');
    ...
    protected function define_filteroptions() {
        ...
        $this->add_program_fields_to_filters($filteroptions, 'shezar_certification');
        ...
        $this->add_cohort_program_fields_to_filters($filteroptions, 'shezar_certification');
