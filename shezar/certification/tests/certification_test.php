 ...
 * vendor/bin/phpunit --verbose shezar_certification_certification_testcase shezar/certification/tests/certification_test.php
 */
class shezar_certification_certification_testcase extends reportcache_advanced_testcase {
    ...
    private function actions_stage_1() {
        ...
        sleep(1);
        $startoftoday = shezar_date_parse_from_format(get_string('datepickerlongyearparseformat', 'shezar_core'),
    ...
    private function actions_stage_3() {
        ...
        // Run cron.
        ob_start();
        $certcron = new \shezar_certification\task\update_certification_task();
        $certcron->execute();
        $assignmentscron = new \shezar_program\task\user_assignments_task();
