 ...
 * vendor/bin/phpunit --verbose shezar_certification_certification_completion_testcase shezar/certification/tests/certification_completion_test.php
 */
class shezar_certification_certification_completion_testcase extends reportcache_advanced_testcase {
    ...
    public function test_certif_get_completion_form_errors() {
        ...
        $expectederrors = array(
            'timedue' => get_string('error:stateassigned-timedueunknown', 'shezar_certification'),
            'certif_path' => get_string('error:stateassigned-pathincorrect', 'shezar_certification')
        );
