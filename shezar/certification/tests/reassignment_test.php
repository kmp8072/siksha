 ...
 * vendor/bin/phpunit --verbose shezar_certification_recertdates_testcase shezar/certification/tests/recertdates_test.php
 */
class shezar_certification_reassignments_testcase extends reportcache_advanced_testcase {
    ...
    public function setUp() {
        ...
        $this->task = new \shezar_certification\task\update_certification_task();
