...
$string['cohortbugheading'] = 'There was a bug in shezar 2.4.8 - 2.4.12 which may have affected your
site. <a href="http://community.shezarlms.com/mod/forum/discuss.php?d=3407" target="_blank">More information about this issue.</a>';
...
$string['error:badruleonupgrade'] = 'Dynamic Audience "{$a}" contains criteria based on a user profile customfield of type textarea. This type of criteria is no longer supported in shezar 2.2 Audiences. You should check the rules for the "{$a}" Audience after the upgrade and make any necessary changes.';
...
$string['pluginname'] = 'shezar Audiences';
