...
M.shezar_goalcohort = M.shezar_goalcohort || {
    ...
    init_dialogs: function() {
        ...
        var ehandler = new shezarDialog_handler_goalcohorts();
        ...
        shezarDialogs['id_cohortsaddenrolled'] = new shezarDialog(
            ...
            {
                buttons: dbuttons,
                title: '<h2>' + M.util.get_string('choosecohort', 'shezar_hierarchy') + '</h2>'
            },
...
shezarDialog_handler_goalcohorts = function() {
    this.baseurl = '';
...
shezarDialog_handler_goalcohorts.prototype = new shezarDialog_handler_treeview_multiselect();
 ...
 */
shezarDialog_handler_goalcohorts.prototype._update = function(response) {
 ...
 */
shezarDialog_handler_goalcohorts.prototype.cohort_item_exists = function(itemid) {
 ...
 */
shezarDialog_handler_goalcohorts.prototype.check_table_hidden_status = function() {
 ...
 */
shezarDialog_handler_goalcohorts.prototype.add_cohort_delete_event_handlers = function() {
 ...
 */
shezarDialog_handler_goalcohorts.prototype.add_cohort_item = function(itemid) {
 ...
 */
shezarDialog_handler_goalcohorts.prototype.create_item = function(html) {
    var element = $(html);
 ...
 */
shezarDialog_handler_goalcohorts.prototype.remove_cohort_item = function(item) {
