...
M.shezar_coursecohort = M.shezar_coursecohort || {
    ...
    init_dialogs: function() {
        ...
        // Enrolled cohorts
        var ehandler = new shezarDialog_handler_coursecohorts();
        ...
        shezarDialogs['id_cohortsaddenrolled'] = new shezarDialog(
            'course-cohorts-enrolled-dialog',
            'id_cohortsaddenrolled',
            {
                buttons: dbuttons,
                title: '<h2>' + M.util.get_string('coursecohortsenrolled', 'shezar_cohort') + '</h2>'
            },
...
shezarDialog_handler_coursecohorts = function() {
    // Base url
    this.baseurl = '';
...
shezarDialog_handler_coursecohorts.prototype = new shezarDialog_handler_treeview_multiselect();
 ...
 * @return void
 */
shezarDialog_handler_coursecohorts.prototype._update = function(response) {
 ...
 **/
shezarDialog_handler_coursecohorts.prototype.cohort_item_exists = function(itemid) {
...
shezarDialog_handler_coursecohorts.prototype.check_table_hidden_status = function() {
...
shezarDialog_handler_coursecohorts.prototype.add_cohort_delete_event_handlers = function() {
 ...
 ** Adds an item
 **/
shezarDialog_handler_coursecohorts.prototype.add_cohort_item = function(itemid) {
 ...
 **/
shezarDialog_handler_coursecohorts.prototype.create_item = function(html) {
    var element = $(html);
...
shezarDialog_handler_coursecohorts.prototype.remove_cohort_item = function(item) {
