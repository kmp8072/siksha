...
require_once($CFG->dirroot.'/shezar/core/dialogs/dialog_content_certifications.class.php');
...
$assigned = shezar_cohort_get_associations($cohortid, $type, $value);
$selected = array();
...
switch ($type) {
    ...
    case COHORT_ASSN_ITEMTYPE_CERTIF:
        $dialog = new shezar_dialog_content_certifications($categoryid);
        break;
    default:
