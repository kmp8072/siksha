...
/**
 * This file defines the two shezar_dialog_content subclasses used in browselearning.php;
 ...
 * @access  public
 */
class shezar_dialog_content_cohort_courses extends shezar_dialog_content_courses {
    ...
    protected function _prepend_markup() {
        return display_dialog_selector(
            array(
                COHORT_ASSN_ITEMTYPE_COURSE => get_string('learningitemcourses', 'shezar_cohort'),
                COHORT_ASSN_ITEMTYPE_PROGRAM => get_string('learningitemprograms', 'shezar_cohort')
            ),
 ...
 * @access  public
 */
class shezar_dialog_content_cohort_programs extends shezar_dialog_content_programs {
