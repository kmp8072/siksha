...
M.shezar_cohortprogramcompletion = M.shezar_cohortprogramcompletion || {
    ...
    init: function(Y, args) {
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.shezar_cohortcompletion.init()-> jQuery dependency required for this module.');
        }

        /// the completion dialog definition
        shezarDialog_completion = function() {
            ...
            // Update the hidden inputs
                ...
                var url = M.cfg.wwwroot + '/shezar/cohort/dialog/updateprogramcompletion.php' +
            ...
            this.handler._container.on('click', '.fixeddate', function() {
                ...
                var completionevent = M.shezar_cohortprogramcompletion.config.COMPLETION_EVENT_NONE;
            ...
            this.handler._container.on('click', '.relativeeventtime', function() {
                ...
                else if (completioninstance == 0 && completionevent != M.shezar_cohortprogramcompletion.config.COMPLETION_EVENT_FIRST_LOGIN &&
                    completionevent != M.shezar_cohortprogramcompletion.config.COMPLETION_EVENT_ENROLLMENT_DATE) {
        ...
        /// Handler definition
        shezarDialog_completion_handler = function() {};
        ...
        shezarDialog_completion_handler.prototype.every_load = function() {
            ...
            $('.completiontime').datepicker({
                ...
                showOn: 'both',
                buttonImage: M.util.image_url('t/calendar', 'shezar_core'),
            ...
            if (typeof completionevent === 'undefined' ||
                completionevent == M.shezar_cohortprogramcompletion.config.COMPLETION_EVENT_NONE) {
                if (typeof completionevent === 'undefined' ||
                    completiontime != M.shezar_cohortprogramcompletion.config.COMPLETION_TIME_NOT_SET) {
        ...
        shezarDialog_completion_event = function() {
            ...
            var dbuttons = {};
            dbuttons[M.util.get_string('save','shezar_core')] = function() { self.save() }
            dbuttons[M.util.get_string('cancel','moodle')] = function() { handler._cancel() }
            ...
            {
                buttons: dbuttons,
                title: '<h2>' + M.util.get_string('chooseitem', 'shezar_program') + M.shezar_cohortprogramcompletion.config.selected_program + '</h2>'
            },
            ...
            $(document).on('change', '#eventtype', function() {
                if ($('#eventtype').val() != M.shezar_cohortprogramcompletion.config.COMPLETION_EVENT_FIRST_LOGIN &&
                    $('#eventtype').val() != M.shezar_cohortprogramcompletion.config.COMPLETION_EVENT_ENROLLMENT_DATE) {
                    $('#instance').val(0);
        ...
        $(document).on('click', '.completionlink', function(event){
            ...
            var dialog = shezarDialogs['completion'];
            ...
            dialog.cohortid = M.shezar_cohortprogramcompletion.config.cohortid;
            ...
            dialog.default_url = M.cfg.wwwroot + '/shezar/program/assignment/set_completion.php?programid=' + dialog.programid;
