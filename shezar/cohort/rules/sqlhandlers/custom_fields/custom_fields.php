 ...
 *
 * @author Murali Nair <murali.nair@shezarlms.com>
 * @package shezar_cohort
 */


require_once($CFG->dirroot . '/shezar/cohort/rules/sqlhandlers/custom_fields/operators.php');
require_once($CFG->dirroot . '/shezar/cohort/rules/sqlhandlers/custom_fields/persistence_metadata.php');
require_once($CFG->dirroot . '/shezar/cohort/rules/sqlhandlers/custom_fields/sql_fragment.php');
...
final class custom_fields {
     ...
     * Custom field types.
     *
     * Note: the existing shezar code hardcodes these values everywhere.
     */
