...
M.shezar_cohortruledelete = M.shezar_cohortruledelete || {
    ...
    init_deletelisteners: function() {
        ...
        $('#cohort-rules').on('click', 'a.ruledef-delete', function(e, postdeletecallback) {
            ...
            confirmed = confirm(M.util.get_string('deleteruleconfirm', 'shezar_cohort'));
            ...
            $.ajax({
                url: M.cfg.wwwroot + '/shezar/cohort/rules/ruledelete.php',
                type: "GET",
                data: ({
        ...
        $('#cohort-rules').on('click', 'a .ruleparam-delete', function(e, postdeletecallback) {
            ...
            confirmed = confirm(M.util.get_string('deleteruleparamconfirm', 'shezar_cohort'));
            ...
            $.ajax({
                url: M.cfg.wwwroot + '/shezar/cohort/rules/ruleparamdelete.php',
                type: "GET",
                data: ({
                    sesskey: M.cfg.sesskey,
