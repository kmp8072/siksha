 ...
 */
class shezar_cohort_position_profile_field_checkbox_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        for ($i = 0; $i < 10; $i++) {
            next($users);
            \shezar_job\job_assignment::create_default(key($users), array('positionid' => $this->pos->id));
        }
