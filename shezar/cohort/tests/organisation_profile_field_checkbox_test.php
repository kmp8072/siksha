 ...
 * Test audience rules.
 *
 * NOTE: the numbers are coming straight from shezar 2.7.2 which is the baseline for us,
 *       any changes in results need to be documented here.
 */
class shezar_cohort_organisation_profile_field_checkbox_testcase extends advanced_testcase {

    /**
     * @var shezar_cohort_generator The cohort data generator.
     */
    ...
    protected function setUp() {
        ...
        for ($i = 0; $i < 10; $i++) {
            next($users);
            \shezar_job\job_assignment::create_default(key($users), array('organisationid' => $this->org->id));
        }
