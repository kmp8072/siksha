 ...
 * @category test
 */
class shezar_cohort_generator extends component_generator_base {
    /**
    ...
    public function create_cohort_enrolment($record) {
        ...
        if (empty($record['cohortid'])) {
            throw new coding_exception('cohortid is required in shezar_cohort_generator::create_cohort_enrolment() $record');
        }
        ...
        if (empty($record['courseid'])) {
            throw new coding_exception('courseid is required in shezar_cohort_generator::create_cohort_enrolment() $record');
        }
    ...
    public function create_cohort_member($record) {
        ...
        if (empty($record['cohortid'])) {
            throw new coding_exception('cohortid is required in shezar_cohort_generator::create_cohort_member() $record');
        }

        if (empty($record['userid'])) {
            throw new coding_exception('userid is required in shezar_cohort_generator::create_cohort_member() $record');
        }
    ...
    public function create_cohort($record = null) {
        ...
        $record = (array) $record;
        $idnumber = shezar_cohort_next_automatic_id();
