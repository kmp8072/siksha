...
class shezar_cohort_organisation_type_menu_field_testcase
extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $this->cohorts = $generator->get_plugin_generator('shezar_cohort');

        $hierarchies = $generator->get_plugin_generator('shezar_hierarchy');
        ...
        for ($i = 1; $i <= $this->number_assigned; $i++) {
            ...
            \shezar_job\job_assignment::create_default($user->id, array('organisationid' => $org->id));
        }
