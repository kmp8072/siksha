 ...
 *
 * Notes:
 * - The numbers are coming straight from shezar 2.7.2 which is the baseline for
 ...
 */
class shezar_cohort_user_custom_profile_field_checkbox_testcase extends advanced_testcase {
