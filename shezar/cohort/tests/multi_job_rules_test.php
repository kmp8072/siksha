 ...
 *
 */
class shezar_cohort_multi_jobs_rules_testcase extends advanced_testcase {
    ...
    public function setUp() {
        ...
        $man3ja = \shezar_job\job_assignment::create_default($this->man3->id);
        ...
        for ($i = 1; $i <= self::TEST_POSITION_COUNT_MEMBERS; $i++) {
            ...
            \shezar_job\job_assignment::create(array(
