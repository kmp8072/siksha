...
class shezar_cohort_user_custom_profile_field_date_no_timezone_testcase extends advanced_testcase {
    ...
    public function test_update_dynamic_cohort_members() {
        ...
        $this->assertEmpty(shezar_get_members_cohort($audience1->id));
        ...
        $audiencemembers = shezar_get_members_cohort($audience1->id);
