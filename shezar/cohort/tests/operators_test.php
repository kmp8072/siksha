 ...
 * vendor/bin/phpunit shezar_cohort_operators_testcase
 *
 */
class shezar_cohort_operators_testcase extends reportcache_advanced_testcase {
    ...
    public function test_ruleset_operator() {
        ...
        $result = shezar_cohort_update_operator($audience->id, $rulsetid, COHORT_OPERATOR_TYPE_RULESET, COHORT_RULES_OP_OR);
    ...
    public function test_cohort_operator() {
        ...
        shezar_cohort_update_operator($this->cohort->id, $this->cohort->id, COHORT_OPERATOR_TYPE_COHORT, COHORT_RULES_OP_AND);
        ...
        shezar_cohort_update_operator($audience->id, $audience->id, COHORT_OPERATOR_TYPE_COHORT, COHORT_RULES_OP_OR);
