 ...
 * vendor/bin/phpunit shezar_cohort_position_custom_fields_test
 *
 */
class shezar_cohort_position_custom_fields_testcase extends advanced_testcase {
    ...
    public function setUp() {
        ...
        for ($i = 1; $i <= self::TEST_USER_COUNT_MEMBERS; $i++) {
            ...
            \shezar_job\job_assignment::create_default($user->id, array('positionid' => $this->pos1->id));
        }
        $this->assertSame(self::TEST_USER_COUNT_MEMBERS + 2, $DB->count_records('user'));

        // Set shezar_cohort generator.
        $this->cohort_generator = $generator->get_plugin_generator('shezar_cohort');
