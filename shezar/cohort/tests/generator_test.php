 ...
 */
class shezar_cohort_generator_testcase extends advanced_testcase {
    public function test_disable_enrol_plugin_enrolment() {
        $this->resetAfterTest();

        /** @var shezar_cohort_generator $generator */
        $generator = $this->getDataGenerator()->get_plugin_generator('shezar_cohort');
