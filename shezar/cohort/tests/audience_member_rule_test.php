 ...
 * vendor/bin/phpunit shezar_cohort_audience_member_rule_testcase
 *
 */
class shezar_cohort_audience_member_rule_testcase extends advanced_testcase {
    ...
    public function test_audience_member_sync_job($incohortparam, $cohortidsparam, $usercount, $membersmatched) {
        ...
        \shezar_cohort\task\sync_dynamic_cohort_task::sync_cohort($cohort3, null);
        ...
        $this->assertEmpty(get_config('shezar_cohort', 'lasthourlycron'));
    }
}
