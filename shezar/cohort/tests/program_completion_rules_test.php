 ...
 * vendor/bin/phpunit shezar_cohort_program_completion_rules_testcase
 *
 */
class shezar_cohort_program_completion_rules_testcase extends reportcache_advanced_testcase {
