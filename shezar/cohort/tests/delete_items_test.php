 ...
 * vendor/bin/phpunit shezar_cohort_delete_items_testcase shezar/cohort/tests/delete_items_test.php
 *
 */
class shezar_cohort_delete_items_testcase extends advanced_testcase {
    ...
    public function setUp() {
        ...
        \shezar_job\job_assignment::create_default($user1->id, array('positionid' => $this->pos1->id));
        \shezar_job\job_assignment::create_default($user2->id, array('positionid' => $this->pos1->id));
        \shezar_job\job_assignment::create_default($user3->id, array('positionid' => $this->pos2->id));
