...
/**
 * Event triggered when a rule is deleted.
 *
 * @author Maria Torres <maria.torres@shezarlms.com>
 * @package shezar_cohort
 */
class rule_deleted extends \core\event\base {
     ...
     *
     * @param   stdClass $instance Rule instance.
    ...
    public static function get_name() {
        return get_string('eventruledeleted', 'shezar_cohort');
    }
    ...
    public function get_description() {
        return "The rule {$this->objectid} was deleted from the cohort {$this->other['cohortid']}";
    }
