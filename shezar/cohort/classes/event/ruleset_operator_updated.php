...
/**
 * Event triggered when a ruleset operator is updated.
 *
 * @property-read array $other {
 * Extra information about the event.
 *
 * - cohortid The Cohort ID where the ruleset is going to be created
 * - value Membership setting between each rule in this rule set.
 * AND (members are in every rule) OR (members are in any rule)
 * }
 *
 * @author Maria Torres <maria.torres@shezarlms.com>
 * @package shezar_cohort
 */
class ruleset_operator_updated extends \core\event\base {
     ...
     *
     * @param   stdClass $instance Ruleset instance.
    ...
    public static function get_name() {
        return get_string('eventrulesetoperatorupdated', 'shezar_cohort');
    }
    ...
    public function get_description() {
        return "The ruleset operator {$this->objectid} for the cohort {$this->other['cohortid']} was updated.
