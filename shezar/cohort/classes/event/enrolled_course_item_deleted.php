...
/**
 * Event triggered when the a course has been deleted from the enrolled learning of a cohort.
 *
 * @property-read array $other {
 * Extra information about the event.
 *
 * - cohortid The Cohort ID where the course was as enrolled learning.
 * }
 *
 * @author Maria Torres <maria.torres@shezarlms.com>
 * @package shezar_cohort
 */
class enrolled_course_item_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcourseitemdeleted', 'shezar_cohort');
    }
