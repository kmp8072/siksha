...
/**
 * Event triggered when a rule is updated.
 *
...
class rule_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventruleupdated', 'shezar_cohort');
    }
    ...
    public function get_description() {
        return "The rule {$this->objectid} was updated. Cohort: {$this->other['cohortid']}";
    }
