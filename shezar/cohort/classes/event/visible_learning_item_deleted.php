...
/**
 * Event triggered when a learning item is deleted.
 *
 * @property-read array $other {
 * Extra information about the event.
 *
 * - cohortid The Cohort ID where the learning item was deleted.
 * }
 *
 * @author Maria Torres <maria.torres@shezarlms.com>
 * @package shezar_cohort
 */
class visible_learning_item_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventlearningitemdeleted', 'shezar_cohort');
    }
    ...
    public function get_description() {
        return "The learning item {$this->objectid} has been deleted from the cohort {$this->other['cohortid']}";
    }
