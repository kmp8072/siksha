...
/**
 * Event triggered when a ruleset is deleted.
 *
 * @property-read array $other {
 * Extra information about the event.
 *
 * - cohortid The Cohort ID where the ruleset was.
 * }
 *
 * @author Maria Torres <maria.torres@shezarlms.com>
 * @package shezar_cohort
 */
class ruleset_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventrulesetdeleted', 'shezar_cohort');
    }
    ...
    public function get_description() {
        return "The ruleset {$this->objectid} was deleted from the cohort {$this->other['cohortid']}";
    }
    ...
    public function get_url() {
        return new \moodle_url('/shezar/cohort/rules.php', array('id' => $this->other['cohortid']));
    }
