...
/**
 * Event triggered when a rule has been created.
 *
 * @property-read array $other {
 * Extra information about the event.
 *
 * - cohortid The Cohort ID where the rule lives in.
 * }
 *
 * @author Maria Torres <maria.torres@shezarlms.com>
 * @package shezar_cohort
...
class rule_created extends \core\event\base {
    ...
    protected function init() {
        $this->data['objecttable'] = 'cohort_rules';
        $this->data['crud'] = 'c';
    ...
    public static function get_name() {
        return get_string('eventrulecreated', 'shezar_cohort');
    }
    ...
    public function get_description() {
        return "The rule {$this->objectid} was created in the cohort {$this->other['cohortid']}.";
    }
