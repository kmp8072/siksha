...
/**
 * Event triggered when the a course has been added as enrolled learning.
 *
 * @property-read array $other {
 * Extra information about the event.
 *
 * - cohortid The Cohort ID where the course was added
 * }
 *
 * @author Maria Torres <maria.torres@shezarlms.com>
 * @package shezar_cohort
 */
class enrolled_course_item_added extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcourseitemadded', 'shezar_cohort');
    }
