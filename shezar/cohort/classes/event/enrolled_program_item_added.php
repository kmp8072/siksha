...
/**
 * Event triggered when the a program has been added as enrolled learning.
 *
 * @property-read array $other {
 * Extra information about the event.
 *
 * - cohortid The Cohort ID where the program was added
 * }
 *
 * @author Maria Torres <maria.torres@shezarlms.com>
 * @package shezar_cohort
 */
class enrolled_program_item_added extends \core\event\base {
     ...
     * @return  enrolled_program_item_added
     */
    ...
    public static function get_name() {
        return get_string('eventprogramitemadded', 'shezar_cohort');
    }
    ...
    public function get_description() {
        return "The program {$this->objectid} has been added to the cohort {$this->other['cohortid']}";
    }
