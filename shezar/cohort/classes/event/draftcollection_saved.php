...
/**
 * Event triggered when the draft rules in a cohort has been saved.
 *
 ...
 * @package shezar_cohort
 */
class draftcollection_saved extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventdraftsaved', 'shezar_cohort');
    }
    ...
    public function get_description() {
        return "The draft rules for the cohort {$this->objectid} were saved by user {$this->userid}.";
    }
    ...
    public function get_url() {
        return new \moodle_url('/shezar/cohort/rules.php', array('id' => $this->objectid));
    }
