...
class update_cohort_task extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('updatecohortstask', 'shezar_cohort');
    }
    ...
    public function execute() {
        ...
        shezar_cohort_check_and_update_dynamic_cohort_members(null, $trace);

        $trace->output(date("H:i:s", time()).' Sending queued cohort notifications...');
        shezar_cohort_send_queued_notifications();
