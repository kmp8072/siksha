...
/**
 * Event triggered when an appraisal is updated.
 *
 ...
 * @package shezar_appraisal
 */
class appraisal_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventupdatedappraisal', 'shezar_appraisal');
    }
    ...
    public function get_description() {
        return "The appraisal {$this->objectid} was updated";
    }
    ...
    public function get_url() {
        return new \moodle_url('/shezar/appraisal/general.php', array('id' => $this->objectid));
    }
    ...
    public function get_legacy_logdata() {
        ...
        $logdata[] = SITEID;
        $logdata[] = 'appraisal';
        $logdata[] = 'update appraisal';
        $logdata[] = new \moodle_url('/shezar/appraisal/general.php', array('id' => $this->objectid));
        $logdata[] = "General Settings: Appraisal ID={$this->objectid}";
