...
/**
 * Event triggered when an appraisal_stage is created.
 *
...
class stage_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcreatedstage', 'shezar_appraisal');
    }
    ...
    public function get_description() {
        return "The appraisal stage {$this->objectid} was created";
    }
