...
class appraisal_stage_completion extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventstagecompleted', 'shezar_appraisal');
    }
    ...
    public function get_url() {
        return new \moodle_url('/shezar/appraisal/myappraisal.php', array('appraisalid' => $this->objectid, 'subjectid' => $this->userid));
    }
