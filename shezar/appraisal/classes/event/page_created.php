...
/**
 * Event triggered when an appraisal page is created.
 *
...
class page_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcreatedpage', 'shezar_appraisal');
    }
    ...
    public function get_description() {
        return "The appraisal page {$this->objectid} was created";
    }
