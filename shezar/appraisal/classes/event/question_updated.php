...
/**
 * Event triggered when an appraisal question is updated.
 *
...
class question_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventupdatedquestion', 'shezar_appraisal');
    }
    ...
    public function get_description() {
        return "The appraisal question {$this->objectid} was updated";
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url('/shezar/appraisal/stage.php', $urlparams, $anchor);
    }
