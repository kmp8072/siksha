...
$capabilities = array(
    ...
    'shezar/appraisal:manageappraisals' => array(
    ...
    'shezar/appraisal:cloneappraisal' => array(
    'riskbitmask'   => RISK_PERSONAL | RISK_DATALOSS | RISK_CONFIG,
        'captype' => 'write',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => array(
    ...
    'shezar/appraisal:assignappraisaltogroup' => array(
    'riskbitmask'   => RISK_PERSONAL | RISK_DATALOSS | RISK_CONFIG,
        'captype' => 'write',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => array(
    ...
    'shezar/appraisal:viewassignedusers' => array(
    ...
    'shezar/appraisal:managenotifications' => array(
    ...
    'shezar/appraisal:manageactivation' => array(
    'riskbitmask'   => RISK_SPAM | RISK_PERSONAL | RISK_DATALOSS | RISK_CONFIG,
        'captype' => 'write',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => array(
    ...
    'shezar/appraisal:managepageelements' => array(
    ...
    'shezar/appraisal:printstaffappraisals' => array(
    'riskbitmask'   => RISK_PERSONAL,
        'captype' => 'read',
    ...
    'shezar/appraisal:viewownappraisals' => array(
    'riskbitmask'   => RISK_PERSONAL,
        'captype' => 'read',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => array(
    ...
    'shezar/appraisal:printownappraisals' => array(
    'riskbitmask'   => RISK_PERSONAL,
        'captype' => 'read',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => array(
