 ...
 *
 * Unit tests for appraisal class of shezar/appraisal/lib.php
 */
global $CFG;
...
class appraisal_test extends appraisal_testcase {
    ...
    public function test_appraisal_activate() {
        ...
        $assign2 = new shezar_assign_appraisal('appraisal', $appraisal1);
    ...
    public function test_active_appraisal_add_group () {
        ...
        $assign = new shezar_assign_appraisal('appraisal', $appraisal);
    ...
    public function test_active_appraisal_role_removal() {
        ...
        $teamleadja = \shezar_job\job_assignment::create_default($teamlead->id);
        $managerja = \shezar_job\job_assignment::create_default(
            $manager->id,
            [
        ...
        $user1ja = \shezar_job\job_assignment::create_default($user1->id, $jobassignmentmanagers);
        $user2ja = \shezar_job\job_assignment::create_default($user2->id, $jobassignmentmanagers);
    ...
    public function test_active_appraisal_role_reassignment() {
        ...
        $teamlead1ja = \shezar_job\job_assignment::create_default($teamlead1->id);
        $teamlead2ja = \shezar_job\job_assignment::create_default($teamlead2->id);

        $manager1ja = \shezar_job\job_assignment::create_default(
            $manager1->id,
            [
                'managerjaid' => $teamlead1ja->id
            ]
        );
        $manager2ja = \shezar_job\job_assignment::create_default(
            $manager2->id,
            [
        ...
        $user1ja = \shezar_job\job_assignment::create_default(
            $user1->id,
            [
        ...
        $user2ja = \shezar_job\job_assignment::create_default(
            $user2->id,
            [
    ...
    public function test_cleanup_task() {
        ...
        $task = new \shezar_appraisal\task\cleanup_task();
        $task->execute();
