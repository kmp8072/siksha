...
class shezar_appraisal_generator_testcase extends advanced_testcase {

    /** @var shezar_appraisal_generator $appraisalgenerator */
    ...
    public function setUp() {
        ...
        $this->appraisalgenerator = $this->getDataGenerator()->get_plugin_generator('shezar_appraisal');
    ...
    public function test_assign_users_appraisal() {
        ...
        /** @var shezar_cohort_generator $cohortgenerator */
        $cohortgenerator = $this->getDataGenerator()->get_plugin_generator('shezar_cohort');
