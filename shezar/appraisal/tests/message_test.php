 ...
 *
 * Unit tests for appraisal_message class of shezar/appraisal/lib.php
 *
 * To test, run this from the command line from the $CFG->dirroot
 * vendor/bin/phpunit --verbose appraisal_message_test shezar/appraisal/tests/message_test.php
 */
global $CFG;
...
class appraisal_message_test extends appraisal_testcase {
    ...
    public function test_process_event() {
        ...
        shezar_appraisal_observer::send_scheduled($maxactivationtime);
        ...
        shezar_appraisal_observer::send_scheduled($maxactivationtime + DAYSECS);
        ...
        shezar_appraisal_observer::send_scheduled($maxactivationtime + DAYSECS * 3);
