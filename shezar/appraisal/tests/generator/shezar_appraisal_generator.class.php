 ...
 * Appraisal generator.
 *
 * @package shezar_appaisal
 * @category test
 */
class shezar_appraisal_generator extends component_generator_base {
    ...
    public function create_group_assignment($appraisal, $grouptype, $instanceid) {
        ...
        $grouptypes = shezar_assign_appraisal::get_assignable_grouptypes();
            ...
            foreach ($data->roles as $role) {
                switch ($role) {
                    case appraisal::ROLE_LEARNER:
                        $for_suffix = ' for ' . get_string('rolelearner', 'shezar_appraisal');
                        break;
                    case appraisal::ROLE_MANAGER:
                        $for_suffix = ' for ' . get_string('rolemanager', 'shezar_appraisal');
                        break;
