...
$url = new moodle_url('/shezar/appraisal/detailreport.php', array('format' => $format, 'debug' => $debug));
...
if (!$appraisalid) {
    echo $OUTPUT->header();
    $overviewurl = new moodle_url('/shezar/appraisal/reports.php');
...
$heading = get_string('detailreportforx', 'shezar_appraisal', $appraisal->name);
