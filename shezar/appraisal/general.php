...
if ($fromform = $mform->get_data()) {
    ...
    if ($id < 0) {
        shezar_set_notification(get_string('appraisalcreated', 'shezar_appraisal'), $returnurl, array('class' => 'notifysuccess'));
    } else {
        $stageurl = new moodle_url('/shezar/appraisal/stage.php', array('appraisalid' => $appraisal->id));
        shezar_set_notification(get_string('appraisalupdated', 'shezar_appraisal'), $stageurl, array('class' => 'notifysuccess'));
    }
}
...
if ($appraisal->id) {
    ...
    echo $output->heading(get_string('createappraisalheading', 'shezar_appraisal'));
}
