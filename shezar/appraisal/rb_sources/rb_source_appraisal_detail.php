...
class rb_source_appraisal_detail extends rb_source_appraisal {
    ...
    public function is_ignored() {
        return !shezar_feature_visible('appraisals');
    }
    ...
    public function post_params(reportbuilder $report) {
        ...
        $this->set_redirect(new moodle_url('/shezar/appraisal/rb_sources/appraisaldetailselector.php',
                array('detailreportid' => $report->_id)),
                get_string('selectappraisal', 'shezar_appraisal'));
    ...
    public function rb_cols_generator_totals($columnoption, $hidden) {
        ...
        $rolename = get_string($columnoption->type, 'shezar_appraisal');
    ...
    private function get_columns_for_question($question, $columnoption, $hidden, $includesummary = true) {
        ...
        $rolename = get_string($role, 'shezar_appraisal');
        $a = new stdClass();
                    ...
                    new rb_join(
                        ...
                        "(SELECT f.itemid AS appraisalroleassignmentid, " . sql_group_concat($file) . " AS files " .
                          ...
                          "WHERE f.contextid = {$FILEPICKER_OPTIONS['context']->id} " .
                            "AND f.component = 'shezar_appraisal' " .
    ...
    public function get_required_jss() {
        ...
        $jsdetails->initcall = 'M.shezar_reportbuilder_verticaltableheadings.init';
        $jsdetails->jsmodule = array('name' => 'shezar_reportbuilder_verticaltableheadings',
            'fullpath' => '/shezar/reportbuilder/js/verticaltableheadings.js');
