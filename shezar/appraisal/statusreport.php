...
$url = new moodle_url('/shezar/appraisal/statusreport.php', array('format' => $format, 'debug' => $debug));
...
$heading = get_string('statusreportforx', 'shezar_appraisal', $appraisal->name);
