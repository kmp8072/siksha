        ...
        */
        ...
        stagesSelectDialog: function() {
            ...
            handler._print = function(e, printurl) {
                ...
                var popupdata = {
                    name: 'printpopup',
                    url: mdlcfg.wwwroot + '/shezar/appraisal/snapshot.php' + '?' + urlparam,
            ...
            var requiredstrings = [];
            requiredstrings.push({key: 'printnow', component: 'shezar_appraisal'});
            requiredstrings.push({key: 'cancel', component: 'moodle'});
            requiredstrings.push({key: 'printyourappraisal', component: 'shezar_appraisal'});
            mdlstrings.get_strings(requiredstrings).done(function(strings) {
                ...
                buttonObj[tstr.printnow] = function(e) {
                    handler._print(e, mdlcfg.wwwroot + '/shezar/appraisal/snapshot.php' + '?' + urlparamstrselect);
                };
                buttonObj[tstr.cancel] = function() { handler._cancel(); };

                shezarDialogs.print = new shezarDialog(
                    'print',
                    'show-print-dialog',
                    {
                        buttons: buttonObj,
                    ...
                    mdlcfg.wwwroot + '/shezar/appraisal/snapshot.php' + '?' + urlparamstrselect,
                    handler
                );
            });
        },
        ...
        savePdfDialog: function() {
            ...
            handler._open = function() {
                handler._dialog.dialog.html(mdlstrings.get_string('snapshotgeneration', 'shezar_appraisal'));
            };
            ...
            var requiredstrings = [];
            requiredstrings.push({key: 'downloadnow', component: 'shezar_appraisal'});
            requiredstrings.push({key: 'cancel', component: 'moodle'});
            requiredstrings.push({key: 'snapshotdialogtitle', component: 'shezar_appraisal'});
            mdlstrings.get_strings(requiredstrings).done(function(strings) {
                var tstr = [];
                for (var i = 0; i < requiredstrings.length; i++) {
                    tstr[requiredstrings[i].key] = strings[i];
                ...
                shezarDialogs.savepdf = new shezarDialog(
                    'savepdf',
                    'show-savepdf-dialog',
                    {
                        buttons: buttonObj,
                    ...
                    mdlcfg.wwwroot + '/shezar/appraisal/snapshot.php' + '?' + urlparamstrpdf,
                    handler
                );
            });
        },
        ...
        keepAlive: function() {
            $.get(mdlcfg.wwwroot + '/shezar/appraisal/keepalive.php');
        }
    };
    return myappraisal;
});
