...
$string['clienturl_help'] = 'URL of the shezar Connect Client system.';
$string['cohorts'] = 'Synchronised audiences';
$string['cohortsadd'] = 'Add audience';
$string['comment'] = 'Comment';
$string['connect:manage'] = 'Manage the shezar Connect server and connecting clients';
$string['courses'] = 'Synchronised courses';
$string['coursesadd'] = 'Add course';
$string['enableconnectserver'] = 'Enable shezar Connect server';
$string['enableconnectserver_desc'] = 'shezar Connect is a single-sign-on and user identity solution for multiple shezar servers.';
$string['errorclientadd'] = 'Error registering new client';
$string['errorduplicateclient'] = 'Client with this URL is already active.';
$string['errorhttpclient'] = 'For security reasons all shezar Connect clients should be hosted via a secure protocol (https).';
$string['errorhttpserver'] = 'For security reasons shezar Connect servers should be hosted via a secure protocol (https).';
$string['pluginname'] = 'shezar Connect server';
...
$string['server'] = 'shezar Connect server';
