 ...
 * add cohorts to a shezar Connect clients.
 */

M.shezar_connect_cohort = M.shezar_connect_cohort || {
    Y: null,
    selected: null,
    instanceid: null,
    ...
    init: function(Y, selected, instanceid) {
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.shezar_connect_cohort.init()-> jQuery dependency required for this module.');
        }
    ...
    init_dialogs: function() {
        ...
        // Enrolled cohorts.
        var ehandler = new shezarDialog_handler_connectcohorts();
        ...
        shezarDialogs['id_cohortsadd'] = new shezarDialog(
            'shezar-connect-cohorts-dialog',
            'id_cohortsadd',
            {
                buttons: dbuttons,
                title: '<h2>' + M.util.get_string('cohorts', 'shezar_connect') + '</h2>'
            },
 ...
 */
shezarDialog_handler_connectcohorts = function() {
    // Base url.
    this.baseurl = '';
    ...
    this.cohort_table = $('#shezar-connect-cohorts-table');
...
shezarDialog_handler_connectcohorts.prototype = new shezarDialog_handler_treeview_multiselect();
 ...
 * @return void
 */
shezarDialog_handler_connectcohorts.prototype._update = function() {
    ...
    if (newids.length > 0) {
        ...
        var ajax_url = M.cfg.wwwroot + '/shezar/connect/dialog/cohort_item.php?itemid=' + newids.join(',') + params;
 ...
 */
shezarDialog_handler_connectcohorts.prototype.cohort_item_exists = function(itemid) {
...
shezarDialog_handler_connectcohorts.prototype.check_table_hidden_status = function() {
...
shezarDialog_handler_connectcohorts.prototype.add_cohort_delete_event_handlers = function() {
 ...
 * Adds an item
 */
shezarDialog_handler_connectcohorts.prototype.add_cohort_item = function(itemid) {
 ...
 */
shezarDialog_handler_connectcohorts.prototype.create_item = function(html) {
    var element = $(html);
...
shezarDialog_handler_connectcohorts.prototype.remove_cohort_item = function(item) {
