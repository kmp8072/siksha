...
class rb_source_connect_clients extends rb_base_source {
    ...
    public function __construct() {
        $this->usedcomponents[] = 'shezar_connect';
        $this->base = '{shezar_connect_clients}';
    ...
    protected function define_columnoptions() {
        ...
        $columnoptions[] = new rb_column_option(
            'connect_clients',
            'cohorts',
            get_string('cohorts', 'shezar_connect'),
            '(SELECT COUNT(1) FROM {shezar_connect_client_cohorts} WHERE clientid = base.id)',
            array(
                'outputformat' => 'text',
        ...
        $columnoptions[] = new rb_column_option(
            'connect_clients',
            'courses',
            get_string('courses', 'shezar_connect'),
            '(SELECT COUNT(1) FROM {shezar_connect_client_courses} WHERE clientid = base.id)',
            array(
                'outputformat' => 'text',
                'extrafields' => array('client_id' => "base.id"),
        ...
        $columnoptions[] = new rb_column_option(
            'connect_clients',
            'timecreated',
            get_string('timecreated', 'shezar_connect'),
            'base.timecreated',
            array(
        ...
        $columnoptions[] = new rb_column_option(
            'connect_clients',
            'timemodified',
            get_string('timemodified', 'shezar_connect'),
            'base.timemodified',
            array(
                'displayfunc' => 'nice_datetime',
                'dbdatatype' => 'timestamp',
        ...
        $columnoptions[] = new rb_column_option(
            'connect_clients',
            'clientcomment',
            get_string('comment', 'shezar_connect'),
            'base.clientcomment',
            array(
                'dbdatatype' => 'text',
                'outputformat' => 'text',
