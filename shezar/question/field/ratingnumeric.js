...
M.shezar_question_ratingnumeric = M.shezar_question_ratingnumeric || {
  Y : null,
  ...
  init : function(Y, args) {
    ...
    if ( typeof $ === 'undefined') {
      throw new Error('M.shezar_question_ratingnumeric.init()-> jQuery dependency required for this module to function.');
    }
