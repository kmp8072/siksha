...
class question_userinfo extends question_base{
    ...
    public function __construct($storage, $subjectid = 0, $answerid = 0) {
        ...
        $this->info_fields = array(
            ...
            'profile_managername' => get_string('managernames', 'shezar_question'),
            'profile_position' => get_string('positions', 'shezar_question'),
            'profile_organisation' => get_string('organisations', 'shezar_question')
        );
    ...
    public static function get_info() {
        return array('group' => question_manager::GROUP_OTHER,
                     'type' => get_string('questiontypeuserinfo', 'shezar_question'));
    }
    ...
    protected function define_validate($data, $files) {
        ...
        if (!$atleastone) {
            $err['errorplaceholder'] = get_string('error:userinfoatleastone', 'shezar_question');
        }
    ...
    protected function add_field_specific_settings_elements(MoodleQuickForm $form, $readonly, $moduleinfo) {
        ...
        $form->addElement('header', 'infoheader', get_string('infotodisplay', 'shezar_question') . $requiredstr);
