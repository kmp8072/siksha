...
global $CFG;
require_once($CFG->dirroot.'/shezar/question/tests/question_testcase.php');
require_once($CFG->dirroot.'/shezar/question/field/text.class.php');

class question_storage_test extends shezar_question_testcase {
