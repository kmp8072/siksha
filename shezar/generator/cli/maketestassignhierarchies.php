...
\$ sudo -u www-data php shezar/generator/cli/maketestassignhierarchies.php --name=SIZE_S --size=S
";
...
$backend = new shezar_generator_hierarchy_backend('competency', $size, $name, $fixeddataset, $filesizelimit, empty($options['quiet']));
