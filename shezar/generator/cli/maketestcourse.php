...
\$ sudo -u www-data php shezar/generator/cli/maketestcourse.php --shortname=SIZE_S --size=S
";
...
$backend = new shezar_generator_course_backend($name, $size, $fixeddataset, $filesizelimit, empty($options['quiet']));
$id = $backend->make();
