...
\$ sudo -u www-data php shezar/generator/cli/maketestlearningplan.php --name=SIZE_S --size=S
";
...
$backend = new shezar_generator_learning_plan_backend($size, $name, $fixeddataset, $filesizelimit, empty($options['quiet']));
$id = $backend->make();
