...
\$ sudo -u www-data php shezar/generator/cli/maketestsite.php --size=S
";
...
// Check size.
$size = shezar_generator_site_backend::size_for_name($sizename);

// Do backend code to generate site.
$backend = new shezar_generator_site_backend($size, $options['bypasscheck'], $fixeddataset, $filesizelimit, empty($options['quiet']));
if ($userpassword) {
