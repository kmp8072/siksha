...
class shezar_generator_appraisal_backend extends tool_generator_backend {
    ...
    /**
     * @var shezar_appraisal_generator $appraisal_generator.
     */
    ...
    protected function set_custom_generators() {
        ...
        $this->appraisal_generator = $this->generator->get_plugin_generator('shezar_appraisal');
    ...
    protected function create_appraisal() {
        ...
        $default_name = ($this->name) ? $this->name : shezar_appraisal_generator::DEFAULT_NAME;

        // Create the name we want to use.
        $default_name = trim($default_name) . ' ' . shezar_generator_util::get_size_name($this->size);
        $default_name = $default_name . ' ' . shezar_generator_util::get_next_record_number('appraisal', 'name', $default_name);
     ...
     * Public because it is used by @see shezar_core_courses_jmeter
     *
