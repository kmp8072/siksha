...
class shezar_generator_course_backend extends tool_generator_course_backend {
    ...
    private function create_course() {
        ...
        $fullname = trim($fullname). ' ' . shezar_generator_util::get_size_name($this->size);
        $shortname = shezar_generator_util::create_short_name($fullname);

        // Make sure the names are unique.
        $fullname = $fullname . ' ' . shezar_generator_util::get_next_record_number('course', 'fullname', $fullname);
        $shortname = $shortname . ' ' . shezar_generator_util::get_next_record_number('course', 'shortname', $shortname);
        ...
        $record['category'] = shezar_generator_util::get_random_record_id('course_categories', true);
