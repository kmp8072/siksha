...
class shezar_generator_course_category_backend extends tool_generator_backend {
    ...
    protected function create_course_category() {
        ...
        $default_name = $default_name . ' ' . shezar_generator_util::get_next_record_number('course_categories','name',$default_name);
