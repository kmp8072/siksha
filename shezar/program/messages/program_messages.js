 ...
 * @subpackage program
 */
M.shezar_programmessages = M.shezar_programmessages || {
    ...
    init: function(Y, args){
        ...
        if (!this.config.id) {
            throw new Error('M.shezar_programmessages.init()-> Required config \'id\' not available.');
        }

        // check jQuery dependency and continue with setup
        if (typeof $ === 'undefined') {
            throw new Error('M.shezar_programmessages.init()-> jQuery dependency required for this module to function.');
        }
        ...
        this.shezarDialog_savechanges = function() {
            ...
            buttonsObj[M.util.get_string('editmessages', 'shezar_program')] = function() { handler._cancel() };
            ...
            {
                buttons: buttonsObj,
                title: '<h2>'+ M.util.get_string('confirmmessagechanges', 'shezar_program') +'</h2>'
            },
    ...
    handleSaveChanges: function(){
        ...
        dialog.open(M.util.get_string('tosavemessages', 'shezar_program'));
