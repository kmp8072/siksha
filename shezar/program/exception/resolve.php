...
if (count($failed_ids) == 0) {
    shezar_set_notification(get_string('successfullyresolvedexceptions', 'shezar_program'), null, array('class' => 'notifysuccess'));
}
else {
    shezar_set_notification(get_string('failedtoresolve', 'shezar_program') . ': ' . implode(', ', $failed_ids));
}
