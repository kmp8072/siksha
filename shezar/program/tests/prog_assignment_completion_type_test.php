 ...
 * vendor/bin/phpunit shezar_program_prog_assignment_completion_type_testcase shezar/program/tests/prog_assignment_completion_type_test.php
 *
 */
class shezar_program_prog_assignment_completion_type_testcase extends reportcache_advanced_testcase {
    ...
    public function test_prog_assignment_completion_type_subclasses() {
        ...
        $this->positiongenerator = $this->getDataGenerator()->get_plugin_generator('shezar_hierarchy');
        ...
        \shezar_job\job_assignment::get_first($this->users[3]->id)->update(array('positionid' => $this->positions[2]->id));
        \shezar_job\job_assignment::get_first($this->users[4]->id)->update(array('positionid' => $this->positions[2]->id));
        \shezar_job\job_assignment::get_first($this->users[5]->id)->update(array('positionid' => $this->positions[3]->id));
        ...
        \shezar_job\job_assignment::get_first($this->users[6]->id)->update(
            array('positionid' => $this->positions[1]->id, 'startdate' => $this->dates[6]));
        \shezar_job\job_assignment::get_first($this->users[7]->id)->update(
            array('positionid' => $this->positions[1]->id, 'startdate' => $this->dates[7]));
        \shezar_job\job_assignment::get_first($this->users[8]->id)->update(
