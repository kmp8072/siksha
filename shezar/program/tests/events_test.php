 ...
 * vendor/bin/phpunit shezar_program_events_testcase
 *
 */
class shezar_program_events_testcase extends advanced_testcase {
    ...
    public function test_program_contentupdated() {
        ...
        $event = \shezar_program\event\program_contentupdated::create_from_data($dataevent);
        $event->trigger();
    ...
    public function test_program_updated() {
        ...
        $other = array('certifid' => empty($this->program->certifid) ? 0 : $this->program->certifid);
        $dataevent = array('id' => $this->program->id, 'other' => $other);
        $event = \shezar_program\event\program_updated::create_from_data($dataevent);
        $event->trigger();
    ...
    public function test_program_viewed() {
        ...
        $dataevent = array('id' => $this->program->id, 'other' => $other);
        $event = \shezar_program\event\program_viewed::create_from_data($dataevent);
        $event->trigger();
    ...
    public function test_bulk_learner_assignments() {
        ...
        $event = \shezar_program\event\bulk_learner_assignments_started::create_from_data(array('other' => $other));
        $event->trigger();
    ...
    public function test_bulk_future_assignments() {
        ...
        $other = array('programid' => $this->program->id, 'assignmentid' => $assign->id);
        $event = \shezar_program\event\bulk_future_assignments_started::create_from_data(array('other' => $other));
        $event->trigger();
    ...
    public function test_update_messages() {
        ...
        $event = \shezar_program\event\update_messages::create_from_instance($this->program);
        $event->trigger();
