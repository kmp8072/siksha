 ...
 * vendor/bin/phpunit --verbose shezar_program_program_completion_testcase shezar/program/tests/program_completion_test.php
 */
class shezar_program_program_completion_testcase extends reportcache_advanced_testcase {
    ...
    public function test_prog_get_completion_form_errors() {
        ...
        $expectederrors = array(
            'timedue' => get_string('error:timedueunknown', 'shezar_program'),
            'timecompleted' => get_string('error:stateincomplete-timecompletednotempty', 'shezar_program')
        );
