 ...
 * @subpackage program
 */
M.shezar_programedit = M.shezar_programedit || {
    ...
    init: function(Y, args){
        ...
        if (!this.config.id) {
            throw new Error('M.shezar_programedit.init()-> Required config \'id\' not available.');
        }

        // check jQuery dependency and continue with setup
        if (typeof $ === 'undefined') {
            throw new Error('M.shezar_programedit.init()-> jQuery dependency required for this module to function.');
        }
