...
class prog_edit_completion_form extends moodleform {
    ...
    public function definition() {
        ...
        $progstatusoptions[-1] = get_string('error:stateinvalid', 'shezar_program');
        ...
        $mform->addElement('select', 'status',
            get_string('completionprogstatus', 'shezar_program'), $progstatusoptions);
        $mform->addHelpButton('status', 'completionprogstatus', 'shezar_program');
    ...
    public function definition() {
        ...
        if (empty($history)) {
            $mform->addElement('html',
                ...
                get_string('userhasnocompletionhistory', 'shezar_program') .
            ...
            foreach ($history as $record) {
                $editurl = new moodle_url('/shezar/program/edit_completion_history.php',
                ...
                $deleteurl = new moodle_url('/shezar/program/edit_completion.php',
        ...
        if (empty($transactions)) {
            $mform->addElement('html',
                html_writer::start_tag('p') .
                get_string('transactionuserhasnone', 'shezar_program') .
                html_writer::end_tag('p')
            );
        } else {
            $mform->addElement('html',
