...
class rb_source_program_completion extends rb_base_source {
    ...
    public function is_ignored() {
        return !shezar_feature_visible('programs');
    }
    ...
    protected function define_columnoptions() {
        ...
        $this->add_program_fields_to_columns($columnoptions, 'program', "shezar_{$this->instancetype}");
    ...
    protected function define_filteroptions() {
        ...
        $filteroptions[] = new rb_filter_option(
            ...
            array (
                'selectchoices' => array(
                    0 => get_string('incomplete', 'shezar_program'),
                    1 => get_string('complete', 'shezar_program'),
                ),
        ...
        $this->add_program_fields_to_filters($filteroptions, "shezar_{$this->instancetype}");
        $this->add_cohort_user_fields_to_filters($filteroptions);
        $this->add_cohort_program_fields_to_filters($filteroptions, "shezar_{$this->instancetype}");
    ...
    function rb_display_program_completion_status($status, $row) {
        ...
        if ($status) {
            ...
            return get_string('incomplete', 'shezar_program');
        }
    }
