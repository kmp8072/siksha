...
class rb_source_program_membership extends rb_base_source {
    ...
    public function rb_filter_status() {
        $out = array();
        $out[STATUS_PROGRAM_INCOMPLETE] = get_string('incomplete', 'shezar_program');
        $out[STATUS_PROGRAM_COMPLETE] = get_string('complete', 'shezar_program');
    ...
    public function rb_display_edit_completion($id, $row, $isexport) {
        ...
        $url = new moodle_url('/shezar/program/edit_completion.php',
