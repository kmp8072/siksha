...
class completecourse_form extends moodleform {
    public function definition() {
        ...
        $mform->addElement('date_selector', 'timecompleted', get_string('datecompleted', 'shezar_program'));

        $mform->addElement('text', 'rplgrade', get_string('rplgrade', 'shezar_program'));
        $mform->setType('rplgrade', PARAM_FLOAT);
        $mform->addRule('rplgrade', null, 'numeric', null, 'client');

        $mform->addElement('text', 'rpl', get_string('rplcomments', 'shezar_program'));
