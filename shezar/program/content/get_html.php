...
if ($htmltype == 'multicourseset') { // if a new mulitcourse set is being added
    ...
    $newcourseset->label = get_string('legend:courseset', 'shezar_program', $sortorder);
    ...
    $newcourseset->islastset = true;
    $newcourseset->label = get_string('legend:recurringcourseset', 'shezar_program');
    ...
    if ($nojs) {
        ...
        $returnurl = new moodle_url('/shezar/program/edit_content.php', array('id' => $id));
        redirect($returnurl);
    } else {
