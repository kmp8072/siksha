...
$capabilities = array(
    ...
    // View a program
    'shezar/program:viewprogram' => array(
        'captype' => 'read',
    ...
    'shezar/program:viewhiddenprograms' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_PROGRAM,
        'archetypes' => array(
    ...
    'shezar/program:accessanyprogram' => array(
    ...
    // Create new programs
    'shezar/program:createprogram' => array(
    ...
    // Delete programs
    'shezar/program:deleteprogram' => array(
        ...
        'clonepermissionsfrom' => 'shezar/program:createprogram'
    ),
    ...
    'shezar/program:configuredetails' => array(
    ...
    'shezar/program:configurecontent' => array(
        'riskbitmask' => RISK_DATALOSS |
            RISK_CONFIG,
        'captype' => 'write',
        'contextlevel' => CONTEXT_PROGRAM,
    ...
    'shezar/program:configureassignments' => array(
        'riskbitmask' => RISK_DATALOSS |
            RISK_CONFIG,
        'captype' => 'write',
        'contextlevel' => CONTEXT_PROGRAM,
    ...
    'shezar/program:configuremessages' => array(
        'riskbitmask' => RISK_DATALOSS |
            RISK_CONFIG,
        'captype' => 'write',
        'contextlevel' => CONTEXT_PROGRAM,
    ...
    'shezar/program:handleexceptions' => array(
        'riskbitmask' => RISK_DATALOSS |
            RISK_CONFIG,
        'captype' => 'write',
        'contextlevel' => CONTEXT_PROGRAM,
    ...
    'shezar/program:visibility' => array(
    ...
    'shezar/program:markstaffcoursecomplete' => array(
    ...
    'shezar/program:editcompletion' => array(
        'riskbitmask' => RISK_DATALOSS | RISK_PERSONAL,
        'captype' => 'write',
        'contextlevel' => CONTEXT_PROGRAM,
    ),
