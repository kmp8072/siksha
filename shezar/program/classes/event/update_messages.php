...
class update_messages extends \core\event\base {
     ...
     * @return  \shezar_program\event\update_messages $event
     */
    ...
    public static function get_name() {
        return get_string('eventmessagesupdated', 'shezar_program');
    }
    ...
    public function get_url() {
        return new \moodle_url('/shezar/program/edit_messages.php', array('id' => $this->objectid));
    }
