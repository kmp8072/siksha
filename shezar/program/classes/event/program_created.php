...
class program_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcreated', 'shezar_program');
    }
    ...
    public function get_description() {
        return "This program {$this->objectid} was created by user {$this->userid}";
    }
    ...
    public function get_url() {
        return new \moodle_url('/shezar/program/edit.php', array('id' => $this->objectid));
    }
    ...
    protected function get_legacy_logdata() {
        return array(SITEID, 'program', 'created', 'edit.php?id=' . $this->objectid, 'ID: ' . $this->objectid);
    }
