...
class program_completed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcompletion', 'shezar_program');
    }
    ...
    public function get_description() {
        return "This program {$this->objectid} was activated by user {$this->userid}";
    }
    ...
    public function get_url() {
        return new \moodle_url('/shezar/program/activation.php', array('id' => $this->objectid, 'action' => 'activate'));
    }
    ...
    protected function get_legacy_logdata() {
        return array(SITEID, 'program', 'activated', 'activation.php?id=' . $this->objectid, 'ID: ' . $this->objectid);
    }
