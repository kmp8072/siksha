...
class program_viewed extends \core\event\base {
     ...
     * @return  \shezar_program\event\program_viewed $event
     */
    ...
    public static function get_name() {
        return get_string('eventviewed', 'shezar_program');
    }
    ...
    public function get_url() {
        switch ($this->other['section']) {
            case "general":
                $url = new \moodle_url('/shezar/program/view.php', array('id' => $this->objectid));
                break;
            case "required":
                $url = new \moodle_url('/shezar/program/required.php', array('id' => $this->objectid, 'userid' => $this->userid));
                break;
            case "content":
                $url = new \moodle_url('/shezar/program/edit_content.php', array('id' => $this->objectid));
                break;
            case "assignments":
                $url = new \moodle_url('/shezar/program/edit_assignments.php', array('id' => $this->objectid));
                break;
            case "messages":
                $url = new \moodle_url('/shezar/program/edit_messages.php', array('id' => $this->objectid));
                break;
            case "exceptions":
                $url = new \moodle_url('/shezar/program/exceptions.php', array('id' => $this->objectid));
                break;
            default:
                $url = new \moodle_url('/shezar/program/view.php', array('id' => $this->objectid));
                break;
