...
class program_unassigned extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventunassigned', 'shezar_program');
    }
    ...
    public function get_description() {
        return "The user {$this->userid} was unassigned from program {$this->objectid}";
    }
    ...
    protected function get_legacy_logdata() {
        return array(SITEID, 'program', 'unassigned', 'edit_assignments.php?id=' . $this->objectid, 'ID: ' . $this->objectid);
    }
