...
trait program_common {
    ...
    public function process_coursesets($coursesets) {
        ...
        foreach ($groups as $group) {
            /** @var \shezar_program\user_learning\courseset[] $group */
    ...
    public function get_courseset_courses($includeunavailable = true) {
        ...
        /** @var \shezar_certification\user_learning\courseset $courseset */
    ...
    public function ensure_duedate_loaded() {
        if ($this->duedate === null) {
            /** @var \shezar_certification\user_learning\item $this->certification */
