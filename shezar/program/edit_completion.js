 ...
 */
M.shezar_editprogcompletion = M.shezar_editprogcompletion || {
    ...
    init: function(Y, config){
        ...
        if ($('input[name="showinitialstateinvalid"]').val() == "1") {
            ...
            statuselement.after("&nbsp;" + M.util.get_string('bestguess', 'shezar_program', actualstatus));
        }

        this.updateFormState();

        $('#id_status').on('change', function(e) {
            M.shezar_editprogcompletion.updateFormState();
        });
