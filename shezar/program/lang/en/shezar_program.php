...
$string['enableprogramcompletioneditor_desc'] = 'When enabled, the Completion tab will be made available to users with the \'shezar/program:editcompletion\' capability when editing a program or certification. This will allow them to edit completion records, both historical and current.';
...
$string['error:progstatusinvalid'] = 'Program status for courseset 0 record must be STATUS_PROGRAM_INCOMPLETE or STATUS_PROGRAM_COMPLETE! This indicates a potentially major problem and should be reported to shezar support.';
...
$string['programcategory_help'] = 'Your shezar administrator may have set up several program/course categories.
...
$string['programidnumber_help'] = 'The ID number of a program is only used when matching this course against external systems - it is never displayed within shezar. If you have an official code name for this program then use it here ... otherwise you can leave it blank.';
