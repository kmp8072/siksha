...
require_capability('shezar/program:configureassignments', $program_context);
...
$selectedids = shezar_prog_removed_selected_ids($programid, $selected, $removed, ASSIGNTYPE_INDIVIDUAL);
