...
$selectedids = shezar_prog_removed_selected_ids($programid, $selected, $removed, ASSIGNTYPE_MANAGERJA);
...
foreach ($allselected as $manager) {
    ...
    $manager->fullname = shezar_job_display_user_job($manager, $job);
...
$dialog = new shezar_job_dialog_assign_manager(0, $managerid);
