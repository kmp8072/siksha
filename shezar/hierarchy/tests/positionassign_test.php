...
class positionassign_test extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $user1firstja = \shezar_job\job_assignment::create($data);
        ...
        $user2secondja = \shezar_job\job_assignment::create($data);
    ...
    public function test_assign_top_level_user() {
        ...
        $user1ja = \shezar_job\job_assignment::get_with_idnumber($this->user1->id, 'U1A1');
        $user2ja = \shezar_job\job_assignment::get_with_idnumber($this->user2->id, 'U2A1');
        $user3ja = \shezar_job\job_assignment::get_with_idnumber($this->user3->id, 'U3A1');
        $user5ja = \shezar_job\job_assignment::get_with_idnumber($this->user5->id, 'U5A1');
