 ...
 * vendor/bin/phpunit --verbose shezar_hierarchy_position_lib_testcase shezar/hierarchy/tests/position_lib_test.php
 */
...
class shezar_hierarchy_position_lib_testcase extends advanced_testcase {

    public function test_get_user_positions() {
        $this->resetAfterTest();

        $posgenerator = $this->getDataGenerator()->get_plugin_generator('shezar_hierarchy');
        ...
        $user1ja1 = \shezar_job\job_assignment::create_default($user1->id, array('positionid' => $pos1->id));
        $user1ja2 = \shezar_job\job_assignment::create_default($user1->id, array('positionid' => $pos3->id));
        $user2ja1 = \shezar_job\job_assignment::create_default($user2->id, array('positionid' => $pos4->id));
        $user2ja2 = \shezar_job\job_assignment::create_default($user2->id, array('positionid' => $pos1->id));
