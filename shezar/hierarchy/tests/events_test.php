...
class shezar_hierarchy_events_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $datagen = $this->getDataGenerator()->get_plugin_generator('shezar_hierarchy');
    ...
    public function test_framework_events() {
        ...
        $oldurl = "/shezar/hierarchy/framework/index.php?prefix=position&frameworkid={$this->pos_framework->id}";
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = "/shezar/hierarchy/framework/view.php?prefix=position&frameworkid={$this->pos_framework->id}";
        ...
        $legacydata = $event->get_legacy_logdata();
        $oldurl = '/shezar/hierarchy/framework/index.php?prefix=position';
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = "/shezar/hierarchy/framework/index.php?prefix=organisation&frameworkid={$this->org_framework->id}";
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = "/shezar/hierarchy/framework/view.php?prefix=organisation&frameworkid={$this->org_framework->id}";
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = '/shezar/hierarchy/framework/index.php?prefix=organisation';
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = "/shezar/hierarchy/framework/index.php?prefix=competency&frameworkid={$this->comp_framework->id}";
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = "/shezar/hierarchy/framework/view.php?prefix=competency&frameworkid={$this->comp_framework->id}";
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = '/shezar/hierarchy/framework/index.php?prefix=competency';
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = "/shezar/hierarchy/framework/index.php?prefix=goal&frameworkid={$this->goal_framework->id}";
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = "/shezar/hierarchy/framework/view.php?prefix=goal&frameworkid={$this->goal_framework->id}";
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = '/shezar/hierarchy/framework/index.php?prefix=goal';
        ...
        $event = \shezar_hierarchy\event\framework_viewed::create_from_prefix('position');
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = '/shezar/hierarchy/framework/index.php?prefix=position';
        ...
        $event = \shezar_hierarchy\event\framework_exported::create_from_instance('position', $this->pos_framework);
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = "/shezar/hierarchy/framework/index.php?id={$this->pos_framework->id}&prefix=position";
    ...
    public function test_type_events() {
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/type/index.php', array('prefix' => 'position'));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/type/edit.php', array('id' => $pos_type->id));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/item/edit.php', array('prefix' => 'position', 'id' => $type_changed['itemid']));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/type/index.php', array('prefix' => 'organisation'));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/type/edit.php', array('id' => $org_type->id));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/item/edit.php', array('prefix' => 'organisation', 'id' => $type_changed['itemid']));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/type/index.php', array('prefix' => 'competency'));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/type/edit.php', array('id' => $comp_type->id));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/item/edit.php', array('prefix' => 'competency', 'id' => $type_changed['itemid']));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/type/index.php', array('prefix' => 'goal'));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/type/edit.php', array('id' => $goal_type->id));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/item/edit.php', array('prefix' => 'goal', 'id' => $type_changed['itemid']));
        ...
        $event = \shezar_hierarchy\event\type_viewed::create_from_prefix('position');
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/type/index.php', array('prefix' => 'position'));
    ...
    public function test_item_events() {
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/item/view.php', array('id' => $this->pos->id, 'prefix' => 'position'));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/item/index.php', array('id' => $this->pos_framework->id, 'prefix' => 'position'));
        ...
        $oldurl = new moodle_url('/shezar/hierarchy/item/view.php', $urlparams);
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/item/view.php', array('id' => $this->org->id, 'prefix' => 'organisation'));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/item/index.php', array('id' => $this->org_framework->id, 'prefix' => 'organisation'));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/item/view.php', array('id' => $this->comp->id, 'prefix' => 'competency'));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/item/index.php', array('id' => $this->comp_framework->id, 'prefix' => 'competency'));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/item/view.php', array('id' => $this->goal->id, 'prefix' => 'goal'));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/item/index.php', array('id' => $this->goal_framework->id, 'prefix' => 'goal'));
    ...
    public function test_scale_events() {
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/prefix/competency/scale/view.php', array('id' => $comp_scale->id, 'prefix' => 'competency'));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/framework/index.php', array('id' => $comp_scale->id, 'prefix' => 'competency'));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/prefix/goal/scale/view.php', array('id' => $goal_scale->id, 'prefix' => 'goal'));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/framework/index.php', array('id' => $goal_scale->id, 'prefix' => 'goal'));
    ...
    public function test_competency_assigned_events() {
        ...
        $legacydata = $event->get_legacy_logdata();
        $oldurl = "/shezar/hierarchy/item/view.php?id={$this->pos->id}&prefix=position";
        ...
        $legacydata = $event->get_legacy_logdata();
        $oldurl = "/shezar/hierarchy/item/view.php?id={$this->org->id}&prefix=organisation";
    ...
    public function test_evidence_legacyevents() {
        ...
        $legacydata = $event->get_legacy_logdata();
        $oldurl = "/shezar/hierarchy/item/view.php?id={$this->comp->id}&prefix=competency";
    ...
    public function test_goal_assignment_events() {
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/prefix/goal/mygoals.php', array('userid' => $eventdata->userid));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/item/view.php', array('prefix' => 'position', 'id' => $eventdata->posid));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/item/view.php', array('prefix' => 'organisation', 'id' => $eventdata->orgid));
        ...
        $event->trigger();
        $legacydata = $event->get_legacy_logdata();
        $oldurl = new moodle_url('/shezar/hierarchy/item/view.php', array('id' => $eventdata->goalid, 'prefix' => 'goal'));
