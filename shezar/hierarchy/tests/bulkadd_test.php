    ...
    public function multiple_hierarchy_data_provider() {
        return array(
            ...
            array(
                '  Bad item',
                false,
                get_string('bulkaddparenterror', 'shezar_hierarchy', 'Bad item')
            ),
...
Item 5
  ...
  Item 2
    Item 3
        Item 4',
                false,
                get_string('bulkaddparenterror', 'shezar_hierarchy', 'Item 4')
            ),
            // Empty items string should give an error.
            array(
                '',
                false,
                get_string('bulkaddnoitems', 'shezar_hierarchy')
            )
        );
    }
