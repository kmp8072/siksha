 ...
 * triggered when a hierarchy item is created.
 *
 ...
 * @package shezar_hierarchy
 */
abstract class hierarchy_created extends \core\event\base {
    ...
    public function get_description() {
        ...
        return "The {$prefix}: {$this->objectid} was created";
    }
