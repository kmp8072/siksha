 ...
 * @package shezar_hierarchy
 */
abstract class type_updated extends \core\event\base {
    ...
    public function get_description() {
        ...
        return "The {$prefix} type {$this->objectid} was updated";
    }

    public function get_url() {
        $urlparams = array('id' => $this->objectid);
        return new \moodle_url('/shezar/hierarchy/type/edit.php', $urlparams);
    }
