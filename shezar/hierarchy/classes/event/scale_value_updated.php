 ...
 * triggered when a hierarchy scalevalue is updated.
 *
 ...
 * @package shezar_hierarchy
 */
abstract class scale_value_updated extends \core\event\base {
    ...
    public function get_description() {
        ...
        return "The scale value: {$this->objectid} was updated in {$prefix} scale {$this->data['other']['scaleid']}";
    }
