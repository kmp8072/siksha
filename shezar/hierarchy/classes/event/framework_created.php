 ...
 * triggered when a hierarchy framework is created.
 *
 ...
 * @package shezar_hierarchy
 */
abstract class framework_created extends \core\event\base {
    ...
    public function get_description() {
        ...
        return "The {$prefix} framework {$this->objectid} was created";
    }

    public function get_url() {
        $urlparams = array('prefix' => $this->get_prefix(), 'frameworkid' => $this->objectid);
        return new \moodle_url('/shezar/hierarchy/framework/index.php', $urlparams);
    }
