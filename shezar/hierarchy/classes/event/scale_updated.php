 ...
 * @package shezar_hierarchy
 */
abstract class scale_updated extends \core\event\base {
     ...
     *
     * @param   \stdClass $instance A hierarchy scale record.
    ...
    public function get_description() {
        ...
        return "The {$prefix} scale {$this->objectid} was updated";
    }

    public function get_url() {
        $prefix = $this->get_prefix();
        $urlparams = array('id' => $this->objectid, 'prefix' => $prefix);
        return new \moodle_url("/shezar/hierarchy/prefix/{$prefix}/scale/view.php", $urlparams);
    }
