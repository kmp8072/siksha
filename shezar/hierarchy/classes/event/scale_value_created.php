 ...
 * triggered when a hierarchy scalevalue is created.
 *
 * @property-read array $other {
 *      Extra information about the event.
 *
 *      - name  The name of the scalevalue
 * }
 *
 * @author David Curry <david.curry@shezarlms.com>
 * @package shezar_hierarchy
 */
abstract class scale_value_created extends \core\event\base {
    ...
    public function get_description() {
        ...
        return "The scale value: {$this->objectid} was added to {$prefix} scale {$this->data['other']['scaleid']}";
    }
    ...
    public function get_url() {
        ...
        $urlpath = "/shezar/hierarchy/prefix/{$prefix}/scale/view.php";
