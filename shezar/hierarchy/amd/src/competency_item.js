...
define(['jquery', 'core/config', 'core/str'], function ($, config, strings) {
    ...
    var loadItemDialogs = function(id, competencyuseresourcelevelevidence) {
        ...
        strings.get_string('assignrelatedcompetencies', 'shezar_hierarchy').done(function (assignrelatedcompetencies) {
            var url = config.wwwroot+'/shezar/hierarchy/prefix/competency/related/';
        ...
        if (typeof competencyuseresourcelevelevidence !== 'undefined' && competencyuseresourcelevelevidence) {
            ...
            shezarDialog_handler_assignEvidence.prototype._handle_course_click = function(courseid) {
                // Load course details
            ...
            var url = config.wwwroot + '/shezar/hierarchy/prefix/competency/evidenceitem/';
            ...
            requiredstrings.push({key: 'assigncoursecompletions', component: 'shezar_hierarchy'});
        ...
        if (typeof competencyuseresourcelevelevidence !== 'undefined' && competencyuseresourcelevelevidence) {
            ...
            var requiredstrings = [];
            requiredstrings.push({key: 'cancel', component: 'moodle'});
            requiredstrings.push({key: 'assignnewevidenceitem', component: 'shezar_hierarchy'});
    ...
    return {
        ...
        template: function (id) {
            ...
            templateinited.done(function () {
                var url = config.wwwroot+'/shezar/hierarchy/prefix/competency/template/';
