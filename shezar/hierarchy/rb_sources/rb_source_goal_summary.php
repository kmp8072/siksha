...
class rb_source_goal_summary extends rb_base_source {
    ...
    public function is_ignored() {
        return !shezar_feature_visible('goals');
    }
    ...
    public function post_params(reportbuilder $report) {
        ...
        $this->set_redirect(new moodle_url('/shezar/hierarchy/rb_sources/goalsummaryselector.php',
                array('summaryreportid' => $report->_id)),
                get_string('selectgoalframework', 'shezar_hierarchy'));
    ...
    public function rb_display_namesummarylink($name, $row, $isexport = false) {
        ...
        $url = new moodle_url('/shezar/hierarchy/prefix/goal/statusreport.php',
