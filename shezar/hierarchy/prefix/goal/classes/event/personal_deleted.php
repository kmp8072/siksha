...
/**
 * Triggered when a personal goal is deleted.
 *
 ...
 * @package shezar_hierarchy
 */
class personal_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string("eventdeletedpersonalgoal", "hierarchy_goal");
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url('/shezar/hierarchy/prefix/goal/mygoals.php', $urlparams);
    }
