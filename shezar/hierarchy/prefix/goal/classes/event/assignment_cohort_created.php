 ...
 * @package shezar_hierarchy
 */
class assignment_cohort_created extends \hierarchy_goal\event\assignment_created {
    /**
     * Returns type.
     * @return string
     */
    ...
    protected function init() {
        $this->data['objecttable'] = 'goal_grp_cohort';
        $this->data['crud'] = 'c';
        $this->data['edulevel'] = self::LEVEL_OTHER;
    }

    public function get_url() {
        return new \moodle_url('/cohort/view.php', array('id' => $this->data['other']['instanceid']));
    }
