...
M.shezar_assignindividual = M.shezar_assignindividual || {
     ...
     init: function(Y, args){
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.shezar_assignindividual.init()-> jQuery dependency required for this module to function.');
        }

        // Goals dialog.
        // Note: assigntype=1 is referring to GOAL_ASSIGNMENT_INDIVIUDAL.
        (function() {
            var assignto = M.shezar_assignindividual.config.id;
            var fid = M.shezar_assignindividual.config.frameworkid;
            ...
            $(shezarDialogs.assigngoaltreeview.dialog).bind('ajaxComplete', function(event) {
            ...
            $(document).on('click', '#show-assignedgoals-dialog', function(event) {
                ...
                // Open default url
                var select = $(this);
                var id = M.shezar_assignindividual.config.id;
                var sesskey = M.shezar_assignindividual.config.sesskey;
                ...
                dialog.showhide_url = M.shezar_assignindividual.config.showhide_url;
                dialog.showhide_text = M.shezar_assignindividual.config.showhide_text;
                dialog.showhide_id = M.shezar_assignindividual.config.id;
                dialog.open();
...
shezarDialog_handler_assigngoaltreeview.prototype._display_details = function () {
