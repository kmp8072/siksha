...
require_capability("shezar/hierarchy:managegoalassignments", $sitecontext);
...
$grouptypes = shezar_assign_goal::get_assignable_grouptypes();
...
$baseclass = new shezar_assign_goal($module, $item);
...
if ($add) {
    ...
    if (!empty($listofvalues) && $grouptypeobj->validate_item_selector($listofvalues)) {
        ...
        $output = $PAGE->get_renderer("shezar_hierarchy");
