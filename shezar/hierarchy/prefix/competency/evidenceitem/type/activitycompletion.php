...
class competency_evidence_type_activitycompletion extends competency_evidence_type {
    ...
    private function _get_module() {
        ...
        if (!$module) {
            print_error('loadmoduleinstance', 'shezar_hierarchy', array($a => $this->itemmodule, $b => $this->iteminstance));
        }
    ...
    public function cron() {
        ...
        if ($rs = $DB->get_recordset_sql($sql)) {
            foreach ($rs as $record) {
                ...
                require_once($CFG->dirroot . '/shezar/hierarchy/prefix/competency/evidenceitem/type/record.php');
