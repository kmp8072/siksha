...
comp_evitem_print_course_evitems($course, $competency_id, "{$CFG->wwwroot}/shezar/hierarchy/prefix/competency/evidenceitem/add.php?competency={$competency_id}&{$urlparams}" );
