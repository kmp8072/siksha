...
// Setup page
admin_externalpage_setup('competencymanage', '', array(), '/shezar/hierarchy/prefix/competency/template/assign_competency.php');
...
if (!$nojs) {
    ...
    $dialog = new shezar_dialog_content_hierarchy_multi('competency', $template->frameworkid);
    ...
    $out .= build_nojs_breadcrumbs($hierarchy,
        $parentid,
        '/shezar/hierarchy/prefix/competency/template/find_competency.php',
        array(
            'templateid' => $id,
            'returnurl' => $returnurl,
            's' => $s,
    ...
    $out .=build_nojs_treeview(
        ...
        '/shezar/hierarchy/prefix/competency/template/save_competency.php',
        array(
            's' => $s,
            'returnurl' => $returnurl,
            'nojs' => 1,
