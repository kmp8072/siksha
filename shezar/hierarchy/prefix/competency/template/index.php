...
$can_add = has_capability('shezar/hierarchy:create'.$hierarchy->prefix.'template', $sitecontext);
$can_edit = has_capability('shezar/hierarchy:update'.$hierarchy->prefix.'template', $sitecontext);
$can_delete = has_capability('shezar/hierarchy:delete'.$hierarchy->prefix.'template', $sitecontext);
