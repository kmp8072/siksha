 ...
 * @package shezar_hierarchy
 */
class competency_created extends \shezar_hierarchy\event\hierarchy_created {
    /**
    ...
    public static function get_name() {
        return get_string('eventcreateditem', 'hierarchy_competency');
    }
