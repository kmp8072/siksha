...
// Setup page
admin_externalpage_setup('competencymanage', '', array(), '/shezar/hierarchy/prefix/competency/evidence/add.php');
...
if (!$nojs) {
    ...
    $dialog = new shezar_dialog_content_hierarchy('competency', $frameworkid, $showhidden);
    ...
    if (empty($frameworkid) || $frameworkid == 0) {
        ...
        $out .= build_nojs_frameworkpicker(
            $hierarchy,
            '/shezar/hierarchy/prefix/competency/assign/find.php',
            array(
                'returnurl' => $returnurl,
                's' => $s,
                'nojs' => 1,
        ...
        $out .=  build_nojs_treeview(
            ...
            '/shezar/hierarchy/prefix/competency/assign/save.php',
            array(
                's' => $s,
                'returnurl' => $returnurl,
                'nojs' => 1,
