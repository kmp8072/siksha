...
// Setup page
admin_externalpage_setup('competencymanage', '', array(), '/shezar/hierarchy/prefix/competency/course/add.php');
...
if (!$nojs) {
    ...
    if (empty($frameworkid) || $frameworkid == 0) {
        ...
        $out .= build_nojs_frameworkpicker(
            $hierarchy,
            '/shezar/hierarchy/prefix/competency/course/add.php',
            array(
                'returnurl' => $returnurl,
                's' => $s,
                'nojs' => 1,
        ...
        $out .= build_nojs_treeview(
            ...
            '/shezar/hierarchy/prefix/competency/course/evidence.php',
            array(
                's' => $s,
                'returnurl' => $returnurl,
                'nojs' => 1,
