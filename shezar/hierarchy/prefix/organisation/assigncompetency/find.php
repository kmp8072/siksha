...
if (!$nojs) {
    ...
    if (empty($frameworkid) || $frameworkid == 0) {
        ...
        echo build_nojs_frameworkpicker(
            $hierarchy,
            '/shezar/hierarchy/prefix/organisation/assigncompetency/find.php',
            array(
                'returnurl' => $returnurl,
                's' => $s,
                'nojs' => 1,
        ...
        $out .= build_nojs_treeview(
            ...
            '/shezar/hierarchy/prefix/organisation/assigncompetency/assign.php',
            array(
                's' => $s,
                'returnurl' => $returnurl,
                'nojs' => 1,
            ...
            $CFG->wwwroot.'/shezar/hierarchy/prefix/organisation/assigncompetency/find.php',
            $urlparams,
