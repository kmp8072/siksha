...
/**
 * Triggered when a competency is unassigned
 *
 ...
 * @package shezar_hierarchy
 */
class competency_unassigned extends \shezar_hierarchy\event\competency_unassigned {
    /**
    ...
    protected function init() {
        $this->data['objecttable'] = 'org_competencies';
        $this->data['crud'] = 'd';
        $this->data['edulevel'] = self::LEVEL_OTHER;
    }

    public static function get_name() {
        return get_string('eventcompetencyunassigned', 'hierarchy_organisation');
    }
}
