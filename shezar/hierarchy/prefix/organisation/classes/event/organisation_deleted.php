 ...
 *
 *      - frameworkid   The id of the framework containing the item
 * }
 *
 * @author David Curry <david.curry@shezarlms.com>
 * @package shezar_hierarchy
 */
class organisation_deleted extends \shezar_hierarchy\event\hierarchy_deleted {
    /**
    ...
    public static function get_name() {
        return get_string('eventdeleteditem', 'hierarchy_organisation');
    }
}
