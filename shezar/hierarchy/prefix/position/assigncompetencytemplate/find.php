...
if (!$nojs) {
    ...
    if (empty($frameworkid) || $frameworkid == 0) {
        ...
        echo build_nojs_frameworkpicker(
            $hierarchy,
            '/shezar/hierarchy/prefix/position/assigncompetencytemplate/find.php',
            array(
                'returnurl' => $returnurl,
                's' => $s,
                'nojs' => 1,
        ...
        $out .= html_writer::tag('p', get_string('clicktoassigntemplate', 'shezar_hierarchy').' ');
        ...
        $out .= build_nojs_treeview(
            ...
            '/shezar/hierarchy/prefix/position/assigncompetencytemplate/assign.php',
            array(
                's' => $s,
                'returnurl' => $returnurl,
                'nojs' => 1,
