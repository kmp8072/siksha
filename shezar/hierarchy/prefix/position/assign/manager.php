...
error_log('shezar/hierarchy/prefix/position/assign/manager.php has been deprecated. Please update your code.');
...
if ($canedit || $manageronsignup) {
    ...
    $managers = $DB->get_records_sql($sql, $params, 0, shezar_DIALOG_MAXITEMS + 1);
}
