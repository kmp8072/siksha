...
error_log('shezar/hierarchy/prefix/position/assign/tempmanager.php has been deprecated. Please update your code.');
...
// Load potential managers for this user.
    ...
    $job_assignment = \shezar_job\job_assignment::get_first($userid);
