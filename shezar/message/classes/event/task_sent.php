...
namespace shezar_message\event;
 ...
 * @package shezar_message
 */
class task_sent extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventtasksent', 'shezar_message');
    }
    ...
    public function get_description() {
        ...
        if (\core_user::is_real_user($this->userid)) {
            $description  = "The user with id '{$this->userid}' sent a task of the type '{$this->other['msgtype']}'";
            $description .= " to the user with id '{$this->relateduserid}'.";

            return $description;
        }

        $description  = "A task of type '{$this->other['msgtype']}' was sent by the system";
        $description .= " to the user with id '{$this->relateduserid}'.";
     ...
     * @return \shezar_message\event\task_sent
     */
