 ...
 * @package    shezar_message
 */

defined('MOODLE_INTERNAL') || die();

/**
 * Test events in shezar message subpackage.
 *
 * To test, run this from the command line from the $CFG->dirroot
 * vendor/bin/phpunit shezar_message_events_testcase
 *
 */
class shezar_message_events_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $this->messagedata = (object)array(
            ...
            'sendemail'   => shezar_MSG_EMAIL_NO,
            'msgstatus'   => shezar_MSG_STATUS_OK,
            'urgency'     => shezar_MSG_URGENCY_NORMAL,
            'msgtype'     => shezar_MSG_TYPE_COURSE,
    ...
    protected function filter_events($type, $events) {
        ...
        $class = "shezar_message\\event\\{$type}_sent";
     ...
     * @param shezar_message\event\alert_sent|shezar_message\event\task_sent $event
     */
