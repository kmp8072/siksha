 ...
 */
/**
 * Classes to help in generating the $eventdata needed to send shezar messages
 */

defined('MOODLE_INTERNAL') || die();

/**
 * A basic shezar message
 */
...
/**
 * A shezar "task" (a message which prompts the user to make an accept/reject choice)
 */
...
/**
 * A shezar "alert" (message which requires no response)
 */
