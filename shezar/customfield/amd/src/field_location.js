...
define(['jquery'], function ($) {
    ...
    function Location(google, args) {
         ...
         * This is part of the Google maps API and comes from a setting in shezar.
         * @type {string}
         */
                ...
                if (response == 'success' && data.results.length > 0) {
                    ...
                    if ($('#fgroup_id_' + self.fieldprefix + 'mapelements .felement .alert').length === 0){
                        require(['core/templates', 'core/str'], function (templates, mdlstrings) {
                            mdlstrings.get_string('locationnotfound', 'shezar_customfield').done(function (notfound) {
    ...
    return {
        init: function (args) {
            require(['shezar_customfield/field_location_loader!'+args.mapparams], function() {
