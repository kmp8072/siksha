...
require_once($CFG->dirroot.'/shezar/customfield/lib.php');
...
/** @var shezar_customfield_renderer $renderer*/
$renderer = $PAGE->get_renderer('shezar_customfield');

// Set redirect.
$redirectoptions = $renderer->get_redirect_options($prefix, $id, $typeid, $class);
$redirectpage = '/shezar/customfield/index.php';
$redirect = new moodle_url('/shezar/customfield/index.php', $redirectoptions);
...
switch ($action) {
    case 'showlist':
        ...
        echo $renderer->shezar_customfield_print_list($fields, $can_manage, $options, $redirectpage, $redirectoptions);
        break;
    case 'movefield':
    ...
    case 'deletefield':
        ...
        echo $renderer->shezar_customfield_delete_confirmation($datacount, $redirectpage, $optionsyes, $redirectoptions);
        break;
    case 'editfield':
    ...
    default:
        echo $OUTPUT->header();
        echo $renderer->customfield_tabs_link($prefix, $redirectoptions);
        print_error('actiondoesnotexist', 'shezar_customfield');
        break;
}
