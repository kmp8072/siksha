...
/**
 * shezar customfield event handler.
 */
class shezar_customfield_observer {
    /**
     ...
     *
     * @param \shezar_program\event\program_deleted $event
     * @return bool true on success
     */
    public static function program_deleted(\shezar_program\event\program_deleted $event) {
        global $DB;
