...
class customfield_define_datetime extends customfield_define_base {
    ...
    function define_form_specific(&$form) {
        ...
        // Add elements
        $form->addElement('select', 'param1', get_string('startyear', 'shezar_customfield'), $arryears);
        $form->setType('param1', PARAM_INT);
        $form->setDefault('param1', $currentyear);

        $form->addElement('select', 'param2', get_string('endyear', 'shezar_customfield'), $arryears);
        $form->setType('param2', PARAM_INT);
        $form->setDefault('param2', $currentyear + 20);

        $form->addElement('checkbox', 'param3', get_string('wanttime', 'shezar_customfield'));
    ...
    function define_validate_specific($data, $files, $tableprefix) {
        ...
        if ($data->param1 > $data->param2) {
            $errors['param1'] = get_string('startyearafterend', 'shezar_customfield');
        }
