...
require_once($CFG->dirroot . '/shezar/customfield/field/text/field.class.php');
require_once($CFG->dirroot . '/shezar/customfield/field/text/define.class.php');
...
require_once($CFG->dirroot . '/shezar/customfield/field/file/define.class.php');
 ...
 * @category test
 */
class shezar_customfield_generator extends testing_data_generator {
    /**
