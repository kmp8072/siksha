 ...
 *
 * shezar_dashboard specific language strings.
 * these should be called like get_string('key', 'shezar_dashboard');
 */
...
$string['configenableshezardashboard'] = 'This option will let you: Enable(show)/Disable shezar Dashboard feature on this site.

* If Show is chosen, all links, menus, tabs and option related to shezar Dashboard will be accessible.
* If Disable is chosen, shezar Dashboard will disappear from any menu on the site and will not be accessible.
';
...
$string['enableshezardashboard'] = 'Enable shezar Dashboard';
...
$string['pluginname'] = 'shezar Dashboards';
...
$string['shezardashboarddisabled'] = 'shezar Dashboard is not enabled on this site';
