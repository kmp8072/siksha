...
if ($action === 'new') {
    ...
    if ($mform->is_cancelled()) {
        ...
        $result = \repository_opensesame\local\shezarlms_com::provision_tenant($data->tenantname, $data->tenanttype, $repositorykey, $data->tenantdemosecret);
    ...
    if ($mform->is_cancelled()) {
        ...
        $result = \repository_opensesame\local\shezarlms_com::remove_tenant($data->tenantid, $config->repositorykey);
