...
<p>The OpenSesame plugin in shezar allows you to easily register, browse the course catalogue and purchase an OpenSesame Plus subscription.
...
Any purchased courses will be downloaded to your shezar site as SCORM packages where you can either turn them into a single activity course with the click of a button or include them within an existing course.';
...
$string['errorcannotaccessshezarlms'] = 'Unable to connect to https://register.shezarlms.com, please make sure your server is able to access this site.';
