...
class opensesame_com {
    ...
    public static function provision_user($user) {
        ...
        $url = "https://www.opensesame.com/api/shezar/{$config->tenantid}/provision_user";
    ...
    public static function get_fetch_content_request($type) {
        ...
        $url = "https://www.opensesame.com/api/shezar/{$config->tenantid}/fetch_content";
    ...
    public static function get_catalogue_callback_url() {
        global $CFG;
        return $CFG->wwwroot . '/repository/opensesame/shezarcallback.php';
    }
