...
/**
 * Utility class for communication with shezar registration server.
 */
class shezarlms_com {
    /**
     * Register shezar server with OpenSesame.
     *
    ...
    public static function provision_tenant($tenantname, $tenanttype, $repositorykey, $tenantdemosecret) {
        ...
        $url = 'https://register.shezarlms.com/local/opensesameadmin/request/provison_tenant.php';
        ...
        if (!$result) {
            return array(
                'status' => 'error',
                'message' => get_string('errorcannotaccessshezarlms', 'repository_opensesame'),
            );
        }
    ...
    public static function remove_tenant($tenantid, $repositorykey) {
        $url = 'https://register.shezarlms.com/local/opensesameadmin/request/remove_tenant.php';
