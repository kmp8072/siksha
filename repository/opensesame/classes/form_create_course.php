...
class repository_opensesame_form_create_course extends moodleform {
    protected function definition() {
        global $CFG, $shezar_COURSE_TYPES;
        ...
        $mform->addElement('select', 'coursetype', get_string('coursetype', 'shezar_core'), $coursetypeoptions);
        ...
        shezar_add_icon_picker($mform, 'add', 'course', 'default', 0);
