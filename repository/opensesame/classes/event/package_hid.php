 ...
 */
class package_hid extends \core\event\base {
    /**
    ...
    public static function get_name() {
        return get_string('eventpackagehid', 'repository_opensesame');
    }
    ...
    public function get_description() {
        return "Course package '{$this->other['externalid']}'' visibility changed to hidden.";
    }
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call package_hid::create() directly, use package_hid::create_from_package() instead.');
        }
