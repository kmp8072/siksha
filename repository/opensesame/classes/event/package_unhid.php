 ...
 */
class package_unhid extends \core\event\base {
    /**
    ...
    public static function get_name() {
        return get_string('eventpackageunhid', 'repository_opensesame');
    }
    ...
    public function get_description() {
        return "Course package '{$this->other['externalid']}'' visibility changed to visible.";
    }
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call package_unhid::create() directly, use package_unhid::create_from_package() instead.');
        }
