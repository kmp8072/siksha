...
abstract class repository implements cacheable_object {
     ...
     *
     * shezar: It was a really bad idea to treat the reference as trusted url by default!
     *
    ...
    public function get_file($reference, $filename = '') {
        ...
        // shezar: Add-on repositories must be updated to override this method
        ...
        throw new moodle_exception('incompatiblerepository', 'shezar_core', '', $this->get_name());
    }

    /**
     * Downloads a file from url.
     *
     * shezar: use this from get_file() above after the creating validated $url from $reference.
     *
     * @see curl
     * @throws file_exception when error occured
     *
 ...
 *          accepted_types
 *          return_types
 * @param bool $returntemplates shezar: true means add templates to the return object instead of M.core_filepicker.set_templates
 *
