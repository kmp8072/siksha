...
$string['apiv1migration_message_content'] = 'As part of the recent shezar upgrade, the Box repository plugin has been disabled. To re-enable it, you need to re-configure it as described in the documentation {$a->docsurl}.';
...
$string['information'] = 'Get a client ID and secret from the <a href="https://app.box.com/developers/services">Box developer page</a> for your shezar site.';
