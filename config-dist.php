...
// 1. DATABASE SETUP
//=========================================================================
// First, you need to configure the database where all shezar data       //
...
$CFG->dbname    = 'shezar';     // database name, eg shezar
...
// 2. WEB SITE LOCATION
//=========================================================================
// Now you need to tell shezar where it is located. Specify the full
// web address to where shezar has been installed.  If your web site
...
$CFG->wwwroot   = 'http://example.com/shezar';


//=========================================================================
// 3. DATA FILES LOCATION
//=========================================================================
// Now you need a place where shezar can save uploaded files.  This
...
// created by shezar within the data directory.  The format is in
...
// standard location for the shezar admin pages.  You can work around this
// by renaming the admin directory in your installation, and putting that
// new name here.  eg "shezaradmin".  This should fix all admin links in shezar.
...
//=========================================================================
//
// These are additional tweaks for which no GUI exists in shezar yet.
//
...
//
// Change the key pair lifetime for shezar Networking
...
// off non-shezar standard characters in usernames.
...
// comment out one the following options to enable it in shezar:
...
//         '/cachedir/' => '/var/www/shezar/cache',    // for custom $CFG->cachedir locations
//         '/localcachedir/' => '/var/local/cache',    // for custom $CFG->localcachedir locations
//         '/tempdir/'  => '/var/www/shezar/temp',     // for custom $CFG->tempdir locations
//         '/filedir'   => '/var/www/shezar/filedir',  // for custom $CFG->filedir locations
//     );
//
...
//
// If this setting is set to true, then shezar will track the IP of the
...
//
// Enabling this will allow custom scripts to replace existing shezar scripts.
...
// Some examples are:
//      http://my.shezar.site/course/view.php
//      http://my.shezar.site/index.php
//      http://my.shezar.site/admin            (index.php implied)
// Custom scripts should not include config.php
// Warning: Replacing standard shezar scripts may pose security risks and/or may not
...
//
// Email database connection errors to someone.  If shezar cannot connect to the
...
//
//     $CFG->tempdir = '/var/www/shezar/temp';        // Directory MUST BE SHARED by all clsuter nodes.
//     $CFG->cachedir = '/var/www/shezar/cache';      // Directory MUST BE SHARED by all cluster nodes, locking required.
...
//
// When shezar is about to perform an intensive operation it raises PHP's memory
...
//
// shezar 2.4 introduced a new cache API.
// The cache API stores a configuration file within the shezar data directory and
...
// webserver.
//
//     $CFG->altcacheconfigpath = '/var/www/shared/shezar.cache.config.php
//
// The CSS files the shezar produces can be extremely large and complex, especially
// if you are using a custom theme that builds upon several other themes.
// In shezar 2.4 a CSS optimiser was added as an experimental feature for advanced
...
//
// As of version 2.4 shezar serves icons as SVG images if the users browser appears
// to support SVG.
...
//
// Use the following flag to set userid for noreply user. If not set then shezar will
// create dummy user and use -ve value as user id.
//      $CFG->noreplyuserid = -10;
//
// As of version 2.6 shezar supports admin to set support user. If not set, all mails
// will be sent to supportemail.
//      $CFG->supportuserid = -20;
//
// shezar 2.7 introduces a locking api for critical tasks (e.g. cron).
...
//
// shezar 2.9 allows administrators to customise the list of supported file types.
...
//
// Course completion logic changed in shezar 2.9 - failed activity completion
...
// to your config.php BEFORE upgrading to shezar 2.9
//
...
//
// Since shezar 2.2 sql queries are not shown during upgrade by default.
...
//
// shezar: Allow tasks to be scheduled to run on the next cron run using the
...
// 8b. shezar flavours
//=========================================================================
// shezar flavours implement feature restrictions and optimised setting defaults.
// A flavour can be forced by settings the following setting:
//
// Example:
//   $CFG->forceflavour = 'flavourname';
//
// Where the value is one of the directory names in /shezar/flavour/flavours/.
...
// upgrade or when admin confirms the triggers update in /shezar/flavour/view.php
//
...
//
// $CFG->behat_wwwroot = 'http://127.0.0.1/shezar';
// $CFG->behat_prefix = 'bht_';
// $CFG->behat_dataroot = '/home/example/bht_sitedata';
//
// You can override default shezar configuration for Behat and add your own
// params; here you can add more profiles, use different Mink drivers than Selenium...
// These params would be merged with the default shezar behat.yml, giving priority
...
//
// All this page's extra shezar settings are compared against a white list of allowed settings
...
//           'behat_wwwroot' => 'http://127.0.0.1/shezar',
...
// (Development->Profiling) built into shezar.
//      $CFG->pathtodot = '';
//
//=========================================================================
