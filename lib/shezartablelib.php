 ...
 */
class shezar_table extends flexible_table {
    ...
    */
    ...
    function wrap_html_start() {
        echo html_writer::start_tag('div', array('class' => 'shezar-table-container'));
    }
    ...
    /**
     * In shezar tables, we print the table anyway, just with a message
     ...
     * Setup the table
     *
     * Re-use parent class, but also add 'shezartable' class
     */
    function setup() {
        parent::setup();
        // Always introduce the "shezartable" class for the table if not specified
        if (empty($this->attributes)) {
            $this->attributes['class'] = 'shezartable';
        } else if (!isset($this->attributes['class'])) {
            $this->attributes['class'] = 'shezartable';
        } else if (!in_array('shezartable', explode(' ', $this->attributes['class']))) {
            $this->attributes['class'] = trim('shezartable ' . $this->attributes['class']);
        }
    }
}
