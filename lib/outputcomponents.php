...
class pix_icon implements renderable, templatable {
    ...
    public function __construct($pix, $alt, $component='moodle', array $attributes = null) {
        $this->pix        = ltrim($pix, '/'); // shezar: fix invalid pix names with leading slashes.
        $this->component  = $component;
 ...
 * not have children.
 *
 * This functionality has been deprecated - please use the shezar menu functionality instead
 *
