...
abstract class moodle_database {
    ...
    /**
     * shezar - For retrieving the maximum number of items that should be used in an SQL IN clause.
    ...
    protected function normalise_limit_from_num($limitfrom, $limitnum) {
        ...
        // shezar: this may be used from shutdown handler after $CFG is released, we need to prevent notices here!
    ...
    /**
     * shezar - Returns database specific SQL code similar to GROUP_CONCAT() behaviour from MySQL.
     *
