...
class phpunit_util extends testing_util {
    ...
    public static function reset_all_data($detectchanges = false) {
        ...
        global $ME, $SCRIPT; // shezar: fix global resets.
        ...
        // shezar specific resets.
        \shezar_core\hook\manager::phpunit_reset();
        if (class_exists('shezar_core\jsend', false)) {
            \shezar_core\jsend::set_phpunit_testdata(null);
        }
        session_id(''); // shezar Connect fakes the sid in tests.
    ...
    public static function install_site() {
        ...
        // Undo shezar changed defaults to allow upstream testing without hacks.
        ...
        $DB->delete_records('user_preferences', array()); // shezar admin site page default.
