...
/**
* shezar textarea options
*/

$shezar_maxbytes = get_max_upload_file_size();
$shezar_context = context_system::instance();
global $TEXTAREA_OPTIONS;
$TEXTAREA_OPTIONS = array(
        'subdirs' => 0,
        'maxfiles' => EDITOR_UNLIMITED_FILES,
        'maxbytes' => $shezar_maxbytes,
        'trusttext' => false,
        'context' => $shezar_context,
        'collapsed' => true
);
...
abstract class moodleform {
    ...
    public $_form; //shezar: changed to public var to allow dialogs to use mforms easily.
