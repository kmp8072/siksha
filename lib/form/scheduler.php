...
class MoodleQuickForm_scheduler extends MoodleQuickForm_group {
    ...
    function _createElements() {
        ...
        foreach (scheduler::get_options() as $option => $code) {
            $frequencyselect[$code] = get_string('schedule' . $option, 'shezar_core');
        }
        ...
        $this->_elements['frequency'] = @MoodleQuickForm::createElement('select', 'frequency', get_string('schedule', 'shezar_core'), $frequencyselect);
        $this->_elements['daily'] = @MoodleQuickForm::createElement('select', 'daily', get_string('dailyat', 'shezar_core'), $dailyselect);
        $this->_elements['weekly'] = @MoodleQuickForm::createElement('select', 'weekly', get_string('weeklyon', 'shezar_core'), $weeklyselect);
        $this->_elements['monthly'] = @MoodleQuickForm::createElement('select', 'monthly', get_string('monthlyon', 'shezar_core'), $monthlyselect);
        $this->_elements['hourly'] = @MoodleQuickForm::createElement('select', 'hourly', get_string('hourlyon', 'shezar_core'), $hourlyselect);
        $this->_elements['minutely'] = @MoodleQuickForm::createElement('select', 'minutely', get_string('minutelyon', 'shezar_core'), $minutelyselect);
