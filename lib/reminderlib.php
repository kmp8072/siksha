...
class reminder extends data_object {
    ...
    /**
     * shezar - delete reminder and related reminder data with course deletion.
     *
     * @access public
     * @return void
     */
...
function reminder_email_substitutions($content, $user, $course, $message, $reminder) {
    ...
    // Manager name
    $place[] = '[managername]';
    $subs[] = !empty($user->manager) ? fullname($user->manager) : get_string('nomanagermessage', 'shezar_coursecatalog');
...
/**
 * shezar - Remove all reminders and related reminder data
 *
