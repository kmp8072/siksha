...
if ($getpdf) {
    ...
    $doc->SetTitle('shezar PDF library test');
    $doc->SetAuthor('shezar ' . $shezar->release);
    $doc->SetCreator('lib/tests/other/pdflibtestpage.php');
    $doc->SetKeywords('shezar, PDF');
    $doc->SetSubject('This has been generated by shezar as its PDF library test page');
    $doc->SetMargins(15, 30);

    $doc->setPrintHeader(true);
    $doc->setHeaderMargin(10);
    $doc->setHeaderFont(array($fontfamily, 'b', 10));
    $doc->setHeaderData('shezar/core/pix/logo.png', 12, $SITE->fullname, $CFG->wwwroot);
    ...
    $doc->Cell(0, 0, 'shezar PDF library test', 0, 1, 'C', 1);
    ...
    $c .= 'shezar release: '            . $shezar->release . '<br />';
