...
class behat_forms extends behat_base {
    ...
    public function press_button($button) {
        // shezar: use alias to "I click on" because we need to wait for page to load.
     ...
     *
     * shezar: the select options must be exact match and containing field-set must be already expanded.
     *
