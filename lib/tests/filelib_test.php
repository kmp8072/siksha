...
Set-Cookie: BBC-UID=c4de2e109c8df6a51de627cee11b214bd4fb6054a030222488317afb31b343360shezarBot/1.0; expires=Mon, 07-Dec-15 14:44:53 GMT; path=/; domain=bbc.co.uk
X-Cache-Action: MISS
X-Cache-Age: 0
...
EOF;
    ...
    public function test_curl_useragent() {
        ...
        $this->assertTrue(in_array('User-Agent: shezarBot/1.0', $curl->header));
        ...
        $this->assertFalse(in_array('User-Agent: shezarBot/1.0', $curl->header));
