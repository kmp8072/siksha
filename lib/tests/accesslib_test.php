...
class core_accesslib_testcase extends advanced_testcase {
    ...
    public function test_get_all_roles() {
        ...
        $this->assertCount(9, $allroles); // there are 9 roles in standard shezar install
    ...
    public function test_get_role_archetypes() {
        ...
        $this->assertCount(10, $archetypes); // there are 9+1 archetypes in standard shezar install
    ...
    public function test_get_archetype_roles() {
        ...
        foreach ($archetypes as $archetype) {
            ...
            if ($archetype === 'assessor') {
                // shezar: Not installed by default any more.
    ...
    public function test_get_role_users() {
        ...
        // shezar: no debugging from MDL-22309 expected here!
