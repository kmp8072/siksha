...
class core_formslib_testcase extends advanced_testcase {
    ...
    // shezar TL-8057 - Ensure that all fields are contained in a div.fitem with an id, including static and frozen fields.
...
/**
 * shezar TL-8057 - Test form to be used by {@link formslib_test::test_rendering_fitem_ids()}.
 */
