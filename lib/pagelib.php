...
class moodle_page {
    ...
    /**
     * shezar specific Page variable
     */
    protected $_shezar_menu_selected = null;
    ...
    /**
     * Returns the shezar menu selected string
     * @return String shezar_menu_selected
     */
    protected function magic_get_shezar_menu_selected() {
        return $this->_shezar_menu_selected;
    }
     ...
     */
    public function set_shezar_menu_selected($menuitemname) {
        $this->_shezar_menu_selected = $menuitemname;
    }
    ...
    protected function resolve_theme() {
        ...
        foreach ($themeorder as $themetype) {
            ...
            switch ($themetype) {
                ...
                case 'shezarpdf':
                    // shezar: Enforce standardshezarresponsive theme in PDF outputs - standardshezar is not available any more.
                    return 'standardshezarresponsive';
                break;
                ...
                case 'default':
                    // shezar: allow forcing of system default theme (ignore any configuration).
                    return theme_config::DEFAULT_THEME;
                break;

                case 'device':
                    // shezar: allow forcing of device theme.
