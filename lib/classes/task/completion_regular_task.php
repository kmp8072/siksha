...
class completion_regular_task extends scheduled_task {
    ...
    public function execute() {
        ...
        if ($CFG->enablecompletion) {
            ...
            completion_start_user_bulk(); // shezar: Make sure that all course_completion records exist as required.
            // shezar - reaggregate the course_modules_completion records in case of
