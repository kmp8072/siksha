    ...
    public static function is_deleted_standard_plugin($type, $name) {
        ...
        $plugins = array(
            ...
            'theme' => array('mymobile', 'afterburner', 'anomaly', 'arialist', 'binarius', 'boxxie', 'brick', 'formal_white',
                ...
                // shezar uninstalled themes.
                , 'canvas', 'clean', 'more', 'customshezar', 'kiwifruit', 'standardshezar',
            ),
            // Other shezar leftovers and mistakes.
            'connect' => array('shezar'),
        );
    ...
    public static function standard_plugins_list($type) {
        ...
        $standard_plugins = array(
            ...
            'block' => array(
                ...
                // shezar
                ,'shezar_addtoplan', 'shezar_alerts',
                'shezar_my_learning_nav', 'shezar_my_team_nav', 'shezar_quicklinks',
                'shezar_recent_learning', 'shezar_report_graph', 'shezar_report_manager', 'shezar_stats',
                'shezar_tasks', 'shezar_certifications', 'gaccess', 'shezar_program_completion',
                'shezar_dashboard', 'shezar_report_table', 'last_course_accessed',
                'current_learning',
            ),
            ...
            'enrol' => array(
                ...
                'paypal', 'self'
                // shezar
                , 'shezar_learningplan', 'shezar_program', 'shezar_facetoface',
            ),
            ...
            // shezar: flavours allow enforcing of settings and changing of setting defaults.
            'flavour' => array(
                'enterprise',
            ),
            ...
            'theme' => array(
                'base', 'bootstrapbase'
                // shezar:
                , 'kiwifruitresponsive', 'standardshezarresponsive', 'customshezarresponsive', 'roots', 'basis',
            ),
            ...
            'tool' => array(
                ...
                // shezar:
                , 'shezar_sync', 'shezar_timezonefix'
            ),
