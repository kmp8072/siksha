...
class atto_texteditor extends texteditor {
    ...
    /**
     * Allow editor to customise template and init itself in shezar forms.
     *
     * @param array $result
     ...
     */
    public function shezar_form_use_editor(&$result, array $editoroptions, array $fpoptions, array $fptemplates) {
        global $PAGE;
        ...
        $result['form_item_template'] = 'shezar_form/element_editor_atto';
        ...
        $result['amdmodule'] = 'shezar_form/form_element_editor_atto';
    }
}
...
class atto_page_hack {
    ...
    public function __call($name , array $arguments) {
        debugging("shezar forms: Unexpected method call PAGE->xx->'$name'() in Atto init.", DEBUG_DEVELOPER);
    }
}
