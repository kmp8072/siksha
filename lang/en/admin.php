...
$string['configallowthemechangeonurl'] = 'If enabled, the theme can be changed by adding either:<br />?theme=themename to any shezar URL (eg: myshezarsite.com/?theme=afterburner ) or <br />&theme=themename to any internal shezar URL (eg: myshezarsite.com/course/view.php?id=2&theme=afterburner ).';
...
$string['configcustommenuitems'] = 'This is deprecated functionality and will not display in core themes (will be deleted in shezar 10.0). Please customise the main menu instead (Site adminsitration > Appearance > Main menu).<br/>
...
<pre>
shezar community|http://community.shezarlms.com
shezar support|http://support.shezarlms.com
shezar development|http://dev.shezarlms.com
-shezar help|http://help.shezarlms.com
shezar News|http://www.shezarlms.com/about-shezar/news
shezar Partners|http://www.shezarlms.com/partners
</pre>';
...
$string['configenablestats'] = 'If you choose \'yes\' here, shezar\'s cronjob will process the logs and gather some statistics.  Depending on the amount of traffic on your site, this can take awhile. If you enable this, you will be able to see some interesting graphs and statistics about each of your courses, or on a sitewide basis.';
$string['configenabletrusttext'] = 'By default shezar will always thoroughly clean text that comes from users to remove any possible bad scripts, media etc that could be a security risk.  The Trusted Content system is a way of giving particular users that you trust the ability to include these advanced features in their content without interference.  To enable this system, you need to first enable this setting, and then grant the Trusted Content permission to a specific shezar role.  Texts created or uploaded by such users will be marked as trusted and will not be cleaned before display.';
$string['configenablewebservices'] = 'Web services enable other systems to log in to this shezar and perform operations.  For extra security this feature should be disabled unless you are really using it.';
...
$string['configintro'] = 'On this page you can specify a number of configuration variables that help make shezar work properly on your server.  Don\'t worry too much about it - the defaults will usually work fine and you can always come back to this page later and change these settings.';
...
$string['configlangstringcache'] = 'Caches all the language strings into compiled files in the data directory.  If you are translating shezar or changing strings in the shezar source code then you may want to switch this off.  Otherwise leave it on to see performance benefits.';
$string['configlanglist'] = 'Leave this blank to allow users to choose from any language you have in this installation of shezar.  However, you can shorten the language menu by entering a comma-separated list of language codes that you want.  For example:  en,es_es,fr,it';
...
$string['configloginhttps'] = 'Turning this on will make shezar use a secure https connection just for the login page (providing a secure login), and then afterwards revert back to the normal http URL for general speed.  CAUTION: this setting REQUIRES https to be specifically enabled on the web server - if it is not then YOU COULD LOCK YOURSELF OUT OF YOUR SITE.';
...
$string['configmessaging'] = 'Should the messaging system between site users be enabled? (Note: shezar alerts and tasks depend on this)';
...
$string['configpasswordpolicy'] = 'Turning this on will make shezar check user passwords against a valid password policy. Use the settings below to specify your policy (they will be ignored if you set this to \'No\').';
...
$string['configrecaptchaprivatekey'] = 'String of characters (private key) used to communicate between your shezar server and the recaptcha server. Obtain one for this site by visiting http://www.google.com/recaptcha';
...
$string['configsecureforms'] = 'shezar can use an additional level of security when accepting data from web forms. If this is enabled, then the browser\'s HTTP_REFERER variable is checked against the current form address.  In a very few cases this can cause problems if the user is using a firewall (eg Zonealarm) configured to strip HTTP_REFERER from their web traffic.  Symptoms are getting \'stuck\' on a form. If your users are having problems with the login page (for example) you might want to disable this setting, although it might leave your site more open to brute-force password attacks.  If in doubt, leave this set to \'Yes\'.';
$string['configsessioncookie'] = 'This setting customises the name of the cookie used for shezar sessions.  This is optional, and only useful to avoid cookies being confused when there is more than one copy of shezar running within the same web site.';
$string['configsessioncookiedomain'] = 'This allows you to change the domain that the shezar cookies are available from. This is useful for shezar customisations (e.g. authentication or enrolment plugins) that need to share shezar session information with a web application on another subdomain. <strong>WARNING: it is strongly recommended to leave this setting at the default (empty) - an incorrect value will prevent all logins to the site.</strong>';
$string['configsessioncookiepath'] = 'If you need to change where browsers send the shezar cookies, you can change this setting to specify a subdirectory of your web site.  Otherwise the default \'/\' should be fine.';
...
$string['configslasharguments'] = '\'Slash arguments\' (using <em>PATH_INFO</em>) is required for SCORM packages and multiple-file resources to display correctly. If your web server doesn\'t support \'slash arguments\' and you are unable to configure it, this setting can be disabled, though it will result in things not working.<br />Note: The use of \'slash arguments\' will be required in future versions of shezar.';
$string['configsmartpix'] = 'With this on, icons are served through a PHP script that searches the current theme, then all parent themes, then the shezar /pix folder. This reduces the need to duplicate image files within themes, but has a slight performance cost.';
...
$string['configstatsruntimestart'] = 'What time should the cronjob that does the statistics processing start? Specifying different times is recommended if there are multiple shezar sites on one server.';
...
$string['cron'] = 'Cron';
$string['cron_help'] = 'The cron.php maintenance script assists some of shezar\'s modules to perform tasks on a scheduled basis, such as mailing out copies of new forum posts. A mechanism is required to run the script regularly e.g. every 5 minutes.';
...
$string['ctyperequired'] = 'The ctype PHP extension is now required by shezar, in order to improve site performance and to offer multilingual compatibility.';
$string['curlcache'] = 'cURL cache TTL';
$string['curlrequired'] = 'The cURL PHP extension is now required by shezar, in order to communicate with shezar repositories.';
...
$string['enablegravatar_help'] = 'When enabled shezar will attempt to fetch a user profile picture from Gravatar if the user has not uploaded an image.';
...
$string['environmenterrortodo'] = 'You must solve all the environmental problems (errors) found above before proceeding to install this shezar version!';
$string['environmenterrorupgrade'] = 'Warning: you should solve all the environmental problems (errors) found above before proceeding to upgrade this shezar version!  Upgrading without fixing these requirements could cause problems such as data loss.  Are you sure you want to continue with the upgrade?';
...
$string['fatalsessionautostart'] = '<p>Serious configuration error detected, please notify server administrator.</p><p> To operate properly, shezar requires that administrator changes PHP settings.</p><p><code>session.auto_start</code> must be set to <code>off</code>.</p><p>This setting is controlled by editing <code>php.ini</code>, Apache/IIS <br />configuration or <code>.htaccess</code> file on the server.</p>';
...
$string['gdrequired'] = 'The GD extension is now required by shezar for image conversion.';
...
$string['groupenrolmentkeypolicy_desc'] = 'Turning this on will make shezar check group enrolment keys against a valid password policy.';
$string['googlemapkey3'] = 'Google Maps JavaScript API key';
$string['googlemapkey3_help'] = 'If you use Google Map features within shezar we strongly recommend that you read and agree to the Google Maps JavaScript API Terms of Service and generate a Google Maps JavaScript API key for use within your site.
...
If you have purchased a Premium Plan then please put your Client ID into the API key setting, shezar will recognise this as Client ID and treat it as such.

shezar currently uses the Google Maps JavaScript API in the following locations:
...
$string['gravatardefaulturl_help'] = 'Gravatar needs a default image to display if it is unable to find a picture for a given user. Provide a full URL for an image. If you leave this setting empty, shezar will attempt to use the most appropriate default image for the page you are viewing. Note also that Gravatar has a number of codes which can be used to <a href="https://en.gravatar.com/site/implement/images/#default-image">generate default images</a>.';
...
$string['helpcalendarsettings'] = 'Configure various calendar and date/time-related aspects of shezar';
...
$string['iplookupinfo'] = 'By default shezar uses the free online NetGeo (The Internet Geographic Database) server to lookup location of IP addresses, unfortunately this database is not maintained anymore and may return <em>wildly incorrect</em> data.
...
$string['langpackwillbeupdated'] = 'NOTE: shezar will try to download updates for your language packs during the upgrade.';
...
$string['maturitycorewarning'] = 'The version of shezar that you are about to install or upgrade to contains
...
from a STABLE branch of the shezar code. See shezar Docs for more details.';
...
$string['moodleorghubname'] = 'shezar.net';
...
$string['mnetrestore_extusers'] = '<strong>Note:</strong> This backup file contains remote shezar Network user accounts which will be restored as part of the process.';
$string['mnetrestore_extusers_admin'] = '<strong>Note:</strong> This backup file seems to come from a different shezar installation and contains remote shezar Network user accounts. The restore process will try to match the shezar Network hosts for all created users. Those not matching will be automatically switched to internal authentication (instead of mnet one). The restore log will inform you about that.';
$string['mnetrestore_extusers_mismatch'] = '<strong>Note:</strong> This backup file apparently originates from a different shezar installation and contains remote shezar Network user accounts that may fail to restore. This operation is unsupported. If you are certain that it was created on this shezar installation, or you can ensure that all the needed shezar Network Hosts are configured, you may want to still try the restore.';
$string['mnetrestore_extusers_noadmin'] = '<strong>Note:</strong> This backup file seems to come from a different shezar installation and contains remote shezar Network user accounts. You are not allowed to execute this type of restore. Contact the administrator of the site or, alternatively, restore this course without any user information (modules, files...)';
$string['mnetrestore_extusers_switchuserauth'] = 'Remote shezar Network user {$a->username} (coming from {$a->mnethosturl}) switched to local {$a->auth} authenticated user.';
...
$string['nohttpsformobilewarning'] = 'It is recommended to enable HTTPS with a valid certificate. The shezar app will always try to use a secured connection first.';
...
$string['maxtimelimit_desc'] = 'To restrict the maximum PHP execution time that shezar will allow without any output being displayed, enter a value in seconds here. 0 means that shezar default restrictions are used. If you have a front-end server with its own time limit, set this value lower to receive PHP errors in logs. Does not apply to CLI scripts.';
...
$string['opensslrecommended'] = 'Installing the optional OpenSSL library is highly recommended -- it enables shezar Networking functionality.';
...
$string['pathtodot_help'] = 'Path to dot. Probably something like /usr/bin/dot. To be able to generate graphics from DOT files, you must have installed the dot executable and point to it here. Note that, for now, this only used by the profiling features (Development->Profiling) built into shezar.';
...
$string['pleaserefreshregistration'] = 'Your site has been registered with shezarlms.com, please consider updating the registration if significant changes happened since your last update, on {$a}';
...
$string['pluginschecktodo'] = 'You must solve all the plugin requirements before proceeding to install this shezar version!';
...
$string['profilingallowall_help'] = 'If you enable this setting, then, at any moment, you can use the PROFILEALL parameter anywhere (PGC) to enable profiling for all the executed scripts along the shezar session life. Analogously, you can use the PROFILEALLSTOP parameter to stop it.';
...
$string['questioncwqpfscheck'] = 'One or more \'random\' questions in a quiz are set up to select questions from a mixture of shared and unshared question categories. There is a more detailed report <a href="{$a->reporturl}">here</a> and see shezar Docs page <a href="{$a->docsurl}">here</a>.';
...
$string['quizattemptsupgradedmessage'] = 'In shezar 2.2 there was a major upgrade to questions. It was possible to delay parts of the database upgrade to be run later. Before upgrading to shezar 2.7, this upgrade must be completed.';
$string['recaptchaprivatekey'] = 'ReCAPTCHA secret key';
$string['recaptchapublickey'] = 'ReCAPTCHA site key';
$string['registration'] = 'Registration';
$string['releasenoteslink'] = 'For information about this version of shezar, please see the <a target="_blank" href="{$a}">Change Logs</a>';
...
$string['purgecachesconfirm']= 'shezar can cache themes, javascript, language strings, filtered text, rss feeds and many other pieces of calculated data.  Purging these caches will delete that data from the server and force browsers to refetch data, so that you can be sure you are seeing the most up-to-date values produced by the current code.  There is no danger in purging caches, but your site may appear slower for a while until the server and clients calculate new information and cache it.';
...
$string['sessionautostartwarning'] = '<p>Serious configuration error detected, please notify server administrator.</p><p> To operate properly, shezar requires that administrator changes PHP settings.</p><p><code>session.auto_start</code> must be set to <code>off</code>.</p><p>This setting is controlled by editing <code>php.ini</code>, Apache/IIS <br />configuration or <code>.htaccess</code> file on the server.</p>';
...
$string['settingsafemode'] = 'shezar is not fully compatible with safe mode, please ask server administrator to turn it off. Running shezar under safe mode is not supported, please expect various problems if you do so.';
...
$string['simplexmlrequired'] = 'The SimpleXML PHP extension is now required by shezar.';
...
$string['splrequired'] = 'The SPL PHP extension is now required by shezar.';
...
$string['tokenizerrecommended'] = 'Installing the optional PHP Tokenizer extension is recommended -- it improves shezar Networking functionality.';
$string['tools'] = 'Admin tools';
$string['toolsmanage'] = 'Manage admin tools';
$string['shezardashboard'] = 'shezar dashboard';
...
$string['updateavailable'] = 'There is a newer shezar version available!';
...
$string['updateavailable_release'] = 'shezar {$a}';
...
$string['updateavailablenot'] = 'Your shezar code is up-to-date!';
...
$string['updatenotificationfooter'] = 'Your shezar site {$a->siteurl} is configured to automatically check for available updates. You are receiving this message as the administrator of the site. You can disable automatic checks for available updates in the Site administration section of the Administration block. You can customise the delivery of this message via your preferences page.';
$string['updatenotificationsubject'] = 'shezar updates are available ({$a->siteurl})';
$string['updateautocheck'] = 'Automatically check for available updates';
$string['updateautocheck_desc'] = 'If enabled, your site will automatically check for available updates for both shezar code and all additional plugins. If there is a new update available, a notification will be sent to site admins.';
...
$string['updatenotifybuilds_desc'] = 'If enabled, the available update for shezar code is also reported when a new build for the current version is available. Builds are continuous improvements of a given shezar version. They are generally released every week. If disabled, the available update will be reported only when there is a higher version of shezar released. Checks for plugins are not affected by this setting.';
$string['upgradestart'] = 'Upgrade shezar database now';
...
$string['upgradepluginsinfo_help'] = 'There are available updates for some of your plugins. You should install them all prior to upgrading shezar database. If your site does not support automatic updates deployment, you have to download and install new plugin versions at your server manually.';
...
//$string['upgradeforumread'] = 'A new feature has been added in shezar 1.5 to track read/unread forum posts.<br />To use this functionality you need to <a href="{$a}">update your tables</a>.';
//$string['upgradeforumreadinfo'] = 'A new feature has been added in shezar 1.5 to track read/unread forum posts.  To use this functionality you need to update your tables with all the tracking information for existing posts.  Depending on the size of your site this can take a long time (hours) and can be quite taxing on the database, so it\'s best to do it during a quiet period.  However, your site will continue functioning during this upgrade and users won\'t be affected.  Once you start this process you should let it finish (keep your browser window open).  However, if you stop the process by closing the window: don\'t worry, you can start over.<br /><br />Do you want to start the upgrading process now?';
...
$string['upgradesettingsintro'] = 'The settings shown below were added during your last shezar upgrade. Make any changes necessary to the defaults and then click the &quot;Save changes&quot; button at the bottom of this page.';
$string['upgradestalefiles'] = 'Mixed shezar versions detected, upgrade cannot continue';
$string['upgradestalefilesinfo'] = 'The shezar update process has been paused because PHP scripts from at least two major versions of shezar have been detected in the shezar directory.

This can cause significant problems later, so in order to continue you must ensure that the shezar directory contains only files for a single version of shezar.

The recommended way to clean your shezar directory is as follows:

* rename the current shezar directory to "shezar_old"
* create a new shezar directory containing only files from a standard shezar package download
* move the original config.php file and any non-standard plugins from the "shezar_old" directory to the new shezar directory

When you have a clean shezar directory, refresh this page to resume the shezar update process.

This warning is often caused by unzipping a standard shezar package over a previous version of shezar. While this is OK for minor upgrades, it is strongly discouraged for major shezar upgrades.
...
$string['upgradesure'] = '<p>Your shezar files have been changed, and you are about to automatically upgrade your server from this version:</p>
...
$string['webproxyinfo'] = 'Fill in following options if your shezar server can not access internet directly. Internet access is required for download of environment data, language packs, RSS feeds, timezones, etc.<br /><em>PHP cURL extension is highly recommended.</em>';
$string['xmlrpcrecommended'] = 'The xmlrpc extension is needed for hub communication, and useful for web services and shezar networking';
$string['xmlstrictheaders'] = 'XML strict headers';
$string['yuicomboloading'] = 'YUI combo loading';
$string['ziprequired'] = 'The Zip PHP extension is now required by shezar, info-ZIP binaries or PclZip library are not used anymore.';
...
$string['moodlerelease'] = 'shezar release identifier';
...
$string['registrationisdisabled'] = 'shezar registration is disabled.  Configuring your site to register basic information with shezar is recommended to assist in troubleshooting any future issues you may have.<br />
You can enable registration from the <a href="{$a}">registration configuration page</a>';
$string['registrationisenabled'] = 'The site has been successfully registered with shezar.';
$string['registrationoutofdate'] = 'shezar registration information has not been updated for an extended period of time. Registration information should be kept up-to-date to assist possible future troubleshooting. Ensure that your webserver has unrestricted access to make https requests to register.shezarlms.com';
$string['save'] = 'Save';
$string['sitefullname'] = 'Site Fullname';
$string['sitehasntregistered'] = 'This site has not yet successfully registered with shezar. Registering basic information with shezar is recommended to assist in troubleshooting any future issues you may have.  Ensure your webserver is able to make https requests to register.shezarlms.com and that the shezar cron is enabled. You can run the cron manually by <a href="{$a}">clicking here</a>';
