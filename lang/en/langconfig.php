...
$string['strftimedateshortshezar'] = '%e %b';
$string['strftimedatetime'] = '%d %B %Y, %I:%M %p';
$string['strftimedatetimeon'] = '%l:%M%P on %e %b %Y';
$string['strftimedatetimeshort'] = '%d/%m/%y, %H:%M';
$string['strftimedayattime'] = '%A at %I:%M %p';
...
$string['strftimedaydateattime'] = '%A, %d %b %Y at %I:%M %p';
$string['strftimetime'] = '%I:%M %p';
$string['strftimetodayattime'] = 'Today at %I:%M %p';
$string['strftimeyesterdayattime'] = 'Yesterday at %I:%M %p';
