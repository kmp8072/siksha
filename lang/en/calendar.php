...
$string['pref_persistflt_help'] = 'If this is enabled, then shezar will remember your last event filter settings and automatically restore them each time you login.';
