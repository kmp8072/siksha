...
$string['pinblocksexplan'] = 'Any block settings you configure here will be visible (and non-editable) for any user of shezar on their \'My Learning\' overview page.';
