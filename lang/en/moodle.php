...
$string['adminhelpstickyblocks'] = 'Configure shezar-wide sticky blocks';
...
$string['clamlost'] = 'shezar is configured to run clam on file upload, but the path supplied to Clam AV, {$a},  is invalid.';
$string['clamlostandactinglikevirus'] = 'In addition, shezar is configured so that if clam fails to run, files are treated like viruses.  This essentially means that no student can upload a file successfully until you fix this.';
...
The essential one is the session cookie, usually called shezarSession. You must allow this cookie into your browser to provide continuity and maintain your login from page to page. When you log out or close the browser this cookie is destroyed (in your browser and on the server).

The other cookie is purely for convenience, usually called something like shezarID. It just remembers your username within the browser. This means when you return to this site the username field on the login page will be already filled out for you. It is safe to refuse this cookie - you will just have to retype your username every time you log in.';
...
$string['coursefileswarning_help'] = 'Course files are deprecated since shezar 2.0, please use external repositories instead as much as possible.';
...
$string['courselegacyfiles_help'] = 'The course files area provides some backward compatibility with shezar 1.1 and earlier.  All files in this area are always accessible to all participants in the course (whether you link to them or not) and there is no way to know where any of these files are being used in shezar.
...
$string['databasechecking'] = 'Upgrading shezar database from version {$a->oldversion} to {$a->newversion}';
...
$string['documentation'] = 'shezar documentation';
...
$string['formattext'] = 'shezar auto-format';
...
$string['go'] = 'Go';
$string['gpl'] = 'Copyright (C) 2010 onwards shezar Learning Solutions Limited (http://www.shezarlms.com/)
...
$string['gpl3'] = 'Copyright (C) 2010 onwards shezar Learning Solutions Limited (http://www.shezarlms.com/)
Copyright (C) 1999 onwards Martin Dougiamas (http://moodle.com) and other contributors (https://moodle.org/dev/)
...
$string['gravatarenabled'] = '<a href="http://www.gravatar.com/">Gravatar</a> has been enabled for this site. If you don\'t upload a profile picture shezar will attempt to load a profile picture for you from Gravatar.';
$string['group'] = 'Group';
...
$string['latestlanguagepack'] = 'Check for latest language pack on shezarlms.com';
...
$string['noticenewerbackup'] = 'This backup file has been created with shezar {$a->backuprelease} ({$a->backupversion}) and it\'s newer than your currently installed shezar {$a->serverrelease} ({$a->serverversion}). This could cause some inconsistencies because backwards compatibility of backup files cannot be guaranteed.';
...
$string['passwordextlink'] = 'The following link has been provided to recover your lost password. This will take you out of shezar.';
...
$string['passwordnohelp'] = 'No help is available to find your lost password. Please contact your shezar administrator.';
...
$string['registration'] = 'shezar registration';
...
$string['registrationcontactyes'] = 'Yes, provide a form for prospective shezar to contact me';
...
$string['virusfoundlateradminnolog'] = 'Attention administrator! A file that was uploaded with the filename {$a->filename} has since been found to contain a virus. shezar was unable to resolve this file back to the user that originally uploaded it.
