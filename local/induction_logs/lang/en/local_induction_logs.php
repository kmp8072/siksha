...
$string['getname'] = 'Name';
$string['allareas'] = 'User Name';
$string['missingbody'] = 'Please Enter the message you want to send';
$string['attachment']="Upload Image";
$string['induction_logs:view']="View Logs";