...
namespace block_shezar_report_graph;
...
class util {
    ...
    protected static function get_svg(\reportbuilder $report) {
        ...
        $graph = new \shezar_reportbuilder\local\graph($graphrecord, $report, false);
    ...
    public static function send_svg($svgdata) {
        ...
        $svgdata = \shezar_reportbuilder\local\graph::fix_svg_rtl($svgdata, null, null);
    ...
    public static function send_pdf($svgdata) {
        ...
        // Try to fix RTL header as the last step because we cache the data.
        $svgdata = \shezar_reportbuilder\local\graph::fix_svg_rtl($svgdata, null, false);
