 ...
 */
class block_shezar_program_completion_programs implements Iterator {
    /**
    ...
    public function __construct($blockid = 0) {
        $this->headers = array(
            get_string('programname', 'block_shezar_program_completion'),
        );
    ...
    public static function get_programs($blockid) {
        ...
        $block = block_instance('shezar_program_completion', $blockinstance);
