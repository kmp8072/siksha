...
define(['jquery', 'core/str'], function ($, mdlstrings) {
    var blockjs = {
        ...
        init: function(instanceid) {
            var requiredstrings = [];
            requiredstrings.push({key: 'more', component: 'block_shezar_program_completion'});
            requiredstrings.push({key: 'less', component: 'block_shezar_program_completion'});
            ...
            mdlstrings.get_strings(requiredstrings).done(function (strings) {
                ...
                $('.block-shezar-prog-completion-morelink' + instanceid).on('click', function (e) {
                    e.preventDefault();
