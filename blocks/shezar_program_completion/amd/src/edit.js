...
define(['jquery', 'core/config', 'core/str'], function ($, mdlconfig, mdlstrings) {
    var edit = {
        ...
        init: function(blockid, programsselected) {
            ...
            requiredstrings.push({key: 'addprograms', component: 'block_shezar_program_completion'});
            ...
            mdlstrings.get_strings(requiredstrings).done(function (strings) {
                ...
                var url = mdlconfig.wwwroot + '/blocks/shezar_program_completion/';

                // Init programs dialog.
                var phandler = new shezarDialog_handler_blockprograms();
                phandler.baseurl = url;
                var pbuttons = {};
                pbuttons[tstr.save] = function() { phandler._update(); };
                pbuttons[tstr.cancel] = function() { phandler._cancel(); };

                shezarDialogs['addblockprograms'] = new shezarDialog(
                    'addblockprograms',
    ...
    var shezarDialog_handler_blockprograms = function() {
        // Base url
        this.baseurl = '';
    ...
    shezarDialog_handler_blockprograms.prototype = new shezarDialog_handler_treeview_multiselect();
     ...
     * @return void
     */
    shezarDialog_handler_blockprograms.prototype._update = function(response) {
        ...
        if (newids.length > 0) {
            ...
            var ajax_url = mdlconfig.wwwroot + '/blocks/shezar_program_completion/program_item.php?itemid=' + newids.join(',') + params;
     ...
     */
    shezarDialog_handler_blockprograms.prototype.program_item_exists = function(itemid) {
    ...
    shezarDialog_handler_blockprograms.prototype.check_table_hidden_status = function() {
    ...
    shezarDialog_handler_blockprograms.prototype.add_program_delete_event_handlers = function() {
     ...
     * Adds an item.
     */
    shezarDialog_handler_blockprograms.prototype.add_program_item = function(itemid) {
     ...
     */
    shezarDialog_handler_blockprograms.prototype.create_item = function(html) {
        var element = $(html);
    ...
    shezarDialog_handler_blockprograms.prototype.remove_program_item = function(item) {
