...
$string['statlearnerhours'] ='{$a->count} staff who spent more than {$a->hours} hours online';
...
$string['shezar_stats:addinstance'] = 'Add a new stats block';
$string['shezar_stats:myaddinstance'] = 'Add a new stats block to the My Learning page';
$string['updateshezarstatstask'] = 'Update shezar statistics block';
