 ...
 */
class block_shezar_quicklinks extends block_base {

    function init() {
        $this->title = get_string('pluginname', 'block_shezar_quicklinks');
    ...
    function specialization() {
        ...
        if (!empty($this->config) && !empty($this->config->title)) {
            ...
            $this->title = get_string('quicklinks', 'block_shezar_quicklinks');
        }
    }
    ...
    function get_content() {
        ...
        if (count($links) == 0) {
            $this->content->text = get_string('noquicklinks', 'block_shezar_quicklinks');
            return $this->content;
        }
    ...
    function instance_create() {
        ...
        $links = array(
            get_string('home',    'block_shezar_quicklinks')    => "{$CFG->wwwroot}/index.php",
            get_string('reports', 'block_shezar_quicklinks')    => "{$CFG->wwwroot}/my/reports.php",
            get_string('courses', 'block_shezar_quicklinks')    => "{$CFG->wwwroot}/course/find.php"
        );
