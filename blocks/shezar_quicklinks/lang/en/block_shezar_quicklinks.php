...
$string['shezar_quicklinks:addinstance'] = 'Add a new quicklinks block';
$string['shezar_quicklinks:myaddinstance'] = 'Add a new quicklinks block to My Learning page';
$string['shezar_quicklinks:manageownlinks'] = 'Manage own links';
