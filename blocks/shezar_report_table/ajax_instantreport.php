 ...
 *
 * NOTE: this is a clone of /shezar/reportbuilder/ajax/instantreport.php
 */
...
$block = $DB->get_record('block_instances', array('id' => $blockid, 'blockname' => 'shezar_report_table'), '*', MUST_EXIST);
...
$uniqueid = 'block_shezar_report_table_' . $blockid;
