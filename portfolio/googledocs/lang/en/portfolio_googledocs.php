...
$string['noauthtoken'] = 'An authentication token has not been received from Google. Please ensure you are allowing shezar to access your Google account';
