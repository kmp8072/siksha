...
$url = "https://ssoexternal.tvscredit.com/Service.Asmx/Fun_User_Authentication";
...
$data = array("Access_Code" => "VSH00001","Access_Password" => "Tvs@So@3318","UserName" => $username,"Password" => $password,"Application" => "SIGNON");	
