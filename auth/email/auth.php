...
class auth_plugin_email extends auth_plugin_base {
    ...
    function user_signup($user, $notify=true) {
        ...
        // shezar: We need to update primary position fields here.
    ...
    function process_config($config) {
        ...
        set_config('allowsignupposition', $config->allowsignupposition, 'shezar_job');
        set_config('allowsignuporganisation', $config->allowsignuporganisation, 'shezar_job');
        set_config('allowsignupmanager', $config->allowsignupmanager, 'shezar_job');
        return true;
    }
