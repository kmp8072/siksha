...
$string['auth_gauth_casesensitive_description'] = 'When doing the lookup to match an OpenId user to a shezar user, do a case sensitive search - usually this should be On';
...
$string['auth_gauth_username_description'] = 'Google OpenId attribute that is mapped to shezar username - this defaults to email, but you might want to use openid';
$string['auth_gauth_userfield'] = 'shezar username mapping';
$string['auth_gauth_userfield_description'] = 'shezar user field that is mapped to the Google OpenId username attribute - this defaults to idnumber, but could be username, or email.  If you choose idnumber then make sure that the idnumber field below is set to openid';
$string['auth_gauth_invalid_domain'] = 'You are attempting to login from an invalid domain: ';
$string['auth_gauth_field_instructions'] = 'Here you can map further field values from Google to a shezar user accounts.  The fields available are: firstname, lastname, email, lang, and openid';
