...
$string['choosereadme'] = 'Kiwifruit Responsive is a responsive theme, based on Standard shezar Responsive.  Note that currently this theme is experimental. Please report any issues found via the normal support channels.';
