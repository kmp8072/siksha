...
if (!empty($CFG->enabledevicedetection) && empty($device)) {
    ...
    foreach ($themes as $themename => $themedir) {
        ...
        //Hide the standard moodle theme from users, they should be using standardshezar.
        //Do Not! remove the code though, the shezar themes require it.
        if ($themename == 'standard') {
            continue;
        }
        //Hide the standard mymobile theme from users, they should be using mymobileshezar.
        //Do Not! remove the code though, the shezar themes require it.
