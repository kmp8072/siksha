...
$string['backgroundposition_desc'] = 'The position of the background image. Note that this may be hidden behind the header or footer.';
...
$string['choosereadme'] = 'This is a highly customisable shezar theme, suitable for creating a branded look via the theme settings page.';
...
$string['footnotedesc'] = 'Whatever you add to this textarea will be displayed in the footer throughout your shezar site.';
...
$string['pluginname'] = 'Custom shezar Responsive';
