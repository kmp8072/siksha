...
if (empty($PAGE->layout_options['nocustommenu'])) {
    ...
    // print_r($menudata);
   // $mm = ($menudata[1]->name);
    $menudata[1]->linktext = 'My Learning';
    // print_r($menudata);
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $('#inst8 > div.content ').append($('<ul style="list-style-type: square; font-size:18px;margin-left: 24px;margin-top: -3px;"><li><a href="<?php echo $CFG->wwwroot?>/enrol/nomination/manage.php"><span style="margin-left: -4px;font-size: 14px;">Manage enrolment request</span></a> </li></ul>'));

    $('#inst8 > div.content ').append($('<ul style="list-style-type: square; font-size:18px;margin-left: 24px;margin-top: -3px;"><li><a href="<?php echo $CFG->wwwroot?>/sitehome.php?redirect=0"><span style="margin-left: -4px;font-size: 14px;">Site Home</span></a> </li></ul>'));
  });
...
$(document).ready(function(){
	$('.toggle-right').click(function(){
		...
		//$(".menu-mygoals").addClass("selected");	
		});
	  // $('.shezar-menu-nav-item.menu-dashboard').html('My Learning');
      $('.block_navigation > div.content > ul > li > ul > li:nth-child(2)').hide();
