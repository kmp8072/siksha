/**
 * Gruntfile for compiling theme_remui .less files.
 *
 ...
 * Porcelain tasks:
 * ----------------
 * Provides a high level of automation and convenience for specific use-cases.
 *
...
module.exports = function(grunt) { // jshint ignore:line
    ...
    decachephp = '/var/www/remui.local/html/admin/cli/purge_caches.php';
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            files: ["less/**/*.less"],
            tasks: ["less", "decache"],
            // tasks: ["compile"], excutes all the task register in compile
            options: {
                spawn: false,
                livereload: true
            }
        ...
        jshint: {
            options: {
                //jshintrc: moodleroot + '/theme/' + THEMEDIR + '/.jshintrc'
                jshintrc: true
            },
            files: ['**/amd/src/*.js']
        },
    ...
    grunt.registerTask("compile_less", [
        "less",
        "cssflip",
        "replace:rtl_images",
        'csscomb',
