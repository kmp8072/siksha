...
$grid = new theme_remui\output\bootstrap_grid();
...
$themerenderer = $PAGE->get_renderer('theme_remui');
...
<!-- Main navigation -->
<?php require("{$CFG->dirroot}/theme/remui/layout/partials/header.php"); ?>
...
<!-- Footer -->
<?php require("{$CFG->dirroot}/theme/remui/layout/partials/footer.php"); ?>
