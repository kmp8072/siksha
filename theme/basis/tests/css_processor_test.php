...
EOF;
    ...
    public function test_it_replaces_colour_variants() {
        ...
        $linkcolor_lighter = shezar_brightness_linear($linkcolor, 15);
        $linkcolor_darker = shezar_brightness_linear($linkcolor, -15);
        $linkcolor_light = shezar_brightness_linear($linkcolor, 25);
        $linkcolor_dark = shezar_brightness_linear($linkcolor, -25);
        $linkcolor_lighter_perc = shezar_brightness($linkcolor, 15);
        $linkcolor_darker_perc = shezar_brightness($linkcolor, -15);
        $linkcolor_light_perc = shezar_brightness($linkcolor, 25);
        $linkcolor_dark_perc = shezar_brightness($linkcolor, -25);
        $linkcolor_readable_text = shezar_readable_text($linkcolor);
