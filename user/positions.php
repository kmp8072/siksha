 ...
 * to be done via multiple job assignments (/shezar/job/jobassignment.php?jobassignmentid=)
 */
...
// And redirect to shezar/job/jobassignment.php for this jobassignment id
...
redirect(new moodle_url('/shezar/job/jobassignment.php', array('jobassignmentid' => $jaid, 'course' => $courseid)));
