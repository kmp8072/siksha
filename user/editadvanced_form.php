...
class user_editadvanced_form extends moodleform {
    ...
    public function definition() {
        ...
        if (get_config('shezar_sync', 'element_user_enabled')) {
    ...
    public function definition_after_data() {
        ...
        // shezar: let auth plugin decide what can and cannot be changed!
        if ($user) {
    ...
    public function validation($usernew, $files) {
        ...
        if(!empty($usernew->idnumber) && shezar_idnumber_exists('user', $usernew->idnumber, $usernew->id)) {
            $err['idnumber'] = get_string('idnumberexists', 'shezar_core');
        }

        // If idnumber is empty, ensure sync is not turned on.
        if (empty($usernew->idnumber) && !empty($usernew->shezarsync)) {
            $err['shezarsync'] = get_string('error:emptyidnumberwithsync', 'shezar_core');
        }
