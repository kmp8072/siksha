...
class user_filtering {
    ...
    public function __construct($fieldnames = null, $baseurl = null, $extraparams = null) {
        ...
        if (empty($fieldnames)) {
            $fieldnames = array('realname' => 0, 'lastname' => 1, 'firstname' => 1, 'username' => 1, 'email' => 1, 'city' => 1, 'country' => 1,
                                ...
                                'nevermodified' => 1, 'username' => 1, 'auth' => 1, 'mnethostid' => 1, 'idnumber' => 1, 'shezarsync'=>1);
        }
        ...
        if ($adminuserurl === $CFG->admin.'/user.php' && has_capability('shezar/core:seedeletedusers', $systemcontext)) {
    ...
    public function get_field($fieldname, $advanced) {
        ...
        switch ($fieldname) {
            ...
            case 'deleted':   return new user_filter_yesno('deleted', get_string('deleted', 'shezar_core'), $advanced, 'deleted');
            case 'shezarsync':  return new user_filter_yesno('shezarsync', get_string('shezarsync', 'tool_shezar_sync'), $advanced, 'shezarsync');
            case 'auth':
