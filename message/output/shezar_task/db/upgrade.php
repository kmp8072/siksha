...
/**
 * Upgrade code for task  message processor
 */

function xmldb_message_shezar_task_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    /// task savepoint reached
        upgrade_plugin_savepoint(true, 2010110101, 'message', 'shezar_task');
    }
