...
echo <<<EOF
<p>Flexible icons API is designed to provide more control over working with and delivering icons in shezar
...
<p>This page diplays all flexible icons available in shezar core and illustrates how to use them.
The flexible icons are based on {$fontawesomelink} font-icons using shezar specific CSS classes -
