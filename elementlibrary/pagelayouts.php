...
$layouts = array(
    ...
    'mydashboard' => array(
        'name' => 'My dashboard',
        'description' => 'This layout is used on a user\'s customisable profile page some other profile related pages such as My files and My Badges.',
    ),
    'dashboard' => array(
        'name' => 'Dashboard',
        'description' => 'This layout is used on shezar dashboard pages. It is unusual in that it has an extra "main" block region for putting blocks.',
    ),
    'mypublic' => array(
        'name' => 'My public',
    ...
    'noblocks' => array(
        'name' => 'No Blocks',
        'description' => 'This is a custom shezar layout used on pages where the full page width is needed. No other block regions are displayed.',
    ),
    'popup' => array(
        'name' => 'Popup',
...
if ($layout) {
    ...
    echo html_writer::alist(array('A file name for the layout template (stored in <code>theme/[themename]/layout/[filename]</code>). If no file exists in the theme, will look for layout files in each parent theme in turn.',
        ...
        '<strong>nocustommenu</strong>: don\'t include the custommenu. In shezar the main shezar navigation menu replaces the custommenu so this option disables that too.',
    ...
    echo $OUTPUT->container('Each of the files in the theme layout/ folder should contain the logic to correctly handles the options above. See the layouts section of standardshezar/config.php and standardshezar/layouts/ for full details.');
