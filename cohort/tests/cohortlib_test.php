...
class core_cohort_cohortlib_testcase extends advanced_testcase {
    ...
    public function test_cohort_get_available_cohorts() {
        ...
        */
        ...
        $result = cohort_get_available_cohorts($course1ctx, COHORT_ALL, 0, 0, '');
        $this->assertEquals(array(), array_keys($result)); // shezar: ignore Moodle visibility hacks TL-7124.
        ...
        $this->setUser($user1);
        $result = cohort_get_available_cohorts($course1ctx, COHORT_ALL, 0, 0, '');
        $this->assertEquals(array($cohort1->id, $cohort2->id), array_keys($result)); // shezar: ignore Moodle visibility hacks TL-7124.
    }
}
