...
// shezar: this must be included first so that the $version variable does not get overridden.
...
if ($action == 'updatecomponent' && confirm_sesskey()) {
    die(); // No updates for shezar, sorry.
...
// Get current shezar version
$current_version = $shezar->release;
