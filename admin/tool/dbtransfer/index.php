...
<ul>
<li><em>shezar/reportbuilder/db/install.php</em> when migrating to PostgreSQL, installation of the GROUP_CONCAT function.</li>
<li><em>shezar/mssql/install.php</em> when migrating to MSSQL, installation of the GROUP_CONCAT function.</li>
<li><em>shezar/mssql/install.php</em> when migrating to MSSQL, permission checks.</li>
</ul>
