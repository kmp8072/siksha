...
abstract class tool_generator_backend {
    ...
    protected function log($langstring, $a = null, $leaveopen = false) {
        ...
        } else if (get_string_manager()->string_exists('progress_' . $langstring, 'shezar_generator')) {
            // How about in shezar_generator?
            $string = get_string('progress_' . $langstring, 'shezar_generator', $a);
        } else {
