...
$string['installfromrepo_help'] = 'You will be redirected to the Moodle plugins directory to search for and install a plugin. Note that your site full name, URL and shezar version will be sent as well, to make the installation process easier for you.';
