...
//$string['remotelangnotavailable'] = 'Connect to download.shezarlms.com, it is not possible for language packs to be installed automatically.'; // Not used in shezar.
