...
$string['notsupported'] = '';
$string['notupgradedintro'] = 'This page lists the assignments created with an older version of shezar that have not been upgraded to the new assignment module in shezar 2.4. Not all assignments can be upgraded - if they were created with a custom assignment subtype, then that subtype will need to be upgraded to the new assignment plugin format in order to complete the upgrade.';
