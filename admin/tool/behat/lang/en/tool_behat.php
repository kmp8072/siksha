...
$string['aim'] = 'This administration tool helps developers and test writers to create .feature files describing shezar\'s functionalities and run them automatically. Step definitions available for use in .feature files are listed below.';
...
<li>You ran "{$a->behatinit}" from your shezar root directory.</li>
