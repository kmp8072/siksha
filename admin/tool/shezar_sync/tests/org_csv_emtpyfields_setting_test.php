...
class tool_shezar_sync_org_csv_emptyfields_setting_testcase extends advanced_testcase {
    ...
    public function setUp() {
        ...
        set_config('element_org_enabled', 1, 'shezar_sync');
        set_config('source_org', 'shezar_sync_source_org_csv', 'shezar_sync');
    ...
    public function get_element() {
        ...
        /** @var shezar_sync_element_org $element */
        return $elements['org'];
    }
    ...
    public function test_sync_add_organisations_emptyfields_setting_off_populated_fields() {
        ...
        $this->set_config($config, 'shezar_sync_source_org_csv');
        $config = array_merge($this->config, array('csvsaveemptyfields' => false));
        $this->set_config($config, 'shezar_sync_element_org');
