...
class tool_shezar_sync_pos_csv_emptyfields_setting_testcase extends advanced_testcase {
    ...
    public function setUp() {
        ...
        set_config('element_pos_enabled', 1, 'shezar_sync');
        set_config('source_pos', 'shezar_sync_source_pos_csv', 'shezar_sync');
    ...
    public function get_element() {
        ...
        /** @var shezar_sync_element_pos $element */
        return $elements['pos'];
    }
    ...
    public function test_sync_add_positions_emptyfields_setting_off_populated_fields() {
        ...
        $this->set_config($config, 'shezar_sync_source_pos_csv');
        $config = array_merge($this->config, array('csvsaveemptyfields' => false));
        $this->set_config($config, 'shezar_sync_element_pos');
