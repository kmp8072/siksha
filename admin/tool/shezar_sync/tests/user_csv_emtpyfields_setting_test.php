...
class tool_shezar_sync_user_csv_emptyfields_setting_testcase extends advanced_testcase {
    ...
    private $importdata = array(
        ...
        */
        ...
        "url" => array(
            "required" => false,
            "newdata" => array("https://www.shezarlms.com"),
            "editeddata" => array("https://www.shezarlms.com/about-us"),
            "default" => array("")
        ),
        "institution" => array(
            "required" => false,
            "newdata" => array("shezar"),
            "editeddata" => array("shezar - Europe"),
            "default" => array("")
        ),
        "department" => array(
            "required" => false,
    ...
    public function setUp() {
        ...
        $this->filedir = $CFG->dataroot . '/shezar_sync';
        mkdir($this->filedir . '/csv/ready', 0777, true);

        set_config('element_user_enabled', 1, 'shezar_sync');
        set_config('source_user', 'shezar_sync_source_user_csv', 'shezar_sync');
        set_config('fileaccess', FILE_ACCESS_DIRECTORY, 'shezar_sync');
        set_config('filesdir', $this->filedir, 'shezar_sync');
    ...
    public function get_element() {
        ...
        /** @var shezar_sync_element_user $element */
    ...
    public function test_sync_add_users_emptyfields_setting_off_populated_fields() {
        ...
        $this->set_config($config, 'shezar_sync_source_user_csv');
        $config = array_merge($this->config, array('csvsaveemptyfields' => false));
        $this->set_config($config, 'shezar_sync_element_user');
