 ...
 *
 * Unit tests for admin/tool/shezar_sync
 */

defined('MOODLE_INTERNAL') || die();

class tool_shezar_sync_elements_testcase extends advanced_testcase {
    ...
    public function test_elements_path() {
        global $CFG;
        require_once($CFG->dirroot . '/admin/tool/shezar_sync/sources/source_org_csv.php');
        ...
        $source = new shezar_sync_source_org_csv();
        $form = new shezar_sync_config_form();
    ...
    public function test_user_sync() {
        ...
        require_once($CFG->dirroot . '/admin/tool/shezar_sync/sources/source_user_csv.php');
        ...
        foreach (array(1, 0) as $sourceallrecords) {
                                ...
                                foreach (array(1, 0) as $syncidnumber) {
                                    ...
                                    foreach ($syncdeleteoptions as $syncdeleted) {
                                        ...
                                        if ($userexists) {
                                            ...
                                            $userrecord->shezarsync = $usersync;
                                            if ($useridnumber) {
                                            ...
                                            $expectedresult->shezarsync = $userrecord->shezarsync;
                                            if ($useridnumber) {
                                        ...
                                        if ($syncexists) {
                                            ...
                                            if ($userexists) {
                                                ...
                                                if ($syncidnumber && !$syncdeleted) {
                                                    ...
                                                    $expectedresult->idnumber = $syncrecord->idnumber;
                                                    $expectedresult->deleted = $syncrecord->deleted;
                                                    $expectedresult->shezarsync = true;
                                                    $expectedcount++;
                                                } else {
            ...
            $element = $this->getMock('shezar_sync_element_user',
            ...
            foreach ($expectedresults as $expectedresult) {
                ...
                if (!empty($expectedresult->shezarsync)) {
                    $this->assertEquals($expectedresult->shezarsync, $finalresult->shezarsync,
                            "Unexpected result for shezarsync\n{$settings}");
                }
            }
