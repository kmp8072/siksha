...
require_once($CFG->dirroot.'/admin/tool/shezar_sync/elements/org.php'); // Needed for shezar_sync_element_org.

abstract class shezar_sync_source_org extends shezar_sync_source {
    protected $fields, $customfields, $customfieldtitles;

    /**
     * @var shezar_sync_element_org
     */
    protected $element;
    ...
    function __construct() {
        ...
        $this->temptablename = 'shezar_sync_org';
        parent::__construct();
        ...
        $this->element = new shezar_sync_element_org();
    }
