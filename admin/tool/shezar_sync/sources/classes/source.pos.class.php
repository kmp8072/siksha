...
require_once($CFG->dirroot.'/admin/tool/shezar_sync/elements/pos.php'); // Needed for shezar_sync_element_pos.

abstract class shezar_sync_source_pos extends shezar_sync_source {
    protected $fields, $customfields, $customfieldtitles;

    /**
     * @var shezar_sync_element_pos
     */
    protected $element;
    ...
    function __construct() {
        ...
        $this->temptablename = 'shezar_sync_pos';
        parent::__construct();
        ...
        $this->element = new shezar_sync_element_pos();
    }
    ...
    function config_form(&$mform) {
        ...
        $mform->addElement('header', 'dbfieldmappings', get_string('fieldmappings', 'tool_shezar_sync'));
