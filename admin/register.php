<?php  // $Id$
    ...
    admin_externalpage_setup('shezarregistration');
...
/// Print the form
    ...
    if (!empty($statusmsg)) {
        ...
        shezar_set_notification($statusmsg, $url, array('class'=>'notifysuccess'));
    }

/// Print headings
    echo $OUTPUT->header();

    echo $OUTPUT->heading(get_string("shezarregistration", 'shezar_core'), 3, 'main');

    echo $OUTPUT->box(get_string("shezarregistrationinfo", 'shezar_core'));
