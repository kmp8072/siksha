...
class register_form extends moodleform {
    function definition (){
        ...
        $mform->addElement('header', 'settingsheader', get_string('shezarregistration', 'shezar_core'));
        $radioarray=array();
        ...
        foreach ($data as $key => $value) {
            $module = (strpos($key, 'shezar') === 0 || ($key == 'debugstatus') || ($key == 'edition')) ? 'shezar_core' : 'admin';
