...
// shezar: no moodle registration!

// shezar flavour overview.
$hidden = (isset($CFG->showflavours) and empty($CFG->showflavours));
$ADMIN->add('root', new admin_externalpage('flavouroverview', new lang_string('flavouroverview', 'shezar_flavour'), "$CFG->wwwroot/shezar/flavour/view.php", 'moodle/site:config', $hidden));

$ADMIN->add('root', new admin_externalpage('shezarregistration', new lang_string('shezarregistration', 'shezar_core'),
...
$ADMIN->add('root', new admin_category('hierarchies', new lang_string('hierarchies','shezar_hierarchy')));
$ADMIN->add('root', new admin_category('shezar_plan', new lang_string('learningplans', 'shezar_plan'),
    shezar_feature_disabled('learningplans')
));
$ADMIN->add('root', new admin_category('appraisals', new lang_string('appraisals', 'shezar_appraisal'),
    (shezar_feature_disabled('appraisals') && shezar_feature_disabled('feedback360'))
));
