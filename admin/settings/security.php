...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    $temp->add(new admin_setting_configcheckbox('forcelogin', new lang_string('forcelogin', 'admin'), new lang_string('configforceloginshezar', 'shezar_core'), 1));
    ...
    $temp->add(new admin_setting_configcheckbox('stricttransportsecurity', new lang_string('stricttransportsecurity', 'shezar_core'), new lang_string('stricttransportsecurity_desc', 'shezar_core'), 0));
    $temp->add(new admin_setting_configcheckbox('securereferrers', new lang_string('securereferrers', 'shezar_core'), new lang_string('securereferrers_desc', 'shezar_core'), 0));
    ...
    $temp->add(new admin_setting_configselect('permittedcrossdomainpolicies', new lang_string('permittedcrossdomainpolicies', 'shezar_core'), new lang_string('permittedcrossdomainpolicies_desc', 'shezar_core'), '', $options));
