...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    // shezar feature.
    $temp->add(new admin_setting_configtext('csvdateformat', new lang_string('csvdateformat', 'shezar_core'), new lang_string('csvdateformatconfig', 'shezar_core'), new lang_string('csvdateformatdefault', 'shezar_core')));
