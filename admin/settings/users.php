...
if ($hassiteconfig
 ...
 or has_capability('moodle/cohort:view', $systemcontext)) { // speedup for non-admins, add all caps used on this page
    ...
    $ADMIN->add('accounts', new admin_externalpage('profilefields', new lang_string('profilefields','admin'), "$CFG->wwwroot/user/profile/index.php", array('moodle/site:config', 'shezar/core:manageprofilefields')));
    ...
    $temp->add(new admin_setting_heading('tempmanagers',
            new lang_string('tempmanagers', 'shezar_job'), ''));

    $temp->add(new admin_setting_configcheckbox('enabletempmanagers',
            new lang_string('enabletempmanagers', 'shezar_job'),
            new lang_string('enabletempmanagersdesc', 'shezar_job'),
            1));

    $temp->add(new admin_setting_configselect('tempmanagerrestrictselection',
            new lang_string('tempmanagerrestrictselection', 'shezar_job'),
            new lang_string('tempmanagerrestrictselectiondesc', 'shezar_job'),
            0,
            array(0 => get_string('tempmanagerselectionallusers', 'shezar_job'),
                  1 => get_string('tempmanagerselectiononlymanagers', 'shezar_job'))));

    $temp->add(new admin_setting_configtext('tempmanagerexpirydays',
            new lang_string('tempmanagerexpirydays', 'shezar_job'),
            new lang_string('tempmanagerexpirydaysdesc', 'shezar_job'),
            '30', PARAM_INT));
    ...
    $ADMIN->add('roles', new admin_externalpage('roledefaults', new lang_string('roledefaults', 'shezar_core'), "$CFG->wwwroot/$CFG->admin/roles/roledefaults.php", 'moodle/role:manage'));
