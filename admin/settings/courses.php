...
if ($hassiteconfig or has_any_capability($capabilities, $systemcontext)) {
    ...
    $ADMIN->add('courses', new admin_externalpage('programmgmt', new lang_string('manageprograms', 'admin'),
        $CFG->wwwroot . '/shezar/program/manage.php',
        array('shezar/program:createprogram', 'shezar/program:configuredetails'),
        shezar_feature_disabled('programs')
    ));

    $ADMIN->add('courses', new admin_externalpage('managecertifications', new lang_string('managecertifications', 'shezar_core'),
        $CFG->wwwroot . '/shezar/program/manage.php?viewtype=certification',
        array('shezar/certification:createcertification', 'shezar/certification:configurecertification'),
        shezar_feature_disabled('certifications')
    ));

    $ADMIN->add('courses', new admin_externalpage('coursecustomfields', new lang_string('customfields', 'shezar_customfield'),
        $CFG->wwwroot . '/shezar/customfield/index.php?prefix=course', array('shezar/core:coursemanagecustomfield', 'shezar/core:programmanagecustomfield')));

    $ADMIN->add('courses', new admin_externalpage('customicons', new lang_string('customicons', 'shezar_core'), $CFG->wwwroot . '/shezar/core/manage_customicons.php',
    ...
    $temp->add(new admin_setting_configselect('moodlecourse/visiblelearning', new lang_string('audiencevisibility', 'shezar_cohort'), new lang_string('configaudiencevisibility', 'shezar_cohort'), 2, $COHORT_VISIBILITY));
