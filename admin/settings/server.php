...
$temp->add(new admin_setting_configexecutable('pathtowkhtmltopdf', new lang_string('pathtowkhtmltopdf', 'shezar_core'), new lang_string('pathtowkhtmltopdf_help', 'shezar_core'), ''));
...
$temp->add(new admin_setting_configselect('menulifetime', new lang_string('menulifetime', 'shezar_core'),
    new lang_string('menulifetime_desc', 'shezar_core'), '600',
    $options));
